...
Hi! I’m really excited that you are interested in contributing to CreatorMatrix. Before submitting your contribution though, please make sure to take a moment and read through the following guidelines.
...
- Check if the issue is reproducible with the latest stable version of CreatorMatrix. If you are using a pre-release, please indicate the specific version you are using.

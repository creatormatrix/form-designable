  ...
  return core_1.createBehavior(
    {
      ...
      selector: function (node) {
        return node.props['x-component'] === name
      },
      designerProps: {
        droppable: true,
    ...
    },
    {
      ...
      extends: ['Field'],
      selector: function (node) {
        return node.props['x-component'] === name + '.Addition'
      },
      designerProps: {
        ...
        propsSchema: Field_1.createVoidFieldSchema(
          schemas_1.AllSchemas[name].Addition
        ),
      },
    ...
    },
    {
      ...
      extends: ['Field'],
      selector: function (node) {
        return node.props['x-component'] === name + '.Remove'
      },
      designerProps: {
        allowDrop: function (parent) {
          return parent.props['x-component'] === name
    ...
    },
    {
      ...
      extends: ['Field'],
      selector: function (node) {
        return node.props['x-component'] === name + '.Index'
      },
      designerProps: {
        allowDrop: function (parent) {
          return parent.props['x-component'] === name
    ...
    },
    {
      ...
      extends: ['Field'],
      selector: function (node) {
        return node.props['x-component'] === name + '.MoveUp'
      },
      designerProps: {
        allowDrop: function (parent) {
          return parent.props['x-component'] === name
    ...
    },
    {
      ...
      extends: ['Field'],
      selector: function (node) {
        return node.props['x-component'] === name + '.MoveDown'
      },
      designerProps: {
        allowDrop: function (parent) {

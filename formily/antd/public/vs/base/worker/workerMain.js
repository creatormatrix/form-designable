 ...
 * Version: 0.46.0-dev-20231210(5e5af013f8d295555a7210df0d5f2cea0bf5dd56)
 ...
 *-----------------------------------------------------------*/ ;(function () {
  var J = [
    ...
    Z = function (O) {
      for (var n = [], M = 0, A = O.length; M < A; M++) n[M] = J[O[M]]
      return n
    }
  const Ee = this,
  ...
  ;(function (O) {
    class n {
      constructor(d, b, L) {
        ;(this.type = d), (this.detail = b), (this.timestamp = L)
      }
    }
    O.LoaderEvent = n
    class M {
      ...
      record(d, b) {
        this._events.push(
          new n(d, b, O.Utilities.getHighPerformanceTimestamp())
        )
      }
      getEvents() {
        return this._events
    ...
    ;(A.INSTANCE = new A()), (O.NullLoaderEventRecorder = A)
  })(ae || (ae = {}))
  var ae
  ;(function (O) {
    class n {
    ...
    class M {
      static validateConfigurationOptions(d) {
        ...
        if (
          ...
          d.baseUrl.length > 0 &&
            (O.Utilities.endsWith(d.baseUrl, '/') || (d.baseUrl += '/')),
      ...
      static mergeConfigurationOptions(d = null, b = null) {
        let L = O.Utilities.recursiveClone(b || {})
        return (
          O.Utilities.forEachProperty(d, (h, o) => {
            h === 'ignoreDuplicateModules' &&
            typeof L.ignoreDuplicateModules < 'u'
              ? (L.ignoreDuplicateModules = L.ignoreDuplicateModules.concat(o))
              : h === 'paths' && typeof L.paths < 'u'
              ? O.Utilities.forEachProperty(o, (w, e) => (L.paths[w] = e))
              : h === 'config' && typeof L.config < 'u'
              ? O.Utilities.forEachProperty(o, (w, e) => (L.config[w] = e))
              : (L[h] = O.Utilities.recursiveClone(o))
          }),
    ...
    class A {
      ...
      _createSortedPathsRules() {
        ;(this.sortedPathsRules = []),
          O.Utilities.forEachProperty(this.options.paths, (d, b) => {
            Array.isArray(b)
      ...
      _applyPaths(d) {
        ...
        for (let L = 0, h = this.sortedPathsRules.length; L < h; L++)
          if (
            ((b = this.sortedPathsRules[L]), O.Utilities.startsWith(d, b.from))
          ) {
            let o = []
            for (let w = 0, e = b.to.length; w < e; w++)
              o.push(b.to[w] + d.substr(b.from.length))
            return o
          }
        return [d]
      }
      _addUrlArgsToUrl(d) {
        return O.Utilities.containsQueryString(d)
      ...
      moduleIdToPaths(d) {
        ...
        let b = d,
          L
        if (!O.Utilities.endsWith(b, '.js') && !O.Utilities.isAbsolutePath(b)) {
          L = this._applyPaths(b)
          for (let h = 0, o = L.length; h < o; h++)
            (this.isBuild() && L[h] === 'empty:') ||
              (O.Utilities.isAbsolutePath(L[h]) ||
                (L[h] = this.options.baseUrl + L[h]),
              !O.Utilities.endsWith(L[h], '.js') &&
                !O.Utilities.containsQueryString(L[h]) &&
                (L[h] = L[h] + '.js'))
        } else
          !O.Utilities.endsWith(b, '.js') &&
            !O.Utilities.containsQueryString(b) &&
            (b = b + '.js'),
            (L = [b])
      ...
      requireToUrl(d) {
        let b = d
        return (
          O.Utilities.isAbsolutePath(b) ||
            ((b = this._applyPaths(b)[0]),
            O.Utilities.isAbsolutePath(b) || (b = this.options.baseUrl + b)),
      ...
      shouldInvokeFactory(d) {
        return !!(
          ...
          O.Utilities.isAnonymousModule(d) ||
    ...
    class n {
      ...
      load(o, w, e, a) {
        ...
        if (this._callbackMap.hasOwnProperty(w)) {
          this._callbackMap[w].push(u)
          return
        }
        ;(this._callbackMap[w] = [u]),
          this._scriptLoader.load(
            o,
            w,
            () => this.triggerCallback(w),
            (c) => this.triggerErrorback(w, c)
          )
      }
      triggerCallback(o) {
        let w = this._callbackMap[o]
        delete this._callbackMap[o]
        for (let e = 0; e < w.length; e++) w[e].callback()
      }
      triggerErrorback(o, w) {
        let e = this._callbackMap[o]
        delete this._callbackMap[o]
        for (let a = 0; a < e.length; a++) e[a].errorback(w)
      }
    }
    class M {
      attachListeners(o, w, e) {
        let a = () => {
      ...
      load(o, w, e, a) {
        if (/^node\|/.test(w)) {
          let u = o.getConfig().getOptionsLiteral(),
            c = b(o.getRecorder(), u.nodeRequire || O.global.nodeRequire),
            m = w.split('|'),
            f = null
          try {
            f = c(m[1])
          ...
          c && (w = c.createScriptURL(w)), u.setAttribute('src', w)
...
//# sourceURL=${w}`),
          ...
          try {
            u && (w = u.createScriptURL(w)), importScripts(w), e()
          } catch (m) {
            a(m)
          }
        }
    ...
    class d {
      ...
      _initNodeRequire(o, w) {
        ...
        u.prototype._compile = function (m, f) {
          ...
          try {
            ...
            ;(v = R.slice(0, 16)), (y.cachedData = R.slice(16)), C.record(60, E)
          } catch {
            C.record(61, E)
          }
          const r = new a._vm.Script(S, y),
            ...
            l = a._path.dirname(f),
            _ = c(this),
            g = [this.exports, _, this, f, l, process, Ne, Buffer],
            p = s.apply(this.exports, g)
          return (
            a._handleCachedData(r, S, E, !y.cachedData, w),
            a._verifyCachedData(r, S, E, v, w),
            p
          )
        }
      }
      load(o, w, e, a) {
        ...
        if (/^node\|/.test(w)) {
          ...
          o.enqueueDefineAnonymousModule([], () => C), e()
        } else {
          w = O.Utilities.fileUriToFilePath(this._env.isWindows, w)
          const S = this._path.normalize(w),
            C = this._getElectronRendererScriptPathOrUri(S),
            E = !!u.nodeCachedData,
            y = E ? this._getCachedDataPath(u.nodeCachedData, w) : void 0
          this._readSourceAndCachedData(S, y, f, (v, r, s, l) => {
            if (v) {
              a(v)
              return
            }
            ...
            r.charCodeAt(0) === d._BOM
              ? (_ = d._PREFIX + r.substring(1) + d._SUFFIX)
              : (_ = d._PREFIX + r + d._SUFFIX),
              (_ = m(_, S))
            const g = { filename: C, cachedData: s },
              p = this._createAndEvalScript(o, _, g, e, a)
            this._handleCachedData(p, _, y, E && !s, o),
              this._verifyCachedData(p, _, y, l, o)
          })
        }
      }
      _createAndEvalScript(o, w, e, a, u) {
        const c = o.getRecorder()
        c.record(31, e.filename)
        const m = new this._vm.Script(w, e),
          f = m.runInThisContext(e),
          S = o.getGlobalAMDDefineFunc()
        let C = !1
        const E = function () {
          return (C = !0), S.apply(null, arguments)
        }
        return (
          (E.amd = S.amd),
          f.call(
          ...
          C
            ? a()
            : u(new Error(`Didn't receive define call in ${e.filename}!`)),
          m
        )
      }
      ...
      _getCachedDataPath(o, w) {
        const e = this._crypto
            ...
            .update(process.arch, '')
            .digest('hex'),
          a = this._path.basename(w).replace(/\.js$/, '')
        return this._path.join(o.path, `${a}-${e}.code`)
      }
      _handleCachedData(o, w, e, a, u) {
        o.cachedDataRejected
          ? this._fs.unlink(e, (c) => {
              u.getRecorder().record(62, e),
                this._createAndWriteCachedData(o, w, e, u),
                c && u.getConfig().onError(c)
            })
          : a && this._createAndWriteCachedData(o, w, e, u)
      }
      _createAndWriteCachedData(o, w, e, a) {
        let u = Math.ceil(
        ...
        const S = () => {
          setTimeout(() => {
            f || (f = this._crypto.createHash('md5').update(w, 'utf8').digest())
            const C = o.createCachedData()
            if (!(C.length === 0 || C.length === c || m >= 5)) {
              if (C.length < c) {
                S()
                return
              }
              ;(c = C.length),
                this._fs.writeFile(e, Buffer.concat([f, C]), (E) => {
      ...
      _readSourceAndCachedData(o, w, e, a) {
        if (!w) this._fs.readFile(o, { encoding: 'utf8' }, a)
        else {
          let u,
            c,
            m,
            f = 2
          const S = (C) => {
            C ? a(C) : --f === 0 && a(void 0, u, c, m)
          }
          this._fs.readFile(o, { encoding: 'utf8' }, (C, E) => {
            ;(u = E), S(C)
          }),
            this._fs.readFile(w, (C, E) => {
              !C && E && E.length > 0
                ? ((m = E.slice(0, 16)), (c = E.slice(16)), e.record(60, w))
                : e.record(61, w),
                S()
            })
        }
      }
      _verifyCachedData(o, w, e, a, u) {
        a &&
          (o.cachedDataRejected ||
            setTimeout(() => {
    ...
    O.ensureRecordedNodeRequire = b
    function L(h) {
      return new n(h)
    }
    O.createScriptLoader = L
  })(ae || (ae = {}))
  var ae
  ;(function (O) {
    class n {
      constructor(h) {
        let o = h.lastIndexOf('/')
        o !== -1
          ? (this.fromModulePath = h.substr(0, o + 1))
          : (this.fromModulePath = '')
      }
      static _normalizeModuleId(h) {
        let o = h,
          w
        for (w = /\/\.\//; w.test(o); ) o = o.replace(w, '/')
        for (
          o = o.replace(/^\.\//g, ''),
            w =
              /\/(([^\/])|([^\/][^\/\.])|([^\/\.][^\/])|([^\/][^\/][^\/]+))\/\.\.\//;
      ...
      resolveModule(h) {
        let o = h
        return (
          O.Utilities.isAbsolutePath(o) ||
            ((O.Utilities.startsWith(o, './') ||
              O.Utilities.startsWith(o, '../')) &&
    ...
    class M {
      ...
      static _safeInvokeFunction(h, o) {
        try {
          return { returnedValue: h.apply(O.global, o), producedError: null }
        } catch (w) {
          return { returnedValue: null, producedError: w }
        }
      }
      static _invokeFactory(h, o, w, e) {
        return h.shouldInvokeFactory(o)
          ? h.shouldCatchError()
            ? this._safeInvokeFunction(w, e)
            : { returnedValue: w.apply(O.global, e), producedError: null }
      ...
      complete(h, o, w, e) {
        ...
        if (this._callback)
          if (typeof this._callback == 'function') {
            ...
            let u = M._invokeFactory(o, this.strId, this._callback, w)
            ;(a = u.producedError),
    ...
    class d {
      constructor(h, o, w) {
        ;(this.id = h), (this.pluginId = o), (this.pluginParam = w)
      }
    }
    O.PluginDependency = d
    class b {
      constructor(h, o, w, e, a = 0) {
        ;(this._env = h),
        ...
        for (let u = 0; u < a.length; u++) {
          ...
          if (c) {
            let m = c[1],
              f = c[2],
              S = c[3],
              C = Math.max(m.lastIndexOf(' ') + 1, m.lastIndexOf('(') + 1)
            if (((m = m.substr(C)), (m = w(m)), m === e)) {
      ...
      getBuildInfo() {
        ...
        for (let w = 0, e = this._modules2.length; w < e; w++) {
          ...
          h[o++] = {
            ...
            path: u,
            defineLocation:
              u && c ? b._findRelevantLocationInStack(u, c) : null,
            dependencies: m,
            shim: null,
            exports: a.exports,
          }
      ...
      defineModule(h, o, w, e, a, u = new n(h)) {
        ...
        let m = new M(c, h, this._normalizeDependencies(o, u), w, e, u)
        ;(this._modules2[c] = m),
          this._config.isBuild() &&
      ...
      _normalizeDependency(h, o) {
        ...
        let w = h.indexOf('!')
        if (w >= 0) {
          let e = o.resolveModule(h.substr(0, w)),
            a = o.resolveModule(h.substr(w + 1)),
      ...
      _normalizeDependencies(h, o) {
        ...
        for (let a = 0, u = h.length; a < u; a++)
          w[e++] = this._normalizeDependency(h[a], o)
        return w
      }
      _relativeRequire(h, o, w, e) {
      ...
      synchronousRequire(h, o = new n(h)) {
        let w = this._normalizeDependency(h, o),
      ...
      configure(h, o) {
        ...
        o
          ? (this._config = new O.Configuration(this._env, h))
      ...
      _createLoadError(h, o) {
        ...
        const a = O.ensureError(o)
        return (a.phase = 'loading'), (a.moduleId = w), (a.neededBy = e), a
      }
      _onLoadError(h, o) {
        const w = this._createLoadError(h, o)
        this._modules2[h] ||
        ...
        let e = []
        for (let c = 0, m = this._moduleIdProvider.getMaxModuleId(); c < m; c++)
          e[c] = !1
        let a = !1,
          u = []
        ...
        a || this._config.onError(w)
      }
      _hasDependencyPath(h, o) {
        let w = this._modules2[h]
        if (!w) return !1
        let e = []
        for (let u = 0, c = this._moduleIdProvider.getMaxModuleId(); u < c; u++)
          e[u] = !1
        let a = []
        for (a.push(w), e[h] = !0; a.length > 0; ) {
          let c = a.shift().dependencies
          if (c)
            for (let m = 0, f = c.length; m < f; m++) {
              let S = c[m]
              if (S.id === o) return !0
              let C = this._modules2[S.id]
              C && !e[S.id] && ((e[S.id] = !0), a.push(C))
            }
        }
        return !1
      }
      _findCyclePath(h, o, w) {
        if (h === o || w === 50) return [h]
        let e = this._modules2[h]
        if (!e) return null
        let a = e.dependencies
        if (a)
          for (let u = 0, c = a.length; u < c; u++) {
            let m = this._findCyclePath(a[u].id, o, w + 1)
            if (m !== null) return m.push(h), m
          }
        return null
      }
      _createRequire(h) {
        let o = (w, e, a) => this._relativeRequire(h, w, e, a)
        return (
          (o.toUrl = (w) => this._config.requireToUrl(h.resolveModule(w))),
          (o.getStats = () => this.getLoaderEvents()),
          (o.hasDependencyCycle = () => this._hasDependencyCycle),
          (o.config = (w, e = !1) => {
            this.configure(w, e)
          }),
          (o.__$__nodeRequire = O.global.nodeRequire),
          o
        )
      }
      _loadModule(h) {
        ...
        let o = this._moduleIdProvider.getStrModuleId(h),
          w = this._config.moduleIdToPaths(o),
          e = /^@[^\/]+\/[^\/]+$/
        this._env.isNode &&
          (o.indexOf('/') === -1 || e.test(o)) &&
          w.push('node|' + o)
        let a = -1,
          u = (c) => {
            if ((a++, a >= w.length)) this._onLoadError(h, c)
            else {
              let m = w[a],
                f = this.getRecorder()
...
`)
            ...
            if (
              ...
              m ||
                ((m = []), this._inversePluginDependencies2.set(a.pluginId, m)),
                m.push(a),
  ...
  ;(function (O) {
    ...
    const A = function (L, h, o) {
      typeof L != 'string' && ((o = h), (h = L), (L = null)),
        ...
        L
          ? M.defineModule(L, h, o, null, null)
          : M.enqueueDefineAnonymousModule(h, o)
    }
    A.amd = { jQuery: !0 }
    ...
    function b() {
      if (typeof O.global.require < 'u' || typeof require < 'u') {
        const L = O.global.require || require
        if (typeof L == 'function' && typeof L.resolve == 'function') {
          const h = O.ensureRecordedNodeRequire(M.getRecorder(), L)
          ;(O.global.nodeRequire = h),
            (d.nodeRequire = h),
            (d.__$__nodeRequire = h)
        }
      }
      n.isNode && !n.isElectronRenderer && !n.isElectronNodeIntegrationWebWorker
        ? (module.exports = d)
        : (n.isElectronRenderer || (O.global.define = A),
          (O.global.require = d))
    }
    ;(O.init = b),
    ...
    X(J[19], Z([0, 1]), function (O, n) {
      ...
      async function L(f, S, C) {
        const E = b(f) + b(S) + 'vscode/' + b(C),
          y = await fetch(E)
      ...
      function o(f) {
        return (S, C, ...E) => ({ value: i(f[S], E), original: i(C, E) })
      }
      function w(f, S, ...C) {
        return i(S, C)
      }
      ...
      function c(f, S) {
        ...
        return {
          ...
          getConfiguredDefaultLocale:
            (C = S.getConfiguredDefaultLocale) !== null && C !== void 0
              ? C
              : (E) => {},
        }
      }
      ...
      function m(f, S, C, E) {
        var y
        const v = (y = E['vs/nls']) !== null && y !== void 0 ? y : {}
        if (!f || f.length === 0)
          return C({
            localize: w,
            localize2: e,
            getConfiguredDefaultLocale: () => {
              var g
              return (g = v.availableLanguages) === null || g === void 0
                ? void 0
                : g['*']
            },
          })
        const r = v.availableLanguages ? d(v.availableLanguages, f) : null,
          s = r === null || r === A
        let l = '.nls'
        s || (l = l + '.' + r)
        const _ = (g) => {
          Array.isArray(g)
            ...
            (g.getConfiguredDefaultLocale = () => {
              var p
              return (p = v.availableLanguages) === null || p === void 0
                ? void 0
                : p['*']
            }),
            C(g)
        ...
        typeof v.loadBundle == 'function'
          ? v.loadBundle(f, r, (g, p) => {
              g ? S([f + '.nls'], _) : _(p)
            })
          : v.translationServiceUrl && !s
          ? (async () => {
              var g
              try {
                const p = await L(v.translationServiceUrl, r, f)
                return _(p)
              } catch (p) {
                if (!r.includes('-'))
                  return console.error(p), S([f + '.nls'], _)
                try {
                  const R = r.split('-')[0],
                    N = await L(v.translationServiceUrl, R, f)
                  return (
                    ((g = v.availableLanguages) !== null && g !== void 0) ||
                      (v.availableLanguages = {}),
                    (v.availableLanguages['*'] = R),
                    _(N)
                  )
                } catch (R) {
                  return console.error(R), S([f + '.nls'], _)
                }
              }
            })()
          : S([f + l], _, (g) => {
    ...
    (function () {
      ...
      function M(w, e) {
        ...
        if (O?.createTrustedTypesPolicy)
          try {
            return O.createTrustedTypesPolicy(w, e)
          } catch (u) {
            console.warn(u)
            return
          }
...
//# sourceURL=${a}`),
          ...
          A ? importScripts(A.createScriptURL(a)) : importScripts(a), w()
        })
      }
      function b() {
        require.config({
    ...
    X(J[7], Z([0, 1]), function (O, n) {
      ...
      n.tail2 = A
      function i(k, q, I = (V, z) => V === z) {
        if (k === q) return !0
        if (!k || !q || k.length !== q.length) return !1
        for (let V = 0, z = k.length; V < z; V++) if (!I(k[V], q[V])) return !1
        return !0
      }
      n.equals = i
      function d(k, q) {
      ...
      n.binarySearch2 = L
      function h(k, q, I) {
        if (((k = k | 0), k >= q.length)) throw new TypeError('invalid index')
        const V = q[Math.floor(q.length * Math.random())],
          z = [],
          Y = [],
          t = []
        for (const re of q) {
          const le = I(re, V)
          le < 0 ? z.push(re) : le > 0 ? Y.push(re) : t.push(re)
        }
        return k < z.length
          ? h(k, z, I)
          : k < z.length + t.length
          ? t[0]
          : h(k - (z.length + t.length), Y, I)
      }
      n.quickSelect = h
      function o(k, q) {
        const I = []
        let V
        for (const z of k.slice(0).sort(q))
          !V || q(V[0], z) !== 0 ? ((V = [z]), I.push(V)) : V.push(z)
        return I
      }
      n.groupBy = o
      function* w(k, q) {
        let I, V
        for (const z of k)
          V !== void 0 && q(V, z) ? I.push(z) : (I && (yield I), (I = [z])),
            (V = z)
        I && (yield I)
      }
      n.groupAdjacentBy = w
      function e(k, q) {
        for (let I = 0; I <= k.length; I++)
          q(I === 0 ? void 0 : k[I - 1], I === k.length ? void 0 : k[I])
      }
      n.forEachAdjacent = e
      function a(k, q) {
        for (let I = 0; I < k.length; I++)
      ...
      function c(k) {
        let q = 0
        for (let I = 0; I < k.length; I++) k[I] && ((k[q] = k[I]), (q += 1))
        k.length = q
      }
      n.coalesceInPlace = c
      function m(k) {
      ...
      n.distinct = S
      function C(k, q) {
        return k.length > 0 ? k[0] : q
      }
      n.firstOrDefault = C
      function E(k, q) {
        let I = typeof q == 'number' ? k : 0
        typeof q == 'number' ? (I = k) : ((I = 0), (q = k))
        const V = []
        if (I <= q) for (let z = I; z < q; z++) V.push(z)
        else for (let z = I; z > q; z--) V.push(z)
        return V
      }
      n.range = E
      function y(k, q, I) {
      ...
      function v(k, q) {
        const I = k.indexOf(q)
        I > -1 && (k.splice(I, 1), k.unshift(q))
      }
      n.pushToStart = v
      function r(k, q) {
        const I = k.indexOf(q)
        I > -1 && (k.splice(I, 1), k.push(q))
      }
      n.pushToEnd = r
      function s(k, q) {
        for (const I of q) k.push(I)
      }
      n.pushMany = s
      function l(k) {
      ...
      function g(k, q, I, V) {
        const z = p(k, q)
        let Y = k.splice(z, I)
        return Y === void 0 && (Y = []), _(k, z, V), Y
      }
      n.splice = g
      function p(k, q) {
        return q < 0 ? Math.max(q + k.length, 0) : Math.min(q, k.length)
      }
      var R
      ;(function (k) {
        function q(Y) {
        ...
        ;(k.isNeitherLessOrGreaterThan = z),
          (k.greaterThan = 1),
          (k.lessThan = -1),
          (k.neitherLessOrGreaterThan = 0)
      })(R || (n.CompareResult = R = {}))
      function N(k, q) {
        return (I, V) => q(k(I), k(V))
      }
      n.compareBy = N
      function D(...k) {
        return (q, I) => {
      ...
      const T = (k, q) => (0, n.numberComparator)(k ? 1 : 0, q ? 1 : 0)
      ...
      class B {
        ...
        takeWhile(q) {
          let I = this.firstIdx
          for (; I < this.items.length && q(this.items[I]); ) I++
          const V =
            I === this.firstIdx ? null : this.items.slice(this.firstIdx, I)
          return (this.firstIdx = I), V
        }
        takeFromEndWhile(q) {
          let I = this.lastIdx
          for (; I >= 0 && q(this.items[I]); ) I--
          const V =
            I === this.lastIdx
              ? null
              : this.items.slice(I + 1, this.lastIdx + 1)
        ...
        takeCount(q) {
          const I = this.items.slice(this.firstIdx, this.firstIdx + q)
          return (this.firstIdx += q), I
        }
      }
      n.ArrayQueue = B
      class H {
        ...
        toArray() {
          const q = []
          return this.iterate((I) => (q.push(I), !0)), q
        }
        filter(q) {
          return new H((I) => this.iterate((V) => (q(V) ? I(V) : !0)))
        }
        map(q) {
          return new H((I) => this.iterate((V) => I(q(V))))
        }
        findLast(q) {
          let I
          return this.iterate((V) => (q(V) && (I = V), !0)), I
        }
        findLastMaxBy(q) {
          let I,
            V = !0
          return (
            this.iterate(
              (z) => (
                (V || R.isGreaterThan(q(z, I))) && ((V = !1), (I = z)), !0
              )
            ),
            I
          )
      ...
      ;(n.CallbackIterable = H), (H.empty = new H((k) => {}))
    }),
    X(J[11], Z([0, 1]), function (O, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.mapFindFirst =
          n.findMaxIdxBy =
    ...
    X(J[32], Z([0, 1]), function (O, n) {
      ...
      class M {
        ...
        get(d) {
          ...
          return (
            this.lastArgKey !== b &&
              ((this.lastArgKey = b), (this.lastCache = this.fn(d))),
            this.lastCache
          )
        }
      }
      ...
      class i {
        constructor(h, o, w, e) {
          ;(this._hslaBrand = void 0),
            ...
            (this.l = M(Math.max(Math.min(1, w), 0), 3)),
            (this.a = M(Math.max(Math.min(1, e), 0), 3))
        }
        static equals(h, o) {
        ...
        static fromRGBA(h) {
          ...
          if (C > 0) {
            switch (
              ((f = Math.min(S <= 0.5 ? C / (2 * S) : C / (2 - 2 * S), 1)), u)
            ) {
              case o:
                m = (w - e) / C + (w < e ? 6 : 0)
                break
      ...
      class d {
        constructor(h, o, w, e) {
          ;(this._hsvaBrand = void 0),
            (this.h = Math.max(Math.min(360, h), 0) | 0),
            (this.s = M(Math.max(Math.min(1, o), 0), 3)),
            (this.v = M(Math.max(Math.min(1, w), 0), 3)),
            (this.a = M(Math.max(Math.min(1, e), 0), 3))
        }
        static equals(h, o) {
      ...
      class b {
        ...
        getRelativeLuminance() {
          const h = b._relativeLuminanceForComponent(this.rgba.r),
            ...
            w = b._relativeLuminanceForComponent(this.rgba.b),
            e = 0.2126 * h + 0.7152 * o + 0.0722 * w
          return M(e, 4)
        }
        ...
        transparent(h) {
          const { r: o, g: w, b: e, a } = this.rgba
          return new b(new A(o, w, e, a * h))
        }
        isTransparent() {
        ...
        toString() {
          return (
            this._toString || (this._toString = b.Format.CSS.format(this)),
            this._toString
          )
        }
        static getLighterColor(h, o, w) {
          if (h.isLighterThan(o)) return h
          w = w || 0.5
          const e = h.getRelativeLuminance(),
            a = o.getRelativeLuminance()
          return (w = (w * (a - e)) / a), h.lighten(w)
        }
        static getDarkerColor(h, o, w) {
          if (h.isDarkerThan(o)) return h
          w = w || 0.5
          const e = h.getRelativeLuminance(),
            a = o.getRelativeLuminance()
          return (w = (w * (e - a)) / e), h.darken(w)
        }
      }
      ;(n.Color = b),
            ...
            ;(function (e) {
              ...
              function C(r, s = !1) {
                return s && r.rgba.a === 1
                  ...
                  : `#${f(r.rgba.r)}${f(r.rgba.g)}${f(r.rgba.b)}${f(
              ...
              function y(r) {
                ...
                if (s === 7) {
                  const l = 16 * v(r.charCodeAt(1)) + v(r.charCodeAt(2)),
                    _ = 16 * v(r.charCodeAt(3)) + v(r.charCodeAt(4)),
                    g = 16 * v(r.charCodeAt(5)) + v(r.charCodeAt(6))
                  return new L(new A(l, _, g, 1))
                }
                if (s === 9) {
                  const l = 16 * v(r.charCodeAt(1)) + v(r.charCodeAt(2)),
                    _ = 16 * v(r.charCodeAt(3)) + v(r.charCodeAt(4)),
                  ...
                  return new L(new A(l, _, g, p / 255))
                }
                if (s === 4) {
                  const l = v(r.charCodeAt(1)),
                    _ = v(r.charCodeAt(2)),
                    g = v(r.charCodeAt(3))
                  return new L(new A(16 * l + l, 16 * _ + _, 16 * g + g))
                }
                if (s === 5) {
                  const l = v(r.charCodeAt(1)),
                    _ = v(r.charCodeAt(2)),
...
` +
      ...
      function L(m) {
        return m instanceof h
          ? !0
          : m instanceof Error && m.name === b && m.message === b
      }
    ...
    X(J[12], Z([0, 1, 5]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.checkAdjacentItems = n.assertFn = n.assertNever = n.ok = void 0)
      function A(L, h) {
        if (!L)
          throw new Error(h ? `Assertion failed (${h})` : 'Assertion Failed')
      }
      n.ok = A
      ...
      n.checkAdjacentItems = b
    }),
    X(J[20], Z([0, 1]), function (O, n) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
    ...
    X(J[21], Z([0, 1]), function (O, n) {
      ...
      ;(function (A) {
        function i(v) {
          return (
            v && typeof v == 'object' && typeof v[Symbol.iterator] == 'function'
          )
        }
        A.is = i
        ...
        A.from = o
        function* w(v) {
          for (let r = v.length - 1; r >= 0; r--) yield v[r]
        }
        A.reverse = w
        function e(v) {
        ...
        A.some = u
        function c(v, r) {
          for (const s of v) if (r(s)) return s
        }
        A.find = c
        function* m(v, r) {
          for (const s of v) r(s) && (yield s)
        }
        A.filter = m
        function* f(v, r) {
          let s = 0
          for (const l of v) yield r(l, s++)
        }
        A.map = f
        function* S(...v) {
          for (const r of v) yield* r
        }
        A.concat = S
        function C(v, r, s) {
          let l = s
          for (const _ of v) l = r(l, _)
          return l
        }
        A.reduce = C
        function* E(v, r, s = v.length) {
          for (
            r < 0 && (r += v.length),
              s < 0 ? (s += v.length) : s > v.length && (s = v.length);
            r < s;
            r++
          )
            yield v[r]
        ...
        A.slice = E
        function y(v, r = Number.POSITIVE_INFINITY) {
          const s = []
          if (r === 0) return [s, v]
          const l = v[Symbol.iterator]()
          for (let _ = 0; _ < r; _++) {
            const g = l.next()
            if (g.done) return [s, A.empty()]
            s.push(g.value)
          }
          return [
            s,
    ...
    X(J[35], Z([0, 1]), function (O, n) {
      ...
      class M {
        ...
        define(a, u) {
          ;(this._keyCodeToStr[a] = u),
            (this._strToKeyCode[u.toLowerCase()] = a)
        }
        keyCodeToStr(a) {
      ...
      ;(function () {
        ...
        for (const m of a) {
          ...
          if (
            ...
            if (((u[E] = !0), !y))
              throw new Error(
                `String representation missing for key code ${E} around scan code ${C}`
              )
            A.define(E, y), i.define(E, s || y), d.define(E, l || s || y)
          }
          v && (n.EVENT_KEY_CODE_MAP[v] = E),
      ...
      ;(function (e) {
        function a(C) {
          return A.keyCodeToStr(C)
        }
        e.toString = a
        function u(C) {
          return A.strToKeyCode(C)
        }
        e.fromString = u
        function c(C) {
        ...
        function f(C) {
          return i.strToKeyCode(C) || d.strToKeyCode(C)
        }
    ...
    X(J[13], Z([0, 1, 20, 21]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.DisposableMap =
          n.ImmortalReference =
    ...
    X(J[22], Z([0, 1]), function (O, n) {
      ...
      class A {
        ...
        _remove(d) {
          ...
          } else d.prev === M.Undefined && d.next === M.Undefined ? ((this._first = M.Undefined), (this._last = M.Undefined)) : d.next === M.Undefined ? ((this._last = this._last.prev), (this._last.next = M.Undefined)) : d.prev === M.Undefined && ((this._first = this._first.next), (this._first.prev = M.Undefined))
          this._size -= 1
        }
        *[Symbol.iterator]() {
          let d = this._first
    ...
    X(J[37], Z([0, 1]), function (O, n) {
      ...
      class L {
        ...
        set(a, u, c = 0) {
          ...
          if (m) (m.value = u), c !== 0 && this.touch(m, c)
            ...
            switch (
              ((m = { key: a, value: u, next: void 0, previous: void 0 }), c)
            ) {
              case 0:
                this.addItemLast(m)
                break
        ...
        remove(a) {
          ...
          if (u)
            return (
              this._map.delete(a), this.removeItem(u), this._size--, u.value
            )
        }
        shift() {
          ...
          const a = this._head
          return (
            this._map.delete(a.key), this.removeItem(a), this._size--, a.value
          )
        }
        forEach(a, u) {
          const c = this._state
      ...
      class h extends L {
        constructor(a, u = 1) {
          super(),
            (this._limit = a),
            (this._ratio = Math.min(Math.max(0, u), 1))
        }
        get limit() {
          return this._limit
        }
      ...
      class o {
        ...
        delete(a) {
          ...
          return u === void 0
            ? !1
            : (this._m1.delete(a), this._m2.delete(u), !0)
        }
        keys() {
    ...
    X(J[9], Z([0, 1, 5, 20, 13, 22, 23]), function (O, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.Relay =
          n.EventBufferer =
      ...
      ;(function (g) {
        ...
        function D(K, j, G) {
          return k(
            (Q, ee = null, ne) => K((P) => Q.call(ee, j(P)), null, ne),
            G
          )
        }
        g.map = D
        ...
        function T(K, j, G) {
          return k(
            (Q, ee = null, ne) => K((P) => j(P) && Q.call(ee, P), null, ne),
            G
          )
        }
        g.filter = T
        ...
        g.latch = z
        function Y(K, j, G) {
          return [g.filter(K, j, G), g.filter(K, (Q) => !j(Q), G)]
        }
        g.split = Y
        function t(K, j = !1, G = [], Q) {
          let ee = G.slice(),
            ne = K((W) => {
              ee ? ee.push(W) : U.fire(W)
            })
          Q && Q.add(ne)
          const P = () => {
              ee?.forEach((W) => U.fire(W)), (ee = null)
            },
            U = new S({
              onWillAddFirstListener() {
                ne || ((ne = K((W) => U.fire(W))), Q && Q.add(ne))
              },
        ...
        class Se {
          constructor(j, G) {
            ...
            G || p(Q), (this.emitter = new S(Q)), G && G.add(this.emitter)
          }
          beginUpdate(j) {
            this._counter++
          }
        ...
        function fe(K) {
          return (j, G, Q) => {
            ...
            const P = {
              ...
              endUpdate() {
                ee--,
                  ee === 0 && (K.reportChanges(), ne && ((ne = !1), j.call(G)))
              },
            ...
            return (
              Q instanceof i.DisposableStore
                ? Q.add(U)
                : Array.isArray(Q) && Q.push(U),
              U
            )
          }
        }
        g.fromObservableLight = fe
      })(o || (n.Event = o = {}))
      class w {
        constructor(p) {
          ;(this.listenerCount = 0),
            ...
            (this.durations = []),
            (this.name = `${p}_${w._idPool++}`),
            w.all.add(this)
        }
        start(p) {
          ;(this._stopWatch = new b.StopWatch()), (this.listenerCount = p)
        }
        stop() {
          if (this._stopWatch) {
      ...
      ;(n.EventProfiling = w), (w.all = new Set()), (w._idPool = 0)
      let e = -1
      class a {
        ...
        check(p, R) {
          ...
          const D = this._stacks.get(p.value) || 0
          if (
            (this._stacks.set(p.value, D + 1),
          ...
          return () => {
            const x = this._stacks.get(p.value) || 0
            this._stacks.set(p.value, x - 1)
          }
        }
      }
      class u {
...
`)
      ...
      class S {
            ...
            ((p = this._event) !== null && p !== void 0) ||
              (this._event = (R, N, D) => {
                ...
                this._leakageMon &&
                  ...
                  ((k.stack = u.create()),
                  (q = this._leakageMon.check(k.stack, this._size + 1))),
                  L && (k.stack = I ?? u.create()),
                  this._listeners
                    ? this._listeners instanceof c
                      ? (((H = this._deliveryQueue) !== null && H !== void 0) ||
            ...
            for (let k = 0; k < T.length; k++)
              T[k]
                ...
                : B &&
                  ...
                  H < this._deliveryQueue.i && this._deliveryQueue.i--)
            T.length = H
          }
        }
        _deliver(p, R) {
        ...
        fire(p) {
          ...
          if (
            ...
            if (this._listeners instanceof c) this._deliver(this._listeners, p)
            else {
      ...
      class E {
        ...
        enqueue(p, R, N) {
          ;(this.i = 0), (this.end = N), (this.current = p), (this.value = R)
        }
        reset() {
        ...
        constructor(h) {
          ;(this._token = void 0),
            ...
            (this._parentListener =
              h && h.onCancellationRequested(this.cancel, this))
        }
        get token() {
    ...
    X(J[6], Z([0, 1, 32, 36]), function (O, n, M, A) {
      'use strict'
      var i
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function L(P, ...U) {
        return U.length === 0
          ? P
          : P.replace(b, function (W, $) {
              const te = parseInt($, 10)
              return isNaN(te) || te < 0 || te >= U.length ? W : U[te]
            })
      }
      n.format = L
      function h(P) {
      ...
      function a(P, U) {
        ...
        for (
          ;
          (ie = P.lastIndexOf(U, te - 1)), !(ie === -1 || ie + W !== te);
      ...
      n.firstNonWhitespaceIndex = C
      function E(P, U = 0, W = P.length) {
        for (let $ = U; $ < W; $++) {
          const te = P.charCodeAt($)
          if (te !== 32 && te !== 9) return P.substring(U, $)
        }
        return P.substring(U, W)
      }
      n.getLeadingWhitespace = E
      function y(P, U = P.length - 1) {
        for (let W = U; W >= 0; W--) {
      ...
      n.compare = v
      function r(P, U, W = 0, $ = P.length, te = 0, ie = U.length) {
        for (; W < $ && te < ie; W++, te++) {
      ...
      function s(P, U) {
        return l(P, U, 0, P.length, 0, U.length)
      }
      n.compareIgnoreCase = s
      function l(P, U, W = 0, $ = P.length, te = 0, ie = U.length) {
        for (; W < $ && te < ie; W++, te++) {
          let ce = P.charCodeAt(W),
            se = U.charCodeAt(te)
          if (ce === se) continue
          if (ce >= 128 || se >= 128)
            return r(P.toLowerCase(), U.toLowerCase(), W, $, te, ie)
          g(ce) && (ce -= 32), g(se) && (se -= 32)
          const he = ce - se
          if (he !== 0) return he
        }
        const oe = $ - W,
      ...
      n.isLowerAsciiLetter = g
      function p(P) {
        return P >= 65 && P <= 90
      }
      n.isUpperAsciiLetter = p
      function R(P, U) {
        return P.length === U.length && l(P, U) === 0
      }
      n.equalsIgnoreCase = R
      function N(P, U) {
        const W = U.length
        return U.length > P.length ? !1 : l(P, U, 0, W) === 0
      }
      n.startsWithIgnoreCase = N
      function D(P, U) {
        const W = Math.min(P.length, U.length)
        let $
        for ($ = 0; $ < W; $++)
          if (P.charCodeAt($) !== U.charCodeAt($)) return $
        return W
      }
      ...
      function x(P, U) {
        ...
        const te = P.length - 1,
          ie = U.length - 1
        for ($ = 0; $ < W; $++)
          if (P.charCodeAt(te - $) !== U.charCodeAt(ie - $)) return $
        return W
      }
      ...
      n.getNextCodePoint = H
      function k(P, U) {
        const W = P.charCodeAt(U - 1)
        if (F(W) && U > 1) {
      ...
      class q {
        ...
        constructor(U, W = 0) {
          ;(this._str = U), (this._len = U.length), (this._offset = W)
        }
        setOffset(U) {
          this._offset = U
        }
        prevCodePoint() {
          const U = k(this._str, this._offset)
          return (this._offset -= U >= 65536 ? 2 : 1), U
        }
        nextCodePoint() {
          const U = H(this._str, this._len, this._offset)
          return (this._offset += U >= 65536 ? 2 : 1), U
        }
        eol() {
      ...
      class I {
        ...
        constructor(U, W = 0) {
          this._iterator = new q(U, W)
        }
        nextGraphemeLength() {
          const U = fe.getInstance(),
            W = this._iterator,
            $ = W.offset
          let te = U.getGraphemeBreakType(W.nextCodePoint())
          for (; !W.eol(); ) {
            const ie = W.offset,
              oe = U.getGraphemeBreakType(W.nextCodePoint())
            if (be(te, oe)) {
              W.setOffset(ie)
              break
            }
        ...
        prevGraphemeLength() {
          const U = fe.getInstance(),
            W = this._iterator,
            $ = W.offset
          let te = U.getGraphemeBreakType(W.prevCodePoint())
          for (; W.offset > 0; ) {
            const ie = W.offset,
              oe = U.getGraphemeBreakType(W.prevCodePoint())
            if (be(oe, te)) {
              W.setOffset(ie)
              break
            }
      ...
      function V(P, U) {
        return new I(P, U).nextGraphemeLength()
      }
      n.nextCharLength = V
      function z(P, U) {
        return new I(P, U).prevGraphemeLength()
      }
      n.prevCharLength = z
      function Y(P, U) {
        U > 0 && F(P.charCodeAt(U)) && U--
        const W = U + V(P, U)
        return [W - z(P, W), W]
      }
      ...
      function Ce(P, U = !1) {
        return P
          ? (U && (P = P.replace(/\\./g, '')), P.toLowerCase() !== P)
          : !1
      }
      ...
      ;(n.AmbiguousCharacters = ee),
        ...
        (ee.cache = new M.LRUCachedFunction((P) => {
          ...
          const ue = U(te._common),
            ce = W(ue, oe)
          return new i(ce)
        })),
        (ee._locales = new A.Lazy(() =>
          Object.keys(i.ambiguousCharacterData.value).filter(
            (P) => !P.startsWith('_')
          )
        ))
      class ne {
        ...
        static getData() {
          return (
            this._data || (this._data = new Set(ne.getRawData())), this._data
          )
        }
        static isInvisibleCharacter(U) {
          return ne.getData().has(U)
        }
    ...
    X(J[39], Z([0, 1, 6]), function (O, n, M) {
      ...
      function L(m, f) {
        f = d(149417, f)
        for (let S = 0, C = m.length; S < C; S++) f = d(m.charCodeAt(S), f)
        return f
      }
      n.stringHash = L
      function h(m, f) {
        return (f = d(104579, f)), m.reduce((S, C) => i(C, S), f)
      }
      function o(m, f) {
        return (
          (f = d(181387, f)),
      ...
      function e(m, f = 0, S = m.byteLength, C = 0) {
        for (let E = 0; E < S; E++) m[f + E] = C
      }
      function a(m, f, S = '0') {
      ...
      class c {
          ...
          for (
            ...
            if (M.isHighSurrogate(v))
              if (r + 1 < S) {
                ...
                M.isLowSurrogate(l)
                  ? (r++, (s = M.computeCodePoint(v, l)))
                  : (s = 65533)
              } else {
                y = v
                break
              }
            else M.isLowSurrogate(v) && (s = 65533)
            if (((E = this._push(C, E, s)), r++, r < S)) v = f.charCodeAt(r)
            else break
          }
        ...
        _step() {
          const f = c._bigBlock32,
            S = this._buffDV
          for (let g = 0; g < 64; g += 4) f.setUint32(g, S.getUint32(g, !1), !1)
          ...
          for (let g = 0; g < 80; g++)
            g < 20
              ? ((s = (E & y) | (~E & v)), (l = 1518500249))
              : g < 40
              ? ((s = E ^ y ^ v), (l = 1859775393))
              : g < 60
              ? ((s = (E & y) | (E & v) | (y & v)), (l = 2400959708))
              : ((s = E ^ y ^ v), (l = 3395469782)),
              (_ = (w(C, 5) + s + r + l + f.getUint32(g * 4, !1)) & 4294967295),
              (r = v),
              (v = y),
              (y = w(E, 30)),
              (E = C),
    ...
    X(J[24], Z([0, 1, 34, 39]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function d(w, e, a) {
        return new o(new i(w), new i(e)).ComputeDiff(a).changes
      }
      n.stringDiff = d
      class b {
        static Assert(e, a) {
      ...
      class o {
        ...
        _ComputeDiff(e, a, u, c, m) {
          ...
          return (
            m && (S = this.PrettifyChanges(S)), { quitEarly: f[0], changes: S }
          )
        }
        ComputeDiffRecursive(e, a, u, c, m) {
          for (m[0] = !1; e <= a && u <= c && this.ElementsAreEqual(e, u); )
            e++, u++
            ...
            return (
              u <= c
                ? (b.Assert(
                  ...
                  (v = [new M.DiffChange(e, 0, u, c - u + 1)]))
                : e <= a
                ? (b.Assert(
                    u === c + 1,
                    'modifiedStart should only be one more than modifiedEnd'
                  ),
                  (v = [new M.DiffChange(e, a - e + 1, u, 0)]))
                : (b.Assert(
                    e === a + 1,
                    'originalStart should only be one more than originalEnd'
                  ),
          ...
          const f = [0],
            S = [0],
            C = this.ComputeRecursionPoint(e, a, u, c, f, S, m),
            E = f[0],
            y = S[0]
          if (C !== null) return C
          if (!m[0]) {
            const v = this.ComputeDiffRecursive(e, E, u, y, m)
            let r = []
            return (
              m[0]
                ? (r = [
        ...
        WALKTRACE(e, a, u, c, m, f, S, C, E, y, v, r, s, l, _, g, p, R) {
          let N = null,
            D = null,
            x = new h(),
            T = a,
          ...
          do {
            ...
            q === T || (q < F && E[q - 1] < E[q + 1])
              ? ((v = E[q + 1]),
                (l = v - B - c),
                v < H && x.MarkNextChange(),
                (H = v),
                x.AddModifiedElement(v + 1, l),
                (B = q + 1 - e))
              : ((v = E[q - 1] + 1),
                (l = v - B - c),
                v < H && x.MarkNextChange(),
                (H = v - 1),
                x.AddOriginalElement(v, l + 1),
                (B = q - 1 - e)),
              k >= 0 &&
          ...
          if (((N = x.getReverseChanges()), R[0])) {
            ...
            if (N !== null && N.length > 0) {
              ...
              ;(q = Math.max(q, V.getOriginalEnd())),
                (I = Math.max(I, V.getModifiedEnd()))
            }
            D = [new M.DiffChange(q, r - q + 1, I, _ - I + 1)]
          } else {
            ;(x = new h()),
              (T = f),
              (F = S),
            ...
            do {
              ...
              q === T || (q < F && y[q - 1] >= y[q + 1])
                ? ((v = y[q + 1] - 1),
                  ...
                  v > H && x.MarkNextChange(),
                  (H = v + 1),
                  x.AddOriginalElement(v + 1, l + 1),
                  (B = q + 1 - m))
                : ((v = y[q - 1]),
                  (l = v - B - C),
                  v > H && x.MarkNextChange(),
                  (H = v),
                  x.AddModifiedElement(v + 1, l + 1),
                  (B = q - 1 - m)),
                k >= 0 &&
        ...
        ComputeRecursionPoint(e, a, u, c, m, f, S) {
          ...
          for (let B = 1; B <= l / 2 + 1; B++) {
            let H = 0,
              k = 0
            ;(y = this.ClipDiagonalBound(R - B, B, R, _)),
              (v = this.ClipDiagonalBound(R + B, B, R, _))
            for (let I = y; I <= v; I += 2) {
              I === y || (I < v && g[I - 1] < g[I + 1])
                ? (C = g[I + 1])
                : (C = g[I - 1] + 1),
                (E = C - (I - R) - D)
              const V = C
              for (; C < a && E < c && this.ElementsAreEqual(C + 1, E + 1); )
                C++, E++
              if (
                ((g[I] = C),
                C + E > H + k && ((H = C), (k = E)),
                !F && Math.abs(I - N) <= B - 1 && C >= p[I])
              )
                return (
                  (m[0] = C),
                  (f[0] = E),
                  V <= p[I] && 1447 > 0 && B <= 1447 + 1
                    ? this.WALKTRACE(
                        R,
                        y,
                        v,
            ...
            if (
              ...
              !this.ContinueProcessingPredicate(H, q)
            )
              return (
                (S[0] = !0),
                (m[0] = H),
            ...
            ;(r = this.ClipDiagonalBound(N - B, B, N, _)),
              (s = this.ClipDiagonalBound(N + B, B, N, _))
            for (let I = r; I <= s; I += 2) {
              I === r || (I < s && p[I - 1] >= p[I + 1])
                ? (C = p[I + 1] - 1)
                : (C = p[I - 1]),
                (E = C - (I - N) - x)
              const V = C
              for (; C > e && E > u && this.ElementsAreEqual(C, E); ) C--, E--
              if (((p[I] = C), F && Math.abs(I - R) <= B && C <= g[I]))
                return (
                  (m[0] = C),
                  (f[0] = E),
                  V >= g[I] && 1447 > 0 && B <= 1447 + 1
                    ? this.WALKTRACE(
                        R,
                        y,
                        v,
            ...
            if (B <= 1447) {
              let I = new Int32Array(v - y + 2)
              ;(I[0] = R - y + 1),
                L.Copy2(g, y, I, 1, v - y + 1),
                this.m_forwardHistory.push(I),
                (I = new Int32Array(s - r + 2)),
                (I[0] = N - r + 1),
                L.Copy2(p, r, I, 1, s - r + 1),
        ...
        PrettifyChanges(e) {
          for (let a = 0; a < e.length; a++) {
            ...
            const C = [null]
            if (a < e.length - 1 && this.ChangesOverlap(e[a], e[a + 1], C)) {
              ;(e[a] = C[0]), e.splice(a + 1, 1), a--
              continue
            }
          }
          for (let a = e.length - 1; a >= 0; a--) {
            ...
            if (a > 0) {
              ...
              ;(c = v.originalStart + v.originalLength),
                (m = v.modifiedStart + v.modifiedLength)
            }
            ...
            for (let v = 1; ; v++) {
              const r = u.originalStart - v,
                s = u.modifiedStart - v
              if (
                r < c ||
                s < m ||
                (f &&
                  !this.OriginalElementsAreEqual(r, r + u.originalLength)) ||
            ...
            ;(u.originalStart -= C), (u.modifiedStart -= C)
            const y = [null]
          ...
          if (this._hasStrings)
            for (let a = 1, u = e.length; a < u; a++) {
              const c = e[a - 1],
                ...
                S = c.originalStart,
                C = m.originalStart + m.originalLength,
                E = C - S,
                y = c.modifiedStart,
                v = m.modifiedStart + m.modifiedLength,
                r = v - y
              if (f < 5 && E < 20 && r < 20) {
                ...
                if (s) {
                  ...
                  ;(l !== c.originalStart + c.originalLength ||
                    _ !== c.modifiedStart + c.modifiedLength) &&
                    ((c.originalLength = l - c.originalStart),
                    (c.modifiedLength = _ - c.modifiedStart),
                    (m.originalStart = l + f),
                    (m.modifiedStart = _ + f),
                    (m.originalLength = C - m.originalStart),
                    (m.modifiedLength = v - m.modifiedStart))
                }
              }
            }
          return e
        ...
        _findBetterContiguousSequence(e, a, u, c, m) {
          ...
          for (let v = e; v < f; v++)
            for (let r = u; r < S; r++) {
              const s = this._contiguousSequenceScore(v, r, m)
              s > 0 && s > C && ((C = s), (E = v), (y = r))
            }
          return C > 0 ? [E, y] : null
        }
        ...
        ConcatenateChanges(e, a) {
          ...
          if (this.ChangesOverlap(e[e.length - 1], a[0], u)) {
            ...
            return (
              L.Copy(e, 0, c, 0, e.length),
              L.Copy(a, 0, c, e.length, a.length),
              c
            )
          }
        }
    ...
    X(J[25], Z([0, 1]), function (O, n) {
      ...
      n.isFunction = u
      function c(f, S) {
        const C = Math.min(f.length, S.length)
        for (let E = 0; E < C; E++) m(f[E], S[E])
      }
    ...
    X(J[40], Z([0, 1, 25]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function i(b, L) {
        if ((0, M.isString)(L)) {
          const h = A[L]
          if (h === void 0)
            throw new Error(`${b} references an unknown codicon: ${L}`)
          L = h
        }
        return (A[b] = L), { id: b }
      }
    ...
    X(J[14], Z([0, 1, 25]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.createProxyObject =
          n.getAllMethodNames =
      ...
      function L(u, c, m) {
        ...
        if (Array.isArray(u)) {
          const S = []
          for (const C of u) S.push(L(C, c, m))
          return S
        }
        if ((0, M.isObject)(u)) {
          ...
          m.add(u)
          const S = {}
          for (const C in u) d.call(u, C) && (S[C] = L(u[C], c, m))
          return m.delete(u), S
        }
        return u
      }
      ...
      function w(u) {
        ...
        for (; Object.prototype !== u; )
          (c = c.concat(Object.getOwnPropertyNames(u))),
      ...
      function e(u) {
        const c = []
        for (const m of w(u)) typeof u[m] == 'function' && c.push(m)
        return c
      }
    ...
    X(J[27], Z([0, 1, 26]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.CharacterSet = n.CharacterClassifier = void 0)
      class A {
        constructor(b) {
          const L = (0, M.toUint8)(b)
        ...
        get(b) {
          return b >= 0 && b < 256
            ? this._asciiMap[b]
            : this._map.get(b) || this._defaultValue
        }
        clear() {
    ...
    X(J[3], Z([0, 1, 5]), function (O, n, M) {
      ...
      class A {
        static addRange(b, L) {
          let h = 0
          for (; h < L.length && L[h].endExclusive < b.start; ) h++
          let o = h
          for (; o < L.length && L[o].start <= b.endExclusive; ) o++
          if (h === o) L.splice(h, 0, b)
          else {
            const w = Math.min(b.start, L[h].start),
              e = Math.max(b.endExclusive, L[o - 1].endExclusive)
            L.splice(h, o - h, new A(w, e))
          }
        }
        static ofLength(b) {
          return new A(0, b)
        }
        static ofStartAndLength(b, L) {
          return new A(b, b + L)
        }
        constructor(b, L) {
          if (((this.start = b), (this.endExclusive = L), b > L))
        ...
        join(b) {
          return new A(
            ...
            Math.max(this.endExclusive, b.endExclusive)
          )
        }
        intersect(b) {
          const L = Math.max(this.start, b.start),
        ...
        forEach(b) {
          for (let L = this.start; L < this.endExclusive; L++) b(L)
        }
      }
      n.OffsetRange = A
      class i {
        ...
        addRange(b) {
          ...
          for (
            ...
            this._sortedRanges[L].endExclusive < b.start;
          ...
          for (
            ...
            this._sortedRanges[h].start <= b.endExclusive;

          )
            h++
          if (L === h) this._sortedRanges.splice(L, 0, b)
          else {
            const o = Math.min(b.start, this._sortedRanges[L].start),
              w = Math.max(
                b.endExclusive,
                this._sortedRanges[h - 1].endExclusive
              )
            this._sortedRanges.splice(L, h - L, new A(o, w))
          }
        }
        toString() {
        ...
        intersectsStrict(b) {
          ...
          return (
            L < this._sortedRanges.length &&
            this._sortedRanges[L].start < b.endExclusive
          )
        }
        ...
        get length() {
          return this._sortedRanges.reduce((b, L) => b + L.length, 0)
        }
      }
      n.OffsetRangeSet = i
    }),
    ...
    X(J[2], Z([0, 1, 4]), function (O, n, M) {
      ...
      class A {
        ...
        static plusRange(d, b) {
          ...
          return (
            b.startLineNumber < d.startLineNumber
              ? ((L = b.startLineNumber), (h = b.startColumn))
              : b.startLineNumber === d.startLineNumber
              ? ((L = b.startLineNumber),
                (h = Math.min(b.startColumn, d.startColumn)))
              : ((L = d.startLineNumber), (h = d.startColumn)),
            b.endLineNumber > d.endLineNumber
              ? ((o = b.endLineNumber), (w = b.endColumn))
              : b.endLineNumber === d.endLineNumber
              ? ((o = b.endLineNumber),
                (w = Math.max(b.endColumn, d.endColumn)))
              : ((o = d.endLineNumber), (w = d.endColumn)),
            new A(L, h, o, w)
          )
        }
        intersectRanges(d) {
        ...
        static intersectRanges(d, b) {
          ...
          return (
            ...
            o > u ? ((o = u), (w = c)) : o === u && (w = Math.min(w, c)),
            L > o || (L === o && h > w) ? null : new A(L, h, o, w)
          )
        }
        equalsRange(d) {
        ...
        static areIntersectingOrTouching(d, b) {
          return !(
            ...
            (d.endLineNumber === b.startLineNumber &&
              d.endColumn < b.startColumn) ||
            b.endLineNumber < d.startLineNumber ||
            (b.endLineNumber === d.startLineNumber &&
              b.endColumn < d.startColumn)
          )
        }
    ...
    X(J[10], Z([0, 1, 5, 3, 2, 11]), function (O, n, M, A, i, d) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.LineRangeSet = n.LineRange = void 0)
      class b {
        static fromRange(o) {
          return new b(o.startLineNumber, o.endLineNumber)
        }
        ...
        static joinMany(o) {
          ...
          let w = new L(o[0].slice())
          for (let e = 1; e < o.length; e++) w = w.getUnion(new L(o[e].slice()))
          return w.ranges
        }
        static ofLength(o, w) {
          return new b(o, o + w)
        ...
        constructor(o, w) {
          if (o > w)
            throw new M.BugIndicatingError(
              `startLineNumber ${o} cannot be after endLineNumberExclusive ${w}`
            )
          ;(this.startLineNumber = o), (this.endLineNumberExclusive = w)
        }
        contains(o) {
        ...
        intersect(o) {
          const w = Math.max(this.startLineNumber, o.startLineNumber),
            e = Math.min(this.endLineNumberExclusive, o.endLineNumberExclusive)
          if (w <= e) return new b(w, e)
        }
        intersectsStrict(o) {
          return (
      ...
      class L {
        ...
        addRange(o) {
          if (o.length === 0) return
          const w = (0, d.findFirstIdxMonotonousOrArrLen)(
          ...
          if (w === e) this._normalizedRanges.splice(w, 0, o)
          else if (w === e - 1) {
            const a = this._normalizedRanges[w]
            this._normalizedRanges[w] = a.join(o)
          } else {
            const a = this._normalizedRanges[w]
              .join(this._normalizedRanges[e - 1])
              .join(o)
            this._normalizedRanges.splice(w, e - w, a)
          }
        }
        contains(o) {
          const w = (0, d.findLastMonotonous)(
            this._normalizedRanges,
            (e) => e.startLineNumber <= o
          )
          return !!w && w.endLineNumberExclusive > o
        }
        intersects(o) {
          const w = (0, d.findLastMonotonous)(
            this._normalizedRanges,
          ...
          return !!w && w.endLineNumberExclusive > o.startLineNumber
        }
        getUnion(o) {
          ...
          for (
            ;
            e < this._normalizedRanges.length || a < o._normalizedRanges.length;

          ) {
            let c = null
            if (
              e < this._normalizedRanges.length &&
              a < o._normalizedRanges.length
            ) {
              const m = this._normalizedRanges[e],
                f = o._normalizedRanges[a]
              m.startLineNumber < f.startLineNumber
                ? ((c = m), e++)
                : ((c = f), a++)
            } else
              e < this._normalizedRanges.length
          ...
          return u !== null && w.push(u), new L(w)
        }
        subtractFrom(o) {
          const w = (0, d.findFirstIdxMonotonousOrArrLen)(
              this._normalizedRanges,
          ...
          if (w === e) return new L([o])
          const a = []
          let u = o.startLineNumber
          for (let c = w; c < e; c++) {
            const m = this._normalizedRanges[c]
            m.startLineNumber > u && a.push(new b(u, m.startLineNumber)),
              (u = m.endLineNumberExclusive)
          }
          return (
            u < o.endLineNumberExclusive &&
              a.push(new b(u, o.endLineNumberExclusive)),
            new L(a)
          )
        }
        toString() {
        ...
        getIntersection(o) {
          ...
          for (
            ...
            const u = this._normalizedRanges[e],
              ...
              m = u.intersect(c)
            m && !m.isEmpty && w.push(m),
              u.endLineNumberExclusive < c.endLineNumberExclusive ? e++ : a++
          }
          return new L(w)
        }
        getWithDelta(o) {
          return new L(this._normalizedRanges.map((w) => w.delta(o)))
        }
      }
      n.LineRangeSet = L
    }),
    X(J[41], Z([0, 1, 4, 2]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.Selection = void 0)
      class i extends A.Range {
        ...
        static selectionsEqual(b, L) {
          return (
            b.selectionStartLineNumber === L.selectionStartLineNumber &&
            b.selectionStartColumn === L.selectionStartColumn &&
            b.positionLineNumber === L.positionLineNumber &&
            b.positionColumn === L.positionColumn
          )
        }
        getDirection() {
        ...
        setEndPosition(b, L) {
          return this.getDirection() === 0
            ? new i(this.startLineNumber, this.startColumn, b, L)
            : new i(b, L, this.startLineNumber, this.startColumn)
        }
        getPosition() {
        ...
        setStartPosition(b, L) {
          return this.getDirection() === 0
            ? new i(b, L, this.endLineNumber, this.endColumn)
            : new i(this.endLineNumber, this.endColumn, b, L)
        }
        static fromPositions(b, L = b) {
          return new i(b.lineNumber, b.column, L.lineNumber, L.column)
        }
        static fromRange(b, L) {
          return L === 0
            ? new i(
                b.startLineNumber,
                b.startColumn,
        ...
        static liftSelection(b) {
          return new i(
            ...
            b.selectionStartColumn,
            b.positionLineNumber,
            b.positionColumn
          )
        }
        static selectionsArrEqual(b, L) {
          if ((b && !L) || (!b && L)) return !1
          if (!b && !L) return !0
          if (b.length !== L.length) return !1
          for (let h = 0, o = b.length; h < o; h++)
            if (!this.selectionsEqual(b[h], L[h])) return !1
          return !0
        }
        ...
        static createWithDirection(b, L, h, o, w) {
          return w === 0 ? new i(b, L, h, o) : new i(h, o, b, L)
        }
      }
      n.Selection = i
    }),
    X(J[42], Z([0, 1, 27]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class A extends M.CharacterClassifier {
        constructor(b) {
          super(0)
          for (let L = 0, h = b.length; L < h; L++) this.set(b.charCodeAt(L), 2)
      ...
      function i(d) {
        const b = {}
        return (L) => (b.hasOwnProperty(L) || (b[L] = d(L)), b[L])
      }
      n.getMapForWordSeparators = i((d) => new A(d))
    }),
    X(J[28], Z([0, 1, 21, 22]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.getWordAtText =
      ...
      function L(o, w, e, a, u) {
        if (((w = d(w)), u || (u = M.Iterable.first(b)), e.length > u.maxLen)) {
          let C = o - u.maxLen / 2
          return (
            C < 0 ? (C = 0) : (a += C),
            (e = e.substring(C, o + u.maxLen / 2)),
            L(o, w, e, a, u)
          )
        }
        const c = Date.now(),
        ...
        let f = -1,
          S = null
        for (let C = 1; !(Date.now() - c >= u.timeBudget); C++) {
          const E = m - u.windowSize * C
          w.lastIndex = Math.max(0, E)
          const y = h(w, e, m, f)
    ...
    X(J[8], Z([0, 1, 7, 5, 3]), function (O, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.DateTimeout =
          n.InfiniteTimeout =
      ...
      class d {
        static trivial(e, a) {
          return new d(
            [
              new b(
                i.OffsetRange.ofLength(e.length),
                i.OffsetRange.ofLength(a.length)
              ),
            ],
            !1
          )
      ...
      class b {
                ...
                b.fromOffsetPairs(
                  ...
                  m
                    ...
                    : new L(
                        a,
                        (c
                          ? c.seq2Range.endExclusive - c.seq1Range.endExclusive
                          : 0) + a
                      )
                )
              )
        ...
        delta(e) {
          return e === 0
            ? this
            : new b(this.seq1Range.delta(e), this.seq2Range.delta(e))
        }
        deltaStart(e) {
          return e === 0
            ? this
            : new b(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e))
        }
        deltaEnd(e) {
          return e === 0
            ? this
            : new b(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e))
        }
        intersect(e) {
      ...
      class L {
        ...
        delta(e) {
          return e === 0 ? this : new L(this.offset1 + e, this.offset2 + e)
        }
      }
      ;(n.OffsetPair = L),
        (L.zero = new L(0, 0)),
    ...
    X(J[29], Z([0, 1, 3, 8]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.MyersDiffAlgorithm = void 0)
      class i {
        compute(o, w, e = A.InfiniteTimeout.instance) {
          if (o.length === 0 || w.length === 0)
            return A.DiffAlgorithmResult.trivial(o, w)
          const a = o,
            u = w
          function c(s, l) {
            for (
          ...
          e: for (;;) {
            if ((m++, !e.isValid()))
              return A.DiffAlgorithmResult.trivialTimedOut(a, u)
            const s = -Math.min(m, u.length + (m % 2)),
              l = Math.min(m, a.length + (m % 2))
            for (C = s; C <= l; C += 2) {
              let _ = 0
              const g = C === l ? -1 : f.get(C + 1),
                p = C === s ? -1 : f.get(C - 1) + 1
              _++
              const R = Math.min(Math.max(g, p), a.length),
                N = R - C
              if ((_++, R > a.length || N > u.length)) continue
              const D = c(R, N)
              f.set(C, D)
              const x = R === g ? S.get(C + 1) : S.get(C - 1)
              if (
                (S.set(C, D !== R ? new d(x, R, N, D - R) : x),
                f.get(C) === a.length && f.get(C) - C === u.length)
              )
                break e
            }
          }
      ...
      class d {
        constructor(o, w, e, a) {
          ;(this.prev = o), (this.x = w), (this.y = e), (this.length = a)
        }
      }
      class b {
        constructor() {
      ...
      class L {
        ...
        set(o, w) {
          o < 0
            ? ((o = -o - 1), (this.negativeArr[o] = w))
            : (this.positiveArr[o] = w)
        }
      }
    }),
    X(J[43], Z([0, 1, 7, 3, 8]), function (O, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function d(c, m, f) {
        let S = f
        return (S = b(c, m, S)), (S = b(c, m, S)), (S = L(c, m, S)), S
      }
      ...
      function b(c, m, f) {
        ...
        for (let E = 1; E < f.length; E++) {
          ...
          if (v.seq1Range.isEmpty || v.seq2Range.isEmpty) {
            const r = v.seq1Range.start - y.seq1Range.endExclusive
            let s
            for (
              s = 1;
              s <= r &&
              !(
                c.getElement(v.seq1Range.start - s) !==
                  c.getElement(v.seq1Range.endExclusive - s) ||
                m.getElement(v.seq2Range.start - s) !==
                  m.getElement(v.seq2Range.endExclusive - s)
              );
              s++
            );
            if ((s--, s === r)) {
              S[S.length - 1] = new i.SequenceDiff(
                new A.OffsetRange(
                  y.seq1Range.start,
                  v.seq1Range.endExclusive - r
                ),
                new A.OffsetRange(
                  y.seq2Range.start,
                  v.seq2Range.endExclusive - r
                )
              )
              continue
            }
        ...
        for (let E = 0; E < S.length - 1; E++) {
          ...
          let v = S[E]
          if (v.seq1Range.isEmpty || v.seq2Range.isEmpty) {
            const r = y.seq1Range.start - v.seq1Range.endExclusive
            let s
            for (
              s = 0;
              s < r &&
              !(
                !c.isStronglyEqual(
                  v.seq1Range.start + s,
                  v.seq1Range.endExclusive + s
                ) ||
                !m.isStronglyEqual(
                  v.seq2Range.start + s,
                  v.seq2Range.endExclusive + s
                )
              );
              s++
            );
            if (s === r) {
              S[E + 1] = new i.SequenceDiff(
                new A.OffsetRange(
                  v.seq1Range.start + r,
                  y.seq1Range.endExclusive
                ),
                new A.OffsetRange(
                  v.seq2Range.start + r,
                  y.seq2Range.endExclusive
                )
              )
              continue
            }
        ...
        return S.length > 0 && C.push(S[S.length - 1]), C
      }
      function L(c, m, f) {
        if (!c.getBoundaryScore || !m.getBoundaryScore) return f
        for (let S = 0; S < f.length; S++) {
          const C = S > 0 ? f[S - 1] : void 0,
            E = f[S],
            y = S + 1 < f.length ? f[S + 1] : void 0,
            v = new A.OffsetRange(
              C ? C.seq1Range.start + 1 : 0,
              y ? y.seq1Range.endExclusive - 1 : c.length
            ),
            r = new A.OffsetRange(
              C ? C.seq2Range.start + 1 : 0,
              y ? y.seq2Range.endExclusive - 1 : m.length
            )
          E.seq1Range.isEmpty
            ? (f[S] = h(E, c, m, v, r))
            : E.seq2Range.isEmpty && (f[S] = h(E.swap(), m, c, r, v).swap())
        }
        return f
      }
      function h(c, m, f, S, C) {
        let y = 1
        for (
          ;
          c.seq1Range.start - y >= S.start &&
          c.seq2Range.start - y >= C.start &&
          f.isStronglyEqual(
            c.seq2Range.start - y,
            c.seq2Range.endExclusive - y
          ) &&
          y < 100;
        ...
        for (
          ;
          c.seq1Range.start + v < S.endExclusive &&
          c.seq2Range.endExclusive + v < C.endExclusive &&
          f.isStronglyEqual(
            c.seq2Range.start + v,
            c.seq2Range.endExclusive + v
          ) &&
          v < 100;
        ...
        for (let l = -y; l <= v; l++) {
          const _ = c.seq2Range.start + l,
            ...
            p = c.seq1Range.start + l,
            R =
              m.getBoundaryScore(p) +
              f.getBoundaryScore(_) +
      ...
      function o(c, m, f) {
        ...
        for (const C of f) {
          ...
          C.seq1Range.start - E.seq1Range.endExclusive <= 2 ||
          C.seq2Range.start - E.seq2Range.endExclusive <= 2
            ? (S[S.length - 1] = new i.SequenceDiff(
                E.seq1Range.join(C.seq1Range),
                E.seq2Range.join(C.seq2Range)
              ))
            : S.push(C)
        }
        return S
      ...
      function w(c, m, f) {
        const S = i.SequenceDiff.invert(f, c.length),
          C = []
        ...
        function y(r, s) {
          ...
          const p = g.intersect(s)
          let R = p.seq1Range.length,
            N = p.seq2Range.length
          for (; S.length > 0; ) {
            const D = S[0]
            ...
            const T = c.findWordContaining(D.seq1Range.start),
              ...
              H = B.intersect(D)
            if (
              ((R += H.seq1Range.length),
              (N += H.seq2Range.length),
              (g = g.join(B)),
          ...
          R + N < ((g.seq1Range.length + g.seq2Range.length) * 2) / 3 &&
            C.push(new i.SequenceDiff(l, _)),
            (E = g.getEndExclusives())
        }
        for (; S.length > 0; ) {
          const r = S.shift()
          r.seq1Range.isEmpty ||
            (y(r.getStarts(), r), y(r.getEndExclusives().delta(-1), r))
        }
        return e(f, C)
      }
      n.extendDiffsToEntireWordIfAppropriate = w
      function e(c, m) {
        const f = []
        for (; c.length > 0 || m.length > 0; ) {
          const S = c[0],
            C = m[0]
          let E
          S && (!C || S.seq1Range.start < C.seq1Range.start)
            ? (E = c.shift())
            : (E = m.shift()),
            f.length > 0 &&
            f[f.length - 1].seq1Range.endExclusive >= E.seq1Range.start
      ...
      function a(c, m, f) {
        ...
        do {
          ...
          for (let v = 1; v < S.length; v++) {
            let l = function (g, p) {
              const R = new A.OffsetRange(
                s.seq1Range.endExclusive,
                r.seq1Range.start
              )
              return (
      ...
      function u(c, m, f) {
        ...
        do {
          ...
          for (let r = 1; r < S.length; r++) {
            let _ = function (p, R) {
              ...
              const T = c.countLinesIn(p.seq1Range),
                F = p.seq1Range.length,
                B = m.countLinesIn(p.seq2Range),
                H = p.seq2Range.length,
                k = c.countLinesIn(R.seq1Range),
                q = R.seq1Range.length,
              ...
              return (
                Math.pow(
                  Math.pow(Y(T * 40 + F), 1.5) + Math.pow(Y(B * 40 + H), 1.5),
                  1.5
                ) +
                  Math.pow(
                    Math.pow(Y(k * 40 + q), 1.5) + Math.pow(Y(I * 40 + V), 1.5),
                    1.5
                  ) >
                (z ** 1.5) ** 1.5 * 1.3
              )
            ...
            const s = S[r],
              l = v[v.length - 1]
            _(l, s)
              ? ((E = !0), (v[v.length - 1] = v[v.length - 1].join(s)))
              : v.push(s)
          }
          S = v
        } while (C++ < 10 && E)
        const y = []
        return (
          (0, M.forEachWithNeighbors)(S, (v, r, s) => {
            let l = r
            function _(x) {
              return (
                x.length > 0 &&
            ...
            const g = c.extendToFullLines(r.seq1Range),
              p = c.getText(new A.OffsetRange(g.start, r.seq1Range.start))
            _(p) && (l = l.deltaStart(-p.length))
            const R = c.getText(
              new A.OffsetRange(r.seq1Range.endExclusive, g.endExclusive)
            )
            _(R) && (l = l.deltaEnd(R.length))
            const N = i.SequenceDiff.fromOffsetPairs(
                v ? v.getEndExclusives() : i.OffsetPair.zero,
...
`)
      ...
      function A(i) {
        ...
        for (
          ;
          d < i.length && (i.charCodeAt(d) === 32 || i.charCodeAt(d) === 9);
    ...
    X(J[15], Z([0, 1]), function (O, n) {
      ...
      class M {
        constructor(b, L) {
          ;(this.width = b),
            (this.height = L),
            (this.array = []),
            (this.array = new Array(b * L))
        }
        get(b, L) {
          return this.array[b + L * this.width]
        }
        set(b, L, h) {
          this.array[b + L * this.width] = h
        }
      }
      n.Array2D = M
      function A(d) {
      ...
      class i {
        static getKey(b) {
          let L = this.chrKeys.get(b)
          return (
            L === void 0 && ((L = this.chrKeys.size), this.chrKeys.set(b, L)), L
          )
        }
        constructor(b, L, h) {
          ;(this.range = b),
          ...
          let o = 0
          for (
            let w = b.startLineNumber - 1;
            w < b.endLineNumberExclusive - 1;
            w++
          ) {
            const e = L[w]
...
`)
        ...
        computeSimilarity(b) {
          var L, h
          let o = 0
          const w = Math.max(this.histogram.length, b.histogram.length)
          for (let e = 0; e < w; e++)
            o += Math.abs(
    ...
    X(J[45], Z([0, 1, 3, 8, 15]), function (O, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.DynamicProgrammingDiffing = void 0)
      class d {
        compute(L, h, o = A.InfiniteTimeout.instance, w) {
          if (L.length === 0 || h.length === 0)
            return A.DiffAlgorithmResult.trivial(L, h)
          ...
          for (let y = 0; y < L.length; y++)
            for (let v = 0; v < h.length; v++) {
              if (!o.isValid())
                return A.DiffAlgorithmResult.trivialTimedOut(L, h)
              const r = y === 0 ? 0 : e.get(y - 1, v),
                s = v === 0 ? 0 : e.get(y, v - 1)
              let l
              L.getElement(y) === h.getElement(v)
                ? (y === 0 || v === 0 ? (l = 0) : (l = e.get(y - 1, v - 1)),
                  y > 0 &&
                    v > 0 &&
                    a.get(y - 1, v - 1) === 3 &&
                    (l += u.get(y - 1, v - 1)),
              ...
              if (_ === l) {
                const g = y > 0 && v > 0 ? u.get(y - 1, v - 1) : 0
                u.set(y, v, g + 1), a.set(y, v, 3)
              } else
                _ === r
                  ? (u.set(y, v, 0), a.set(y, v, 1))
                  : _ === s && (u.set(y, v, 0), a.set(y, v, 2))
              e.set(y, v, _)
            }
          const c = []
          let m = L.length,
    ...
    X(J[30], Z([0, 1, 11, 3, 4, 2, 15]), function (O, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class L {
        constructor(u, c, m) {
          ...
          for (
            let S = this.lineRange.start;
            S < this.lineRange.endExclusive;
            S++
          ) {
            let C = u[S],
              E = 0
            if (f) (E = C.length), (C = ''), (f = !1)
            else if (!m) {
              const y = C.trimStart()
              ;(E = C.length - y.length), (C = y.trimEnd())
            }
            this.additionalOffsetByLine.push(E)
            for (let y = 0; y < C.length; y++)
              this.elements.push(C.charCodeAt(y))
            S < u.length - 1 &&
              (this.elements.push(
                `
`.charCodeAt(0)
        ...
        translateOffset(u) {
          if (this.lineRange.isEmpty)
            return new i.Position(this.lineRange.start + 1, 1)
          ...
          return new i.Position(
            ...
            u -
              this.firstCharOffsetByLine[c] +
              this.additionalOffsetByLine[c] +
              1
          )
        }
        translateRange(u) {
    ...
    X(J[31], Z([0, 1]), function (O, n) {
      ...
      class M {
        constructor(d, b, L) {
          ;(this.changes = d), (this.moves = b), (this.hitTimeout = L)
        }
      }
      n.LinesDiff = M
      class A {
    ...
    X(J[16], Z([0, 1, 10]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.RangeMapping =
      ...
      class A {
        static inverse(L, h, o) {
          ...
          for (const c of L) {
            ...
            m.modified.isEmpty || w.push(m),
              (e = c.original.endLineNumberExclusive),
              (a = c.modified.endLineNumberExclusive)
          }
          const u = new i(
            new M.LineRange(e, h + 1),
            new M.LineRange(a, o + 1),
            void 0
          )
          return u.modified.isEmpty || w.push(u), w
        }
        constructor(L, h) {
        ...
        join(L) {
          return new A(
            this.original.join(L.original),
            this.modified.join(L.modified)
          )
        }
      }
    ...
    X(
      ...
      function (O, n, M, A, i, d, b, L, h, o, w, e) {
        'use strict'
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.computeMovedLines = void 0)
        function a(E, y, v, r, s, l) {
          let { moves: _, excludedChanges: g } = c(E, y, v, l)
          if (!l.isValid()) return []
          const p = E.filter((N) => !g.has(N)),
            R = m(p, r, s, y, v, l)
          return (
            (0, i.pushMany)(_, R),
            (_ = S(_)),
...
`).length >= 15 && u(D, (T) => T.length >= 2) >= 2
        ...
        function u(E, y) {
          let v = 0
          for (const r of E) y(r) && v++
          return v
        }
        function c(E, y, v, r) {
          const s = [],
            l = E.filter(
              (p) => p.modified.isEmpty && p.original.length >= 3
            ).map((p) => new w.LineRangeFragment(p.original, y, p)),
            _ = new Set(
              E.filter((p) => p.original.isEmpty && p.modified.length >= 3).map(
                (p) => new w.LineRangeFragment(p.modified, v, p)
              )
            ),
            g = new Set()
          for (const p of l) {
            ...
            if (
              (R > 0.9 &&
                N &&
                (_.delete(N),
                s.push(new A.LineRangeMapping(p.range, N.range)),
                g.add(p.source),
                g.add(N.source)),
              !r.isValid())
            )
        ...
        function m(E, y, v, r, s, l) {
          ...
          for (const x of E)
            for (
              ...
              g.add(F, { range: new L.LineRange(T, T + 3) })
            }
          const p = []
          E.sort(
            (0, i.compareBy)(
              (x) => x.modified.startLineNumber,
              i.numberComparator
            )
          )
          for (const x of E) {
            ...
            for (
              ...
              const B = `${v[F - 1]}:${v[F + 1 - 1]}:${v[F + 2 - 1]}`,
                H = new L.LineRange(F, F + 3),
                k = []
              g.forEach(B, ({ range: q }) => {
                for (const V of T)
                  if (
                    V.originalLineRange.endLineNumberExclusive + 1 ===
                      q.endLineNumberExclusive &&
                ...
                const I = { modifiedLineRange: H, originalLineRange: q }
                p.push(I), k.push(I)
              }),
                (T = k)
            }
          ...
          for (const x of p) {
            const T =
              ...
              H = F.getIntersection(B)
            for (const k of H.ranges) {
              if (k.length < 3) continue
              const q = k,
                I = k.delta(-T)
              _.push(new A.LineRangeMapping(I, q)), R.addRange(q), N.addRange(I)
            }
          }
          _.sort(
            (0, i.compareBy)(
              (x) => x.original.startLineNumber,
              i.numberComparator
            )
          )
          ...
          for (let x = 0; x < _.length; x++) {
            ...
            let z
            for (z = 0; z < I; z++) {
              const Y = T.original.endLineNumberExclusive + z,
            ...
            z > 0 &&
              (N.addRange(
                new L.LineRange(
                  T.original.endLineNumberExclusive,
                  T.original.endLineNumberExclusive + z
                )
              ),
              R.addRange(
                new L.LineRange(
                  T.modified.endLineNumberExclusive,
                  T.modified.endLineNumberExclusive + z
                )
              )),
              (V > 0 || z > 0) &&
        ...
        function f(E, y, v) {
          ...
          for (const N of _)
            N.seq1Range.forEach((D) => {
              ;(0, w.isSpace)(E.charCodeAt(D)) || l++
            })
          function g(N) {
            let D = 0
            for (let x = 0; x < E.length; x++)
              (0, w.isSpace)(N.charCodeAt(x)) || D++
            return D
          }
          const p = g(E.length > y.length ? E : y)
          return l / p > 0.6 && p > 10
        }
        function S(E) {
          ...
          for (let v = 1; v < E.length; v++) {
            const r = y[y.length - 1],
              s = E[v],
              l =
                s.original.startLineNumber - r.original.endLineNumberExclusive,
        ...
        function C(E, y) {
          const v = new d.MonotonousArray(E)
          return (
            (y = y.filter((r) => {
              const s =
    ...
    X(
      ...
      function (O, n, M, A, i, d, b, L, h, o, w, e, a, u, c, m) {
        'use strict'
        Object.defineProperty(n, '__esModule', { value: !0 }),
        ...
        class f {
          constructor() {
            ;(this.dynamicProgrammingDiffing =
              new h.DynamicProgrammingDiffing()),
              (this.myersDiffingAlgorithm = new o.MyersDiffAlgorithm())
          }
          computeDiff(y, v, r) {
            if (y.length <= 1 && (0, M.equals)(y, v, (z, Y) => z === Y))
              ...
              return new a.LinesDiff(
                [
                  new u.DetailedLineRangeMapping(
                    ...
                    new i.LineRange(1, v.length + 1),
                    [
                      new u.RangeMapping(
                        new b.Range(1, 1, y.length, y[0].length + 1),
                        new b.Range(1, 1, v.length, v[0].length + 1)
                      ),
                    ]
                  ),
                ],
            ...
            function g(z) {
              let Y = _.get(z)
              return Y === void 0 && ((Y = _.size), _.set(z, Y)), Y
            }
            const p = y.map((z) => g(z.trim())),
              R = v.map((z) => g(z.trim())),
              N = new m.LineSequence(p, y),
              D = new m.LineSequence(R, v),
              x = (() =>
                N.length + D.length < 1700
                  ? this.dynamicProgrammingDiffing.compute(N, D, s, (z, Y) =>
                      y[z] === v[Y]
                        ? v[Y].length === 0
                          ? 0.1
                          : 1 + Math.log(1 + v[Y].length)
                        : 0.99
                    )
                ...
                if (l)
                  for (let Y = 0; Y < z; Y++) {
                    ...
                    if (y[t] !== v[re]) {
                      ...
                      for (const ge of le.mappings) B.push(ge)
                      le.hitTimeout && (F = !0)
                    }
                  }
              }
            ...
            for (const z of T) {
              ;(0, A.assertFn)(
                () => z.seq1Range.start - k === z.seq2Range.start - q
              )
              const Y = z.seq1Range.start - k
              H(Y),
                (k = z.seq1Range.endExclusive),
                (q = z.seq2Range.endExclusive)
              const t = this.refineDiff(y, v, z, s, l)
              t.hitTimeout && (F = !0)
              for (const re of t.mappings) B.push(re)
            }
            H(y.length - k)
            const I = S(B, y, v)
            let V = []
            return (
              r.computeMoves && (V = this.computeMoves(I, y, v, p, R, s, l)),
              (0, A.assertFn)(() => {
                function z(t, re) {
                ...
                for (const t of I) {
                  ...
                  for (const re of t.innerChanges)
                    if (
                      !(
                        z(re.modifiedRange.getStartPosition(), v) &&
                        z(re.modifiedRange.getEndPosition(), v) &&
                        z(re.originalRange.getStartPosition(), y) &&
                        z(re.originalRange.getEndPosition(), y)
                      )
                    )
                      return !1
                  if (!Y(t.modified, v) || !Y(t.original, y)) return !1
                }
                return !0
              }),
          ...
          computeMoves(y, v, r, s, l, _, g) {
            return (0, w.computeMovedLines)(y, v, r, s, l, _).map((N) => {
              const D = this.refineDiff(
                ...
                x = S(D.mappings, v, r, !0)
              return new a.MovedText(N, x)
            })
          }
          refineDiff(y, v, r, s, l) {
            const _ = new c.LinesSliceCharSequence(y, r.seq1Range, l),
              g = new c.LinesSliceCharSequence(v, r.seq2Range, l),
              p =
            ...
            return (
              ...
              (R = (0, e.removeVeryShortMatchingTextBetweenLongDiffs)(_, g, R)),
              {
                mappings: R.map(
                  (D) =>
                    new u.RangeMapping(
                      _.translateRange(D.seq1Range),
                      g.translateRange(D.seq2Range)
                    )
                ),
                hitTimeout: p.hitTimeout,
              }
            )
          }
        }
        n.DefaultLinesDiffComputer = f
        function S(E, y, v, r = !1) {
          const s = []
          for (const l of (0, M.groupAdjacentBy)(
            E.map((_) => C(_, y, v)),
            (_, g) =>
              _.original.overlapOrTouch(g.original) ||
              _.modified.overlapOrTouch(g.modified)
          )) {
            const _ = l[0],
              g = l[l.length - 1]
            s.push(
            ...
            (0, A.assertFn)(() =>
              ...
              s[0].original.startLineNumber !== s[0].modified.startLineNumber
                ...
                : (0, A.checkAdjacentItems)(
                    s,
                    (l, _) =>
                      _.original.startLineNumber -
                        l.original.endLineNumberExclusive ===
                        _.modified.startLineNumber -
    ...
    X(
      J[48],
      Z([0, 1, 24, 31, 16, 6, 2, 12, 10]),
      function (O, n, M, A, i, d, b, L, h) {
        'use strict'
        Object.defineProperty(n, '__esModule', { value: !0 }),
        ...
        class w {
          computeDiff(r, s, l) {
            ...
            return (
              ...
              new A.LinesDiff(R, [], p.quitEarly)
            )
          }
        }
        n.LegacyLinesDiffComputer = w
        function e(v, r, s, l) {
          return new M.LcsDiff(v, r, s).ComputeDiff(l)
        }
        class a {
          constructor(r) {
            const s = [],
          ...
          createCharSequence(r, s, l) {
            ...
            for (let N = s; N <= l; N++) {
              ...
              for (let F = x; F < T; F++)
                (_[R] = D.charCodeAt(F - 1)), (g[R] = N + 1), (p[R] = F), R++
              !r &&
                N < l &&
                ((_[R] = 10), (g[R] = N + 1), (p[R] = D.length + 1), R++)
            }
            return new u(_, g, p)
          }
        }
        ...
        class c {
          ...
          static createFromDiffChange(r, s, l) {
            const _ = s.getStartLineNumber(r.originalStart),
              ...
              p = s.getEndLineNumber(r.originalStart + r.originalLength - 1),
        ...
        function m(v) {
          ...
          const r = [v[0]]
          let s = r[0]
          for (let l = 1, _ = v.length; l < _; l++) {
            const g = v[l],
              p = g.originalStart - (s.originalStart + s.originalLength),
              R = g.modifiedStart - (s.modifiedStart + s.modifiedLength)
            Math.min(p, R) < o
              ? ((s.originalLength =
                  g.originalStart + g.originalLength - s.originalStart),
                (s.modifiedLength =
                  g.modifiedStart + g.modifiedLength - s.modifiedStart))
              : (r.push(g), (s = g))
          }
          return r
        }
        class f {
          ...
          static createFromDiffResult(r, s, l, _, g, p, R) {
            ...
            if (
              ...
              const B = l.createCharSequence(
                  r,
                  s.originalStart,
                  s.originalStart + s.originalLength - 1
                ),
                H = _.createCharSequence(
                  r,
                  s.modifiedStart,
                  s.modifiedStart + s.modifiedLength - 1
                )
              if (B.getElements().length > 0 && H.getElements().length > 0) {
                let k = e(B, H, g, !0).changes
                R && (k = m(k)), (F = [])
                for (let q = 0, I = k.length; q < I; q++)
                  F.push(c.createFromDiffChange(k[q], B, H))
              }
            }
        ...
        class S {
            ...
            for (let R = -1, N = s.length; R < N; R++) {
              ...
              for (; g < x && p < T; ) {
                const F = this.originalLines[g],
                  B = this.modifiedLines[p]
                if (F !== B) {
                  {
                    let H = C(F, 1),
                      k = C(B, 1)
                    for (; H > 1 && k > 1; ) {
                      const q = F.charCodeAt(H - 2),
                        I = B.charCodeAt(k - 2)
                      if (q !== I) break
                      H--, k--
                    }
          ...
          _pushTrimWhitespaceCharChange(r, s, l, _, g, p, R) {
            if (this._mergeTrimWhitespaceCharChange(r, s, l, _, g, p, R)) return
            let N
            this.shouldComputeCharChanges &&
              (N = [new c(s, l, s, _, g, p, g, R)]),
              r.push(new f(s, s, g, g, N))
          }
          _mergeTrimWhitespaceCharChange(r, s, l, _, g, p, R) {
            const N = r.length
            if (N === 0) return !1
            const D = r[N - 1]
            return D.originalEndLineNumber === 0 ||
              ...
              ? (this.shouldComputeCharChanges &&
                  D.charChanges &&
                  D.charChanges.push(new c(s, l, s, _, g, p, g, R)),
                !0)
              : D.originalEndLineNumber + 1 === s &&
                D.modifiedEndLineNumber + 1 === g
        ...
        n.DiffComputer = S
        function C(v, r) {
          const s = d.firstNonWhitespaceIndex(v)
          return s === -1 ? r : s + 1
        }
        function E(v, r) {
          const s = d.lastNonWhitespaceIndex(v)
          return s === -1 ? r : s + 2
        }
        function y(v) {
          if (v === 0) return () => !0
    ...
    X(J[49], Z([0, 1, 48, 47]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
    ...
    X(J[50], Z([0, 1, 33]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      function b(a, u) {
        ...
        if (c)
          return { range: a, color: i(c.rgba.r, c.rgba.g, c.rgba.b, c.rgba.a) }
      }
      function L(a, u, c) {
      ...
      function h(a, u, c) {
        ...
        const f = u[0].values(),
          S = A(f),
          C = new M.Color(
            new M.HSLA(S[0], S[1] / 100, S[2] / 100, c ? S[3] : 1)
          )
        return { range: a, color: i(C.rgba.r, C.rgba.g, C.rgba.b, C.rgba.a) }
      }
      function o(a, u) {
      ...
      function e(a) {
        return !a ||
          typeof a.getValue != 'function' ||
          typeof a.positionAt != 'function'
          ? []
          : w(a)
      }
      n.computeDefaultDocumentColors = e
    }),
    X(J[51], Z([0, 1, 27]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class o {
        static _createLink(a, u, c, m, f) {
          let S = f - 1
          do {
            const C = u.charCodeAt(S)
            if (a.get(C) !== 2) break
            S--
          } while (S > m)
          if (m > 0) {
            const C = u.charCodeAt(m - 1),
              E = u.charCodeAt(S)
            ;((C === 40 && E === 41) ||
              (C === 91 && E === 93) ||
              (C === 123 && E === 125)) &&
          ...
          for (let f = 1, S = a.getLineCount(); f <= S; f++) {
            ...
            for (; y < E; ) {
              ...
              if (s === 13) {
                ...
                D === 1 && (m.push(o._createLink(c, C, f, v, y)), (R = !0))
              } else if (s === 12) {
                let D
                N === 91 ? ((_ = !0), (D = 0)) : (D = c.get(N)),
                  D === 1 ? (R = !0) : (s = 13)
              } else (s = u.nextState(s, N)), s === 0 && (R = !0)
              R &&
                ((s = 1), (l = !1), (_ = !1), (p = !1), (v = y + 1), (r = N)),
                y++
            }
            s === 13 && m.push(o._createLink(c, C, f, v, E))
          }
          return m
        }
      }
      ...
      class M {
        ...
        numberReplace(i, d) {
          ...
          return !isNaN(L) && !isNaN(h) && L === h
            ? L === 0 && !d
              ? null
              : ((L = Math.floor(L * b)), (L += d ? b : -b), String(L / b))
            : null
        }
        textReplace(i, d) {
        ...
        valueSetsReplace(i, d, b) {
          ...
          for (let h = 0, o = i.length; L === null && h < o; h++)
            L = this.valueSetReplace(i[h], d, b)
          return L
        }
    ...
    X(J[53], Z([0, 1, 14]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      n.ValidAnnotatedEditOperation = w
      class e {
        constructor(m, f, S) {
    ...
    X(J[54], Z([0, 1, 7, 26]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class i {
        ...
        insertValues(h, o) {
          ...
          return a === 0
            ...
            : ((this.values = new Uint32Array(w.length + a)),
              ...
              this.values.set(w.subarray(h), h + a),
              this.values.set(o, h),
        ...
        removeValues(h, o) {
          ...
          return (
            ...
            o === 0
              ? !1
              : ((this.values = new Uint32Array(w.length - o)),
                this.values.set(w.subarray(0, h), 0),
                this.values.set(w.subarray(h + o), h),
                (this.prefixSum = new Uint32Array(this.values.length)),
                h - 1 < this.prefixSumValidIndex[0] &&
                  (this.prefixSumValidIndex[0] = h - 1),
                this.prefixSumValidIndex[0] >= 0 &&
        ...
        _getPrefixSum(h) {
          ...
          for (let w = o; w <= h; w++)
            this.prefixSum[w] = this.prefixSum[w - 1] + this.values[w]
          return (
      ...
      class d {
        ...
        insertValues(h, o) {
          ;(this._values = (0, M.arrayInsert)(this._values, h, o)),
            this._invalidate(h)
        }
        _invalidate(h) {
          ;(this._isValid = !1),
        ...
        _ensureValid() {
          if (!this._isValid) {
            for (
              let h = this._validEndIndex + 1, o = this._values.length;
              h < o;
              h++
            ) {
              ...
              for (let a = 0; a < w; a++) this._indexBySum[e + a] = h
            }
    ...
    X(J[55], Z([0, 1, 6, 4, 54]), function (O, n, M, A, i) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class d {
        ...
        _ensureLineStarts() {
          if (!this._lineStarts) {
            const L = this._eol.length,
              ...
              o = new Uint32Array(h)
            for (let w = 0; w < h; w++) o[w] = this._lines[w].length + L
        ...
        _acceptInsertText(L, h) {
          ...
          ;(o[o.length - 1] += this._lines[L.lineNumber - 1].substring(
            L.column - 1
          )),
            this._setLineText(
              L.lineNumber - 1,
          ...
          const w = new Uint32Array(o.length - 1)
          for (let e = 1; e < o.length; e++)
            this._lines.splice(L.lineNumber + e - 1, 0, o[e]),
              (w[e - 1] = o[e].length + this._eol.length)
          this._lineStarts && this._lineStarts.insertValues(L.lineNumber, w)
        }
      }
      n.MirrorTextModel = d
    }),
    X(J[56], Z([0, 1, 6, 42, 4, 2, 53]), function (O, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.Searcher =
          n.isValidMatch =
...
`) >= 0)
      ...
      function w(S, C, E) {
        if (!E) return new b.FindMatch(S, null)
        const y = []
        for (let v = 0, r = C.length; v < r; v++) y[v] = C[v]
        return new b.FindMatch(S, y)
      }
      n.createFindMatch = w
      class e {
        constructor(C) {
        ...
        static findMatches(C, E, y, v, r) {
          ...
          return s
            ? s.regex.multiline
              ...
              : this._doFindMatchesLineByLine(C, y, s, v, r)
            : []
        }
        static _getMultilineMatchRange(C, E, y, v, r, s) {
          let l,
            _ = 0
          v
            ? ((_ = v.findLineFeedCountBeforeOffset(r)), (l = E + r + _))
            : (l = E + r)
          let g
          if (v) {
            const D = v.findLineFeedCountBeforeOffset(r + s.length) - _
            g = l + s.length + D
          } else g = l + s.length
          const p = C.getPositionAt(l),
            R = C.getPositionAt(g)
          return new d.Range(p.lineNumber, p.column, R.lineNumber, R.column)
        }
        static _doFindMatchesMultiline(C, E, y, v, r) {
          const s = C.getOffsetAt(E.getStartPosition()),
            l = C.getValueInRange(E, 1),
            _ =
              C.getEOL() ===
              `\r
`
          ...
          for (y.reset(0); (R = y.next(l)); )
            if (
              ((g[p++] = w(
                this._getMultilineMatchRange(C, s, l, _, R.index, R[0]),
                R,
                v
              )),
              p >= r)
        ...
        static _doFindMatchesLineByLine(C, E, y, v, r) {
          const s = []
          let l = 0
          if (E.startLineNumber === E.endLineNumber) {
            const g = C.getLineContent(E.startLineNumber).substring(
              E.startColumn - 1,
              E.endColumn - 1
            )
            return (
          ...
          const _ = C.getLineContent(E.startLineNumber).substring(
            E.startColumn - 1
          )
          l = this._findMatchesInLine(
            y,
          ...
          if (l < r) {
            const g = C.getLineContent(E.endLineNumber).substring(
              0,
              E.endColumn - 1
            )
            l = this._findMatchesInLine(y, g, E.endLineNumber, 0, l, s, v, r)
          }
          return s
        }
        static _findMatchesInLine(C, E, y, v, r, s, l, _) {
          const g = C.wordSeparators
          if (!l && C.simpleSearch) {
          ...
          const p = new f(C.wordSeparators, C.regex)
          let R
          p.reset(0)
          do
            if (
        ...
        static findNextMatch(C, E, y, v) {
          const r = E.parseSearchRequest()
          if (!r) return null
          const s = new f(r.wordSeparators, r.regex)
          return r.regex.multiline
            ? this._doFindNextMatchMultiline(C, y, s, v)
            : this._doFindNextMatchLineByLine(C, y, s, v)
        }
        static _doFindNextMatchMultiline(C, E, y, v) {
          const r = new i.Position(E.lineNumber, 1),
            s = C.getOffsetAt(r),
            l = C.getLineCount(),
            _ = C.getValueInRange(
              new d.Range(r.lineNumber, r.column, l, C.getLineMaxColumn(l)),
              1
            ),
            g =
              C.getEOL() ===
...
`
          ...
          const p = y.next(_)
          return p
            ? w(this._getMultilineMatchRange(C, s, _, g, p.index, p[0]), p, v)
            : E.lineNumber !== 1 || E.column !== 1
            ? this._doFindNextMatchMultiline(C, new i.Position(1, 1), y, v)
            : null
        }
        static _doFindNextMatchLineByLine(C, E, y, v) {
          const r = C.getLineCount(),
            s = E.lineNumber,
            l = C.getLineContent(s),
            _ = this._findFirstMatchInLine(y, l, s, E.column, v)
          if (_) return _
          for (let g = 1; g <= r; g++) {
            const p = (s + g - 1) % r,
              R = C.getLineContent(p + 1),
              N = this._findFirstMatchInLine(y, R, p + 1, 1, v)
            if (N) return N
          }
          return null
        }
        static _findFirstMatchInLine(C, E, y, v, r) {
          C.reset(v - 1)
          const s = C.next(E)
          return s
            ? w(new d.Range(y, s.index + 1, y, s.index + 1 + s[0].length), s, r)
            : null
        }
        static findPreviousMatch(C, E, y, v) {
          const r = E.parseSearchRequest()
          if (!r) return null
          const s = new f(r.wordSeparators, r.regex)
          return r.regex.multiline
            ? this._doFindPreviousMatchMultiline(C, y, s, v)
            : this._doFindPreviousMatchLineByLine(C, y, s, v)
        }
        static _doFindPreviousMatchMultiline(C, E, y, v) {
          ...
          const s = C.getLineCount()
          return E.lineNumber !== s || E.column !== C.getLineMaxColumn(s)
            ? this._doFindPreviousMatchMultiline(
                C,
                new i.Position(s, C.getLineMaxColumn(s)),
                y,
                v
              )
            : null
        }
        static _doFindPreviousMatchLineByLine(C, E, y, v) {
          const r = C.getLineCount(),
            s = E.lineNumber,
            l = C.getLineContent(s).substring(0, E.column - 1),
            _ = this._findLastMatchInLine(y, l, s, v)
          if (_) return _
          for (let g = 1; g <= r; g++) {
            const p = (r + s - g - 1) % r,
              R = C.getLineContent(p + 1),
              N = this._findLastMatchInLine(y, R, p + 1, v)
            if (N) return N
          }
          return null
        }
        static _findLastMatchInLine(C, E, y, v) {
          let r = null,
            s
          for (C.reset(0); (s = C.next(E)); )
            r = w(
              new d.Range(y, s.index + 1, y, s.index + 1 + s[0].length),
              s,
              v
            )
          return r
      ...
      n.TextModelSearch = a
      function u(S, C, E, y, v) {
        if (y === 0) return !0
        const r = C.charCodeAt(y - 1)
        if (S.get(r) !== 0 || r === 13 || r === 10) return !0
        if (v > 0) {
          const s = C.charCodeAt(y)
          if (S.get(s) !== 0) return !0
        }
        return !1
      }
      function c(S, C, E, y, v) {
        if (y + v === E) return !0
        const r = C.charCodeAt(y + v)
        if (S.get(r) !== 0 || r === 13 || r === 10) return !0
        if (v > 0) {
          const s = C.charCodeAt(y + v - 1)
          if (S.get(s) !== 0) return !0
        }
        return !1
      }
      function m(S, C, E, y, v) {
        return u(S, C, E, y, v) && c(S, C, E, y, v)
      }
      n.isValidMatch = m
      class f {
        constructor(C, E) {
        ...
        next(C) {
          ...
          do {
            ...
            if (
              ...
              if (r === 0) {
                M.getNextCodePoint(C, E, this._searchRegex.lastIndex) > 65535
            ...
            if (
              ...
              !this._wordSeparators || m(this._wordSeparators, C, E, v, r))
            )
              return y
          } while (y)
          return null
    ...
    X(J[57], Z([0, 1, 2, 56, 6, 12, 28]), function (O, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class L {
        static computeUnicodeHighlights(a, u, c) {
          const m = c ? c.startLineNumber : 1,
            ...
            S = new o(u),
            C = S.getCandidateCodePoints()
          let E
          C === 'allNonBasicAscii'
            ? (E = new RegExp('[^\\t\\n\\r\\x20-\\x7E]', 'g'))
            : (E = new RegExp(`${h(Array.from(C))}`, 'g'))
          ...
          let r = !1,
            ...
            _ = 0,
            g = 0
          e: for (let p = m, R = f; p <= R; p++) {
            const N = a.getLineContent(p),
              D = N.length
            y.reset(0)
            do
              if (((s = y.next(N)), s)) {
                ...
                const H = S.shouldHighlightNonBasicASCII(F, B ? B.word : null)
                if (H !== 0) {
                  H === 3
                    ? l++
                    : H === 2
                  ...
                  v.push(new M.Range(p, x + 1, p, T + 1))
                }
              }
            while (s)
          }
      ...
      function h(e, a) {
        return `[${i.escapeRegExpCharacters(
          e.map((c) => String.fromCodePoint(c)).join('')
        )}]`
      }
      class o {
        constructor(a) {
        ...
        getCandidateCodePoints() {
          ...
          if (this.options.invisibleCharacters)
            for (const u of i.InvisibleCharacters.codePoints)
              w(String.fromCodePoint(u)) || a.add(u)
          if (this.options.ambiguousCharacters)
            for (const u of this.ambiguousCharacters.getConfusableCodePoints())
              a.add(u)
...
` ||
    ...
    X(J[58], Z([0, 1]), function (O, n) {
      ...
      ;(function (t) {
        ;(t[(t.acceptSuggestionOnCommitCharacter = 0)] =
          ...
          (t[(t.mouseWheelScrollSensitivity = 74)] =
            'mouseWheelScrollSensitivity'),
          (t[(t.mouseWheelZoom = 75)] = 'mouseWheelZoom'),
          (t[(t.multiCursorMergeOverlapping = 76)] =
          ...
          (t[(t.renderValidationDecorations = 97)] =
            'renderValidationDecorations'),
          (t[(t.renderWhitespace = 98)] = 'renderWhitespace'),
          (t[(t.revealHorizontalRightPadding = 99)] =
          ...
          (t[(t.suggestOnTriggerCharacters = 120)] =
          ...
          (t[(t.wordWrapBreakAfterCharacters = 131)] =
            'wordWrapBreakAfterCharacters'),
          (t[(t.wordWrapBreakBeforeCharacters = 132)] =
          ...
          (t[(t.colorDecoratorsActivatedOn = 146)] =
    ...
    X(J[59], Z([0, 1, 9, 13]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
    ...
    X(J[60], Z([19, 61]), function (O, n) {
      return O.create('vs/base/common/platform', n)
    }),
    X(J[17], Z([0, 1, 60]), function (O, n, M) {
      'use strict'
      var A
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.isAndroid =
      ...
      const v =
          typeof ((A = y?.versions) === null || A === void 0
            ? void 0
            : A.electron) == 'string',
        r = v && y?.type === 'renderer'
      ...
      d ? (s = 1) : i ? (s = 3) : b && (s = 2),
        ...
        (n.language = m),
        (n.setTimeout0IsFaster =
          typeof E.postMessage == 'function' && !E.importScripts),
        (n.setTimeout0 = (() => {
          if (n.setTimeout0IsFaster) {
            ...
            return (N) => {
              const D = ++R
              p.push({ id: D, callback: N }),
                E.postMessage({ vscodeScheduleAsyncWork: D }, '*')
            }
          }
          return (p) => setTimeout(p)
        })()),
        (n.OS = d || e ? 2 : i ? 1 : 3)
      let l = !0,
        _ = !1
      function g() {
        if (!_) {
          ...
          ;(p[0] = 1),
            (p[1] = 2),
            (l = new Uint16Array(p.buffer)[0] === (2 << 8) + 1)
        }
        return l
      }
      ;(n.isLittleEndian = g),
    ...
    X(J[62], Z([0, 1, 17]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
    ...
    X(J[63], Z([0, 1, 62]), function (O, n, M) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.sep =
          n.extname =
      ...
      class a extends Error {
        constructor(s, l, _) {
          ...
          typeof l == 'string' && l.indexOf('not ') === 0
            ...
            : (g = 'must be')
          const p = s.indexOf('.') !== -1 ? 'property' : 'argument'
          let R = `The "${s}" ${p} ${g} of type ${l}`
          ;(R += `. Received type ${typeof _}`),
            super(R),
            ...
            if (!(R === x - 1 || N === 1))
              if (N === 2) {
                if (
                  g.length < 2 ||
                  p !== 2 ||
                  g.charCodeAt(g.length - 1) !== L ||
                  g.charCodeAt(g.length - 2) !== L
                ) {
                  if (g.length > 2) {
      ...
      n.win32 = {
        resolve(...r) {
          ...
          for (let g = r.length - 1; g >= -1; g--) {
            let p
            if (g >= 0) {
              if (((p = r[g]), c(p, 'path'), p.length === 0)) continue
            } else
              s.length === 0
                ? (p = M.cwd())
                : ((p = M.env[`=${s}`] || M.cwd()),
                  (p === void 0 ||
                    (p.slice(0, 2).toLowerCase() !== s.toLowerCase() &&
                      p.charCodeAt(2) === o)) &&
                    (p = `${s}\\`))
            const R = p.length
            let N = 0,
            ...
            if (R === 1) f(T) && ((N = 1), (x = !0))
              ...
              if (((x = !0), f(p.charCodeAt(1)))) {
                let F = 2,
                  B = F
                for (; F < R && !f(p.charCodeAt(F)); ) F++
                if (F < R && F !== B) {
                  const H = p.slice(B, F)
                  for (B = F; F < R && f(p.charCodeAt(F)); ) F++
                  if (F < R && F !== B) {
                    for (B = F; F < R && !f(p.charCodeAt(F)); ) F++
                    ;(F === R || F !== B) &&
                      ((D = `\\\\${H}\\${p.slice(B, F)}`), (N = F))
            ...
            if (_) {
              ...
              ((l = `${p.slice(N)}\\${l}`), (_ = x), x && s.length > 0)
            )
              break
          }
        ...
        isAbsolute(r) {
          ...
          return (
            f(l) ||
            (s > 2 && C(l) && r.charCodeAt(1) === w && f(r.charCodeAt(2)))
          )
        },
        join(...r) {
        ...
        relative(r, s) {
          ...
          if (
            l === _ ||
            ((r = l.toLowerCase()), (s = _.toLowerCase()), r === s)
          )
            return ''
          let g = 0
          for (; g < r.length && r.charCodeAt(g) === o; ) g++
          let p = r.length
          for (; p - 1 > g && r.charCodeAt(p - 1) === o; ) p--
          const R = p - g
          let N = 0
          ...
          if (B !== T) {
            ...
            R > T && (r.charCodeAt(g + B) === o ? (F = B) : B === 2 && (F = 3)),
              F === -1 && (F = 0)
          }
          let H = ''
          for (B = g + F + 1; B <= p; ++B)
            (B === p || r.charCodeAt(B) === o) &&
              (H += H.length === 0 ? '..' : '\\..')
          return (
            (N += F),
            H.length > 0
              ? `${H}${_.slice(N, D)}`
              : (_.charCodeAt(N) === o && ++N, _.slice(N, D))
          )
        },
        toNamespacedPath(r) {
        ...
        dirname(r) {
          ...
          if (f(g)) {
            ...
            C(g) &&
              r.charCodeAt(1) === w &&
              ((l = s > 2 && f(r.charCodeAt(2)) ? 3 : 2), (_ = l))
          let p = -1,
            R = !0
          for (let N = s - 1; N >= _; --N)
            if (f(r.charCodeAt(N))) {
        ...
        parse(r) {
          ...
          let _ = 0,
            g = r.charCodeAt(0)
          if (l === 1)
            return f(g) ? ((s.root = s.dir = r), s) : ((s.base = s.name = r), s)
          if (f(g)) {
      ...
      ;(n.posix = {
        resolve(...r) {
          ...
          for (let _ = r.length - 1; _ >= -1 && !l; _--) {
            const g = _ >= 0 ? r[_] : v()
            c(g, 'path'),
              g.length !== 0 && ((s = `${g}/${s}`), (l = g.charCodeAt(0) === h))
          }
        ...
        relative(r, s) {
          if (
            ...
            c(s, 'to'),
            r === s ||
              ((r = n.posix.resolve(r)), (s = n.posix.resolve(s)), r === s))
          )
            return ''
          const l = 1,
            _ = r.length,
          ...
          for (; x < N; x++) {
            ...
            if (F !== s.charCodeAt(p + x)) break
            F === h && (D = x)
          }
          if (x === N)
            if (R > N) {
              if (s.charCodeAt(p + x) === h) return s.slice(p + x + 1)
              if (x === 0) return s.slice(p + x)
            } else
              g > N &&
                (r.charCodeAt(l + x) === h ? (D = x) : x === 0 && (D = 0))
          let T = ''
          for (x = l + D + 1; x <= _; ++x)
            (x === _ || r.charCodeAt(x) === h) &&
              (T += T.length === 0 ? '..' : '/..')
          return `${T}${s.slice(p + D)}`
        },
        toNamespacedPath(r) {
          return r
        },
        ...
        parse(r) {
          ...
          if (R !== -1) {
            const T = p === 0 && l ? 1 : p
            g === -1 || x === 0 || (x === 1 && g === R - 1 && g === p + 1)
              ? (s.base = s.name = r.slice(T, R))
              : ((s.name = r.slice(T, g)),
                (s.base = r.slice(T, R)),
                (s.ext = r.slice(g, R)))
          }
          return p > 0 ? (s.dir = r.slice(0, p - 1)) : l && (s.dir = '/'), s
        },
        sep: '/',
        delimiter: ':',
        win32: null,
    ...
    X(J[18], Z([0, 1, 63, 17]), function (O, n, M, A) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      class u {
        ...
        constructor(_, g, p, R, N, D = !1) {
          typeof _ == 'object'
            ? ((this.scheme = _.scheme || w),
              (this.authority = _.authority || w),
              (this.path = _.path || w),
              (this.query = _.query || w),
              (this.fragment = _.fragment || w))
            : ((this.scheme = h(_, D)),
              (this.authority = g || w),
              (this.path = o(this.scheme, p || w)),
              (this.query = R || w),
              (this.fragment = N || w),
              L(this, D))
        }
        ...
        with(_) {
          if (!_) return this
          let { scheme: g, authority: p, path: R, query: N, fragment: D } = _
          return (
            g === void 0 ? (g = this.scheme) : g === null && (g = w),
            p === void 0 ? (p = this.authority) : p === null && (p = w),
            R === void 0 ? (R = this.path) : R === null && (R = w),
            N === void 0 ? (N = this.query) : N === null && (N = w),
        ...
        static file(_) {
          let g = w
          if (
            (A.isWindows && (_ = _.replace(/\\/g, e)), _[0] === e && _[1] === e)
          ) {
            const p = _.indexOf(e, 2)
            p === -1
              ? ((g = _.substring(2)), (_ = e))
              : ((g = _.substring(2, p)), (_ = _.substring(p) || e))
          }
          return new m('file', g, _, w, w)
        }
        static from(_, g) {
        ...
        static joinPath(_, ...g) {
          ...
          return (
            A.isWindows && _.scheme === 'file'
              ? (p = u.file(M.win32.join(E(_, !0), ...g)).path)
              : (p = M.posix.join(_.path, ...g)),
            _.with({ path: p })
          )
        }
        toString(_ = !1) {
        ...
        static revive(_) {
          ...
          if (_) {
            if (_ instanceof u) return _
            {
              ...
              return (
                (R._formatted =
                  (g = _.external) !== null && g !== void 0 ? g : null),
                (R._fsPath =
                  _._sep === c && (p = _.fsPath) !== null && p !== void 0
                    ? p
                    : null),
                R
              )
      ...
      function S(l, _, g) {
        ...
        for (let N = 0; N < l.length; N++) {
          ...
          if (
            ...
            R !== -1 &&
              ((p += encodeURIComponent(l.substring(R, N))), (R = -1)),
              p !== void 0 && (p += l.charAt(N))
          else {
            p === void 0 && (p = l.substr(0, N))
            const x = f[D]
            x !== void 0
              ? (R !== -1 &&
                  ((p += encodeURIComponent(l.substring(R, N))), (R = -1)),
      ...
      function C(l) {
        ...
        for (let g = 0; g < l.length; g++) {
          const p = l.charCodeAt(g)
          p === 35 || p === 63
            ? (_ === void 0 && (_ = l.substr(0, g)), (_ += f[p]))
            : _ !== void 0 && (_ += l[g])
        }
        return _ !== void 0 ? _ : l
      }
        ...
        if (
          ...
          if (F !== -1) {
            ...
            ;(N = N.substr(F + 1)),
              ...
              F === -1
                ? (p += g(B, !1, !1))
                : ((p += g(B.substr(0, F), !1, !1)),
                  (p += ':'),
                  (p += g(B.substr(F + 1), !1, !0))),
              (p += '@')
          }
          ;(N = N.toLowerCase()),
            (F = N.lastIndexOf(':')),
            F === -1
              ? (p += g(N, !1, !0))
              : ((p += g(N.substr(0, F), !1, !0)), (p += N.substr(F)))
        }
        if (D) {
          if (
            D.length >= 3 &&
            ...
            F >= 65 &&
              F <= 90 &&
              (D = `/${String.fromCharCode(F + 32)}:${D.substr(3)}`)
          } else if (D.length >= 2 && D.charCodeAt(1) === 58) {
            const F = D.charCodeAt(0)
            F >= 65 &&
              F <= 90 &&
              (D = `${String.fromCharCode(F + 32)}:${D.substr(2)}`)
          }
          p += g(D, !0, !1)
        }
        return (
      ...
      function s(l) {
        return l.match(r) ? l.replace(r, (_) => v(_)) : l
      }
    }),
    X(J[67], Z([0, 1, 5, 9, 13, 14, 17, 6]), function (O, n, M, A, i, d, b, L) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.create =
      ...
      class f {
        ...
        sendMessage(l, _) {
          ...
          return new Promise((p, R) => {
            ;(this._pendingReplies[g] = { resolve: p, reject: R }),
              this._send(new e(this._workerId, g, l, _))
          })
        }
        listen(l, _) {
          let g = null
          const p = new A.Emitter({
            onWillAddFirstListener: () => {
              ;(g = String(++this._lastSentReq)),
                this._pendingEmitters.set(g, p),
                this._send(new u(this._workerId, g, l, _))
            },
            onDidRemoveLastListener: () => {
              this._pendingEmitters.delete(g),
                this._send(new m(this._workerId, g)),
                (g = null)
            },
          })
          return p.event
        ...
        _handleRequestMessage(l) {
          ...
          this._handler.handleMessage(l.method, l.args).then(
            (p) => {
              this._send(new a(this._workerId, _, p, void 0))
            },
            (p) => {
        ...
        _handleSubscribeEventMessage(l) {
          const _ = l.req,
            g = this._handler.handleEvent(
              ...
              this._send(new c(this._workerId, _, p))
            })
        ...
        _send(l) {
          const _ = []
          if (l.type === 0)
            for (let g = 0; g < l.args.length; g++)
              l.args[g] instanceof ArrayBuffer && _.push(l.args[g])
      ...
      class S extends i.Disposable {
          ...
          this._lazyProxy = new Promise((F, B) => {
            ;(p = B),
              this._onModuleLoaded.then(
                ...
                (H) => {
                  B(H), this._onError('Worker failed to load ' + _, H)
                }
              )
          })
        }
        ...
        _request(l, _) {
          return new Promise((g, p) => {
            this._onModuleLoaded.then(() => {
              this._protocol.sendMessage(l, _).then(g, p)
            }, p)
          })
        }
        _onError(l, _) {
      ...
      function C(s) {
        return (
          s[0] === 'o' && s[1] === 'n' && L.isUpperAsciiLetter(s.charCodeAt(2))
        )
      }
      function E(s) {
        ...
        constructor(l, _) {
          ;(this._requestHandlerFactory = _),
            ...
            (this._protocol = new f({
              ...
              handleMessage: (g, p) => this._handleMessage(g, p),
              handleEvent: (g, p) => this._handleEvent(g, p),
            }))
        }
        onmessage(l) {
        ...
        _handleMessage(l, _) {
          ...
          try {
            return Promise.resolve(
              this._requestHandler[l].apply(this._requestHandler, _)
            )
          } catch (g) {
            ...
            : (_ &&
              ...
              new Promise((x, T) => {
                ;(globalThis.require || O)(
                  ...
                  (B) => {
                    if (
                      ((this._requestHandler = B.create(D)),
                      !this._requestHandler)
                    ) {
    ...
    X(J[64], Z([19, 61]), function (O, n) {
      return O.create('vs/editor/common/languages', n)
    }),
    X(J[65], Z([0, 1, 40, 18, 2, 59, 64]), function (O, n, M, A, i, d, b) {
      'use strict'
      Object.defineProperty(n, '__esModule', { value: !0 }),
      ...
      ;(function (s) {
        function l(_) {
          return !_ || typeof _ != 'object'
            ? !1
            : typeof _.id == 'string' && typeof _.title == 'string'
        }
        s.is = l
      })(y || (n.Command = y = {}))
      var v
    ...
    X(
      ...
      function (O, n, M, A, i, d, b, L, h, o, w) {
        'use strict'
        Object.defineProperty(n, '__esModule', { value: !0 }),
    ...
    X(
      ...
      function (O, n, M, A, i, d, b, L, h, o, w, e, a, u, c, m) {
        ...
        class f extends b.MirrorTextModel {
          ...
          findMatches(y) {
            ...
            for (let r = 0; r < this._lines.length; r++) {
              const s = this._lines[r],
                ...
                _ = s.matchAll(y)
              for (const g of _)
                (g.index || g.index === 0) && (g.index = g.index + l), v.push(g)
            }
            return v
          }
          getLinesContent() {
          ...
          getWordAtPosition(y, v) {
            const r = (0, L.getWordAtText)(
              y.column,
              (0, L.ensureValidWordDefinition)(v),
          ...
          words(y) {
            ...
            return {
              *[Symbol.iterator]() {
                for (;;)
                  if (_ < g.length) {
                    const p = l.substring(g[_].start, g[_].end)
                    ;(_ += 1), yield p
                  } else if (s < v.length)
                    (l = v[s]), (g = r(l, y)), (_ = 0), (s += 1)
                  else break
              },
            }
          }
          getLineWords(y, v) {
            const r = this._lines[y - 1],
              s = this._wordenize(r, v),
              l = []
            for (const _ of s)
              l.push({
                word: r.substring(_.start, _.end),
          ...
          _wordenize(y, v) {
            const r = []
            let s
            for (v.lastIndex = 0; (s = v.exec(y)) && s[0].length !== 0; )
              r.push({ start: s.index, end: s.index + s[0].length })
            return r
          }
          getValueInRange(y) {
            if (
              ((y = this._validateRange(y)),
            ...
            return (
              l.push(this._lines[s].substring(0, y.endColumn - 1)), l.join(v)
            )
          }
          offsetAt(y) {
            return (
          ...
          positionAt(y) {
            ...
            const v = this._lineStarts.getIndexOf(y),
          ...
          _validateRange(y) {
            ...
            return v.lineNumber !== y.startLineNumber ||
              v.column !== y.startColumn ||
          ...
          _validatePosition(y) {
            ...
            return s ? { lineNumber: v, column: r } : y
          }
        }
        class S {
          constructor(y, v) {
          ...
          _getModels() {
            const y = []
            return (
              Object.keys(this._models).forEach((v) => y.push(this._models[v])),
              y
            )
          }
          acceptNewModel(y) {
            this._models[y.url] = new f(
              A.URI.parse(y.url),
              y.lines,
              y.EOL,
              y.versionId
          ...
          acceptModelChanged(y, v) {
            if (!this._models[y]) return
            this._models[y].onEvents(v)
          }
          acceptRemovedModel(y) {
            this._models[y] && delete this._models[y]
          }
          async computeUnicodeHighlights(y, v, r) {
            const s = this._getModel(y)
            return s
              ? a.UnicodeTextModelHighlighter.computeUnicodeHighlights(s, v, r)
              : {
                  ranges: [],
                  hasMore: !1,
          ...
          async computeDiff(y, v, r, s) {
            const l = this._getModel(y),
              _ = this._getModel(v)
            return !l || !_ ? null : S.computeDiff(l, _, r, s)
          }
          static computeDiff(y, v, r, s) {
            const l =
                s === 'advanced'
              ...
              _ = y.getLinesContent(),
              g = v.getLinesContent(),
              p = l.computeDiff(_, g, r),
              R = p.changes.length > 0 ? !1 : this._modelsAreIdentical(y, v)
            function N(D) {
              return D.map((x) => {
                var T
                return [
          ...
          static _modelsAreIdentical(y, v) {
            const r = y.getLineCount(),
              s = v.getLineCount()
            if (r !== s) return !1
            for (let l = 1; l <= r; l++) {
              const _ = y.getLineContent(l),
                g = v.getLineContent(l)
              if (_ !== g) return !1
            }
            return !0
          }
          async computeMoreMinimalEdits(y, v, r) {
            const s = this._getModel(y)
            if (!s) return v
            const l = []
            let _
            v = v.slice(0).sort((p, R) => {
              if (p.range && R.range)
                return d.Range.compareRangesUsingStarts(p.range, R.range)
              const N = p.range ? 0 : 1,
                D = R.range ? 0 : 1
              return N - D
            })
            ...
            for (let p = 1; p < v.length; p++)
              d.Range.getEndPosition(v[g].range).equals(
                d.Range.getStartPosition(v[p].range)
              )
                ? ((v[g].range = d.Range.fromPositions(
                    d.Range.getStartPosition(v[g].range),
                    d.Range.getEndPosition(v[p].range)
                  )),
                  (v[g].text += v[p].text))
                : (g++, (v[g] = v[p]))
            v.length = g + 1
            for (let { range: p, text: R, eol: N } of v) {
              if ((typeof N == 'number' && (_ = N), d.Range.isEmpty(p) && !R))
                continue
              const D = s.getValueInRange(p)
              if (((R = R.replace(/\r\n|\n|\r/g, s.eol)), D === R)) continue
              if (Math.max(R.length, D.length) > S._diffLimit) {
                l.push({ range: p, text: R })
                continue
              }
              const x = (0, M.stringDiff)(D, R, r),
                T = s.offsetAt(d.Range.lift(p).getStartPosition())
              for (const F of x) {
                const B = s.positionAt(T + F.originalStart),
                  H = s.positionAt(T + F.originalStart + F.originalLength),
                  k = {
          ...
          async computeLinks(y) {
            const v = this._getModel(y)
            return v ? (0, h.computeLinks)(v) : null
          }
          async computeDefaultDocumentColors(y) {
            const v = this._getModel(y)
            return v ? (0, m.computeDefaultDocumentColors)(v) : null
          }
          async textualSuggest(y, v, r, s) {
            ...
            e: for (const p of y) {
              ...
              if (R) {
                for (const N of R.words(_))
                  if (
                    !(N === v || !isNaN(Number(N))) &&
                    (g.add(N), g.size > S._suggestionsLimit)
                  )
                    break e
              }
            }
          ...
          async navigateValueSet(y, v, r, s, l) {
            ...
            const p = _.getValueInRange(v),
              R = _.getWordAtPosition(
                { lineNumber: v.startLineNumber, column: v.startColumn },
                g
              )
            if (!R) return null
            const N = _.getValueInRange(R)
            return o.BasicInplaceReplace.INSTANCE.navigateValueSet(
              v,
              p,
              R,
              N,
          ...
          loadForeignModule(y, v, r) {
            const s = (g, p) => this._host.fhr(g, p),
              _ = {
                host: (0, c.createProxyObject)(r, s),
                getMirrorModels: () => this._getModels(),
              }
            return this._foreignModuleFactory
              ? ((this._foreignModule = this._foreignModuleFactory(_, v)),
                Promise.resolve((0, c.getAllMethodNames)(this._foreignModule)))
              : new Promise((g, p) => {
                  O(
                    [y],
                    (R) => {
                      ;(this._foreignModule = R.create(_, v)),
                        g((0, c.getAllMethodNames)(this._foreignModule))
                    },
                    p
                  )
                })
          ...
          fmr(y, v) {
            if (
              !this._foreignModule ||
              typeof this._foreignModule[y] != 'function'
            )
              return Promise.reject(
            ...
            try {
              return Promise.resolve(
                this._foreignModule[y].apply(this._foreignModule, v)
              )
            } catch (r) {
        ...
        ;(n.create = C),
          typeof importScripts == 'function' &&
            (globalThis.monaco = (0, w.createMonacoBaseAPI)())
      }
    )
}.call(this))

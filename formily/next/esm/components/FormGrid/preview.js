...
import { DroppableWidget, useTreeNode, useNodeIdProps } from '@designable/react'
...
export var FormGrid = observer(function (props) {
  ...
  return React.createElement(
    'div',
    __assign({}, nodeId, { className: 'dn-grid' }),
...
FormGrid.Behavior = createBehavior(
  {
    ...
    selector: function (node) {
      return node.props['x-component'] === 'FormGrid'
    },
    designerProps: {
      droppable: true,
  ...
  },
  {
    ...
    extends: ['Field'],
    selector: function (node) {
      return node.props['x-component'] === 'FormGrid.GridColumn'
    },
    designerProps: {
      droppable: true,
      resizable: {

...
var toDesignableFieldProps = function (schema, components, nodeIdAttrName, id) {
  ...
  if (!components['FormItem']) {
    components['FormItem'] = next_1.FormItem
  }
  var decorator =
    schema['x-decorator'] &&
    core_1.FormPath.getIn(components, schema['x-decorator'])
  var component =
    schema['x-component'] &&
    core_1.FormPath.getIn(components, schema['x-component'])

...
export declare const createComponentSchema: (
  component: ISchema,
  decorator: ISchema
) => {
  'component-group': {
...
export declare const createFieldSchema: (
  component?: ISchema,
  decorator?: ISchema
) => ISchema
export declare const createVoidFieldSchema: (
  component?: ISchema,
  decorator?: ISchema
) => {
  type: string
  properties: {
    ...
    'field-group': {
      ...
      properties: {
        ...
        'x-reactions': {
          'x-decorator': string
          'x-component': import('react').FC<
            import('@designable/formily-setters').IReactionsSetterProps
          >
        }
        'x-decorator': {
          type: string
          'x-decorator': string
          'x-component': import('react').FC<
            import('../../common/FormItemSwitcher').IFormItemSwitcherProps
          >
        }
      }
    }

...
var parseCollapse = function (parent) {
  ...
  parent.children.forEach(function (node) {
    if (shared_1.matchComponent(node, 'FormCollapse.CollapsePanel')) {
      panels.push(node)
    }
  })
  return panels
        ...
        return react_1.default.createElement(
          ...
          react_1.default.createElement(
            ...
            panel.children.length
              ? react_1.default.createElement(react_3.TreeNodeWidget, {
                  node: panel,
                })
              : react_1.default.createElement(react_3.DroppableWidget, null)
          )
        )
      })
    )
      ...
      actions: [
        {
          ...
          icon: 'AddPanel',
          onClick: function () {
            var collapsePanel = new core_1.TreeNode({
              componentName: 'Field',
              props: {
                type: 'void',
                'x-component': 'FormCollapse.CollapsePanel',
...
exports.FormCollapse.Behavior = core_1.createBehavior(
  {
    ...
    designerProps: {
      ...
      propsSchema: Field_1.createVoidFieldSchema(
        schemas_1.AllSchemas.FormCollapse
      ),
    },
  ...
  },
  {
    ...
    designerProps: {
      ...
      propsSchema: Field_1.createVoidFieldSchema(
        schemas_1.AllSchemas.FormCollapse.CollapsePanel
      ),
    },

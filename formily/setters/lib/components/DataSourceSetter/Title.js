...
exports.Title = (0, reactive_react_1.observer)(function (props) {
  ...
  var getTitleValue = function (dataSource) {
    ...
    optionalKeys.some(function (key) {
      var _a
      var title =
        (_a = (0, shared_1.toArr)(dataSource).find(function (item) {
  ...
  var renderTitle = function (dataSource) {
    ...
    if (nodeTitle === undefined)
      return react_1.default.createElement(react_2.TextWidget, {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(react_2.IconWidget, {
      className: prefix + '-icon',
      infer: 'Remove',
      onClick: function () {
        var _a
        var newDataSource = (0, shared_1.clone)(
          (_a =

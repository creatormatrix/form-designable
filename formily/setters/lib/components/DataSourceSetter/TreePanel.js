...
exports.TreePanel = (0, reactive_react_1.observer)(function (props) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(Header_1.Header, {
      ...
      extra: react_1.default.createElement(
        antd_1.Button,
        {
          ...
          icon: react_1.default.createElement(react_2.IconWidget, {
            infer: 'Add',
          }),
        },
    ...
    react_1.default.createElement(
      'div',
      { className: ''.concat(prefix + '-layout-item-content') },
      react_1.default.createElement(antd_1.Tree, {
        blockNode: true,
        draggable: true,
        allowDrop: props.allowTree
          ? function () {
              return true
            }
          : limitTreeDrag,
        ...
        onDrop: dropHandler,
        titleRender: function (titleProps) {
          return react_1.default.createElement(
            Title_1.Title,
            __assign({}, titleProps, { treeDataSource: props.treeDataSource })
          )
        },

...
exports.DataSourceSetter = (0, reactive_react_1.observer)(function (props) {
  var className = props.className,
    ...
    _b = props.allowTree,
    allowTree = _b === void 0 ? true : _b,
    _c = props.allowExtendOption,
    allowExtendOption = _c === void 0 ? true : _c,
  ...
  var treeDataSource = (0, react_1.useMemo)(
    function () {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(react_2.TextWidget, {
    ...
    react_1.default.createElement(
      antd_1.Modal,
      {
        title: react_1.default.createElement(react_2.TextWidget, {
          token: 'SettingComponents.DataSourceSetter.configureDataSource',
        }),
        width: '65%',
      ...
      react_1.default.createElement(
        ...
        {
          className: ''
            .concat((0, classnames_1.default)(prefix, className), ' ')
            .concat(prefix + '-' + theme, ' ')
            .concat(prefix + '-layout'),
        },
        react_1.default.createElement(
          'div',
          { className: ''.concat(prefix + '-layout-item left') },
          react_1.default.createElement(TreePanel_1.TreePanel, {
        ...
        react_1.default.createElement(
          'div',
          { className: ''.concat(prefix + '-layout-item right') },
          react_1.default.createElement(DataSettingPanel_1.DataSettingPanel, {

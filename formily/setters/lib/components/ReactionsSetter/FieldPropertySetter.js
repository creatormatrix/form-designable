...
var FieldPropertySetter = function (props) {
  var _a = __read((0, react_1.useState)(['visible']), 2),
    selectKeys = _a[0],
    setSelectKeys = _a[1]
  ...
  var currentProperty = properties_1.FieldProperties.find(function (item) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      properties_1.FieldProperties.map(function (key) {
        if ((0, shared_1.isPlainObj)(key)) {
          return react_1.default.createElement(
            ...
            react_1.default.createElement(react_2.TextWidget, {
              token: 'SettingComponents.ReactionsSetter.'.concat(
                key.token || key.key
              ),
            })
          )
        ...
        return react_1.default.createElement(
          ...
          { key: key },
          react_1.default.createElement(react_2.TextWidget, {
            token: 'SettingComponents.ReactionsSetter.'.concat(key),
          })
        )
      })
    ),
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(react_settings_form_1.MonacoInput, {
          key: selectKeys[0],
              ...
              : _b.call(
                  ...
                  filterEmpty(
                    __assign(
                      __assign({}, value),
                      ((_a = {}),
                      (_a[selectKeys[0]] = '{{'.concat(expression, '}}')),
                      _a)
                    )
                  )
                )

                  ...
                  case 0:
                    ...
                    return [
                      ...
                      fetch(
                        ''
                          .concat(
                            (0, react_settings_form_1.getNpmCDNRegistry)(),
                            '/'
                          )
                          .concat(name, '/')
                          .concat(path)
...
var initDeclaration = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [
        2 /*return*/,
        react_settings_form_1.MonacoInput.loader.init().then(function (monaco) {
          return __awaiter(void 0, void 0, void 0, function () {
            var deps
            return __generator(this, function (_a) {
              switch (_a.label) {
                    ...
                    : deps.forEach(function (_a) {
                        ...
                        monaco.languages.typescript.typescriptDefaults.addExtraLib(
                          "declare module '"
                            .concat(name, "'{ ")
                            .concat(library, ' }'),
                          'file:///node_modules/'.concat(name, '/index.d.ts')
                        )
                      })
                  monaco.languages.typescript.typescriptDefaults.addExtraLib(

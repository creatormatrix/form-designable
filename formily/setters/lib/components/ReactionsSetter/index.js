...
var ReactionsSetter = function (props) {
  ...
  var formCollapse = (0, react_1.useMemo)(
    function () {
      return antd_1.FormCollapse.createFormCollapse(['deps', 'state'])
    },
    [modalVisible]
  )
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(react_3.TextWidget, {
    ...
    react_1.default.createElement(
      antd_2.Modal,
      {
        title: core_2.GlobalRegistry.getDesignerMessage(
              ...
              react_1.default.createElement(
                ...
                react_1.default.createElement(
                  SchemaField.Void,
                  {
                    ...
                    'x-component-props': {
                      key: 'deps',
                      header: core_2.GlobalRegistry.getDesignerMessage(
                  ...
                  react_1.default.createElement(
                    ...
                    react_1.default.createElement(
                      ...
                      react_1.default.createElement(
                        ...
                        props.independence &&
                          react_1.default.createElement(SchemaField.String, {
                            name: 'source',
                            ...
                            'x-component-props': {
                              showSearch: true,
                              placeholder:
                                core_2.GlobalRegistry.getDesignerMessage(
                      ...
                      react_1.default.createElement(
                        ...
                        react_1.default.createElement(SchemaField.String, {
                          ...
                          'x-validator': {
                            ...
                            message: core_2.GlobalRegistry.getDesignerMessage(
                          ...
                          'x-reactions': function (field) {
                            ...
                            field.query('.source').take(function (source) {
                              var _a, _b
                              if ((0, core_1.isVoidField)(source)) return
                              // 从外部导入的源优先
                      ...
                      react_1.default.createElement(
                        ...
                        react_1.default.createElement(SchemaField.Markup, {
                          type: 'void',
                          'x-component': 'ArrayTable.Remove',
                        })
                      )
                    ),
                    react_1.default.createElement(SchemaField.Void, {
                      title: core_2.GlobalRegistry.getDesignerMessage(

;(function (global, factory) {
  ...
  var AbstractCursorEvent = /** @class */ (function () {
    ...
    AbstractCursorEvent.prototype.transformCoordinates = function () {
      ...
      if (
        frameElement &&
        this.data.view !== Designable.Shared.globalThisPolyfill
      ) {
      ...
      _this.onMouseClick = function (e) {
        ...
        if (
          target === null || target === void 0
            ...
            : target.closest(
                '*['.concat(
                  _this.engine.props.clickStopPropagationAttrName,
                  ']'
                )
              )
        ) {
  ...
  var mergeLocales = function (target, source) {
    if (
      Designable.Shared.isPlainObj(target) &&
      Designable.Shared.isPlainObj(source)
    ) {
  ...
  var getBrowserLanguage = function () {
    ...
    return (
      ...
      ((_a = Designable.Shared.globalThisPolyfill.navigator) === null ||
      _a === void 0
        ? void 0
        : _a.language) ||
      'en'
  ...
  var DESIGNER_LANGUAGE_STORE = Formily.Reactive.observable.ref(
    getBrowserLanguage()
  )
  var DESIGNER_GlobalRegistry = {
    ...
    setDesignerBehaviors: function (behaviors) {
      DESIGNER_BEHAVIORS_STORE.value = behaviors.reduce(function (
        buf,
        behavior
      ) {
    ...
    getDesignerMessage: function (token, locales) {
      ...
      if (!locale) {
        for (var key in DESIGNER_LOCALES_STORE.value) {
          var message = Formily.Path.Path.getIn(
  ...
  var resolveDesignerProps = function (node, props) {
    if (Designable.Shared.isFn(props)) return props(node)
    return props
  }
  var TreeNode = /** @class */ (function () {
    ...
    TreeNode.prototype.allowDrop = function (parent) {
      if (!Designable.Shared.isFn(this.designerProps.allowDrop)) return true
    ...
    TreeNode.prototype.findById = function (id) {
      ...
      if (
        ((_a = this.children) === null || _a === void 0 ? void 0 : _a.length) >
        0
      ) {
    ...
    TreeNode.prototype.setNodeChildren = function () {
      ...
      return this.setChildren.apply(
        this,
        __spreadArray([], __read(nodes), false)
      )
    }
  ...
  var Viewport = /** @class */ (function () {
    ...
    Viewport.prototype.attachEvents = function () {
      ...
      this.attachRequest = Designable.Shared.requestIdle(function () {
        ...
        if (_this.isIframe) {
          ...
          _this.workspace.attachEvents(
            _this.viewportElement,
            _this.contentWindow
          )
        }
      })
    ...
    Viewport.prototype.getElementRectById = function (id) {
      ...
      var rect = Designable.Shared.calcBoundingRect(
    ...
    Viewport.prototype.getElementOffsetRectById = function (id) {
      ...
      var elementRect = Designable.Shared.calcBoundingRect(
        elements.map(function (element) {
          return _this.getElementRect(element)
        })
      )
    ...
    Selection.prototype.mapIds = function (ids) {
      return Designable.Shared.isArr(ids)
        ? ids.map(function (node) {
            return Designable.Shared.isStr(node)
              ? node
              : node === null || node === void 0
              ? void 0
              : node.id
  ...
  var SnapLine = /** @class */ (function () {
    ...
    SnapLine.prototype.translate = function (node, translate) {
      ...
      var edgeOffset = Designable.Shared.calcOffsetOfSnapLineSegmentToEdge(
        this,
        dragNodeRect
      )
      if (this.direction === 'h') {
  ...
  var SpaceBlock = /** @class */ (function () {
    ...
    Object.defineProperty(SpaceBlock.prototype, 'needExtendsLine', {
      get: function () {
        ...
        if (this.type === 'top' || this.type === 'bottom') {
          ...
          return (
            rightDelta < targetRect.width / 2 ||
            leftDelta < targetRect.width / 2
          )
        } else {
    ...
    Object.defineProperty(SpaceBlock.prototype, 'snapLine', {
      get: function () {
        ...
        var distance = Designable.Shared.calcDistanceOfSnapLineToEdges(
          line,
  ...
  var calcPositionDelta = function (end, start) {
    return Object.keys(end || {}).reduce(function (buf, key) {
      if (
        Designable.Shared.isValidNumber(
  ...
  var TransformHelper = /** @class */ (function () {
    ...
    Object.defineProperty(TransformHelper.prototype, 'cursorPosition', {
      get: function () {
        ...
        return this.operation.workspace.viewport.getOffsetPoint(
          new Designable.Shared.Point(position.clientX, position.clientY)
        )
      },
      enumerable: false,
      configurable: true,
    ...
    Object.defineProperty(TransformHelper.prototype, 'closestSpaceBlocks', {
      get: function () {
        ...
        return this.thresholdSpaceBlocks.filter(function (block) {
          ...
          return (
            Designable.Shared.calcDistanceOfSnapLineToEdges(
              line,
              cursorDragNodesEdgeLines
            ) < TransformHelper.threshold
          )
    ...
    TransformHelper.prototype.calcDragStartStore = function (nodes) {
      ...
      nodes.forEach(function (node) {
        ...
        _this.dragStartTranslateStore[node.id] =
          Designable.Shared.calcElementTranslate(element)
    ...
    TransformHelper.prototype.calcRulerSnapLines = function (dragNodesRect) {
      ...
      return this.rulerSnapLines.map(function (line) {
        line.distance = Designable.Shared.calcDistanceOfSnapLineToEdges(
          line,
          edgeLines
        )
        return line
    ...
    TransformHelper.prototype.calcAroundSnapLines = function (dragNodesRect) {
      ...
      this.eachViewportNodes(function (refer, referRect) {
        ...
        var add = function (line) {
          var _a = __read(
              Designable.Shared.calcClosestEdges(line, edgeLines),
              2
            ),
            distance = _a[0],
            edge = _a[1]
          var combined = Designable.Shared.calcCombineSnapLineSegment(
            line,
            edge
          )
          if (distance < TransformHelper.threshold) {
    ...
    TransformHelper.prototype.calcAroundSpaceBlocks = function (dragNodesRect) {
      ...
      var closestSpaces = {}
      this.eachViewportNodes(function (refer, referRect) {
        if (Designable.Shared.isEqualRect(dragNodesRect, referRect)) return
        var origin = Designable.Shared.calcSpaceBlockOfRect(
          dragNodesRect,
          referRect
        )
        if (origin) {
          ...
          if (!closestSpaces[origin.type]) {
            ...
            spaceBlock.distance < closestSpaces[origin.type].distance
          ) {
            closestSpaces[origin.type] = spaceBlock
          }
        }
    ...
    TransformHelper.prototype.addRulerSnapLine = function (line) {
      if (!Designable.Shared.isLineSegment(line)) return
  ...
  var MoveHelper = /** @class */ (function () {
    ...
    MoveHelper.prototype.calcClosestPosition = function (point, viewport) {
      ...
      var isAfter = Designable.Shared.isNearAfter(
        point,
        closestRect,
      ...
      if (
        Designable.Shared.isPointInRect(
          point,
          closestRect,
        ...
        if (!closestNode.allowAppend(this.dragNodes)) {
          if (!closestNode.allowSibling(this.dragNodes)) {
            ...
            if (isInline) {
              return isAfter
                ? exports.ClosestPosition.After
                : exports.ClosestPosition.Before
            } else {
              return isAfter
                ? exports.ClosestPosition.Under
                : exports.ClosestPosition.Upper
            }
          }
        }
        if (
        ...
        return isAfter
          ? exports.ClosestPosition.InnerAfter
          : exports.ClosestPosition.InnerBefore
      } else {
        if (!closestNode.allowSibling(this.dragNodes)) {
          var parentClosestNode = getValidParent(closestNode)
          if (parentClosestNode) {
    ...
    MoveHelper.prototype.calcClosestNode = function (point, viewport) {
      ...
      if (this.touchNode) {
        ...
        if (
          ...
          var touchDistance = Designable.Shared.calcDistancePointToEdge(
            point,
            touchNodeRect
          )
          ...
          this.touchNode.eachChildren(function (node) {
            ...
            if (!rect) return
            var distance = Designable.Shared.isPointInRect(
              point,
              rect,
              viewport.moveSensitive
            )
    ...
    MoveHelper.prototype.calcClosestRect = function (
      viewport,
      closestDirection
    ) {
      var closestNode = this.closestNode
  ...
  var Operation = /** @class */ (function () {
    ...
    Operation.prototype.dispatch = function (event, callback) {
      ...
      if (Designable.Shared.isFn(callback)) return callback()
    }
    ...
    Shortcut.prototype.preventCodes = function (codes) {
      ...
      if (this.codes.length) {
        for (var i = 0; i < codes.length; i++) {
          var sequence =
            (_a = this.codes[i]) !== null && _a !== void 0 ? _a : []
  ...
  var Keyboard = /** @class */ (function () {
    function Keyboard(engine) {
      ...
      this.engine = engine
      this.shortcuts =
        ((_a = engine.props) === null || _a === void 0
          ? void 0
          : _a.shortcuts) || []
      this.makeObservable()
    }
  ...
  var Engine = /** @class */ (function (_super) {
    ...
    Engine.prototype.findMovingNodes = function () {
      ...
      this.workbench.eachWorkspace(function (workspace) {
        var _a
        ;(_a = workspace.operation.moveHelper.dragNodes) === null ||
        _a === void 0
          ? void 0
  ...
  var useCursorEffect = function (engine) {
    engine.subscribeTo(MouseMoveEvent, function (event) {
      engine.cursor.setStatus(
        engine.cursor.status === exports.CursorStatus.Dragging ||
          engine.cursor.status === exports.CursorStatus.DragStart
          ? engine.cursor.status
          : exports.CursorStatus.Normal
      )
      if (engine.cursor.status === exports.CursorStatus.Dragging) return
  ...
  var useDragDropEffect = function (engine) {
    engine.subscribeTo(DragStartEvent, function (event) {
      if (engine.cursor.type !== exports.CursorType.Normal) return
      var target = event.data.target
      var el =
        target === null || target === void 0
          ? void 0
      ...
      var handler =
        target === null || target === void 0
          ? void 0
          : target.closest(
              '*['.concat(engine.props.nodeDragHandlerAttrName, ']')
            )
      var helper =
      ...
      if (
        !(el === null || el === void 0 ? void 0 : el.getAttribute) &&
        !handler
      )
        return
      var sourceId =
    ...
    engine.subscribeTo(DragMoveEvent, function (event) {
      if (engine.cursor.type !== exports.CursorType.Normal) return
      if (engine.cursor.dragType !== exports.CursorDragType.Move) return
      var target = event.data.target
      var el =
        target === null || target === void 0
          ? void 0
      ...
      var point = new Designable.Shared.Point(
    ...
    engine.subscribeTo(DragStopEvent, function () {
      ...
      engine.workbench.eachWorkspace(function (currentWorkspace) {
        ...
        if (dragNodes.length && closestNode && closestDirection) {
          if (
            closestDirection === exports.ClosestPosition.After ||
            ...
            closestDirection === exports.ClosestPosition.Before ||
            ...
            closestDirection === exports.ClosestPosition.Inner ||
            closestDirection === exports.ClosestPosition.InnerAfter
          ) {
  ...
  var useResizeEffect = function (engine) {
    ...
    engine.subscribeTo(DragMoveEvent, function (event) {
      var _a, _b
      if (engine.cursor.dragType !== exports.CursorDragType.Resize) return
      var currentWorkspace =
        (_b =
          (_a = event.context) === null || _a === void 0
            ? void 0
  ...
  var useSelectionEffect = function (engine) {
    engine.subscribeTo(MouseClickEvent, function (event) {
      var _a, _b, _c, _d
      if (engine.cursor.status !== exports.CursorStatus.Normal) return
      var target = event.data.target
      var el =
        (_a =
          target === null || target === void 0 ? void 0 : target.closest) ===
      ...
      if (node) {
        ...
        if (
          engine.keyboard.isKeyDown(Designable.Shared.KeyCode.Meta) ||
  ...
  var useFreeSelectionEffect = function (engine) {
    engine.subscribeTo(DragStopEvent, function (event) {
      ...
      engine.workbench.eachWorkspace(function (workspace) {
        ...
        var dragEndPoint = new Designable.Shared.Point(
          event.data.topClientX,
          event.data.topClientY
        )
        ...
        var selectionRect = Designable.Shared.calcRectByStartEndPoint(
        ...
        tree.eachChildren(function (node) {
          ...
          if (
            nodeRect &&
            Designable.Shared.isCrossRectInRect(selectionRect, nodeRect)
          ) {
  ...
  var useAutoScrollEffect = function (engine) {
    ...
    var scrolling = function (point, viewport) {
      if (engine.cursor.status === exports.CursorStatus.Dragging) {
        xScroller = Designable.Shared.calcAutoScrollBasicInfo(
          point,
          'x',
          viewport.rect
        )
        yScroller = Designable.Shared.calcAutoScrollBasicInfo(
          point,
          'y',
          viewport.rect
        )
        if (xScroller) {
          ...
          xScrollerAnimationStop = Designable.Shared.scrollAnimate(
        ...
        if (yScroller) {
          ...
          yScrollerAnimationStop = Designable.Shared.scrollAnimate(
            viewport.scrollContainer,
            'y',
            yScroller.direction,
            yScroller.speed
  ...
  var useTranslateEffect = function (engine) {
    ...
    engine.subscribeTo(DragMoveEvent, function (event) {
      var _a, _b
      if (engine.cursor.dragType !== exports.CursorDragType.Translate) return
      var currentWorkspace =
        (_b =
          (_a = event.context) === null || _a === void 0
            ? void 0
  ...
  var SelectNodes = new Shortcut({
    codes: [
      [_global_Designable_Shared_KeyCode.Meta],
      [_global_Designable_Shared_KeyCode.Control],
    ],
  })
  ...
  var PreventCommandX = new Shortcut({
    codes: [
      [
        _global_Designable_Shared_KeyCode.Meta,
        _global_Designable_Shared_KeyCode.X,
      ],
      [
        _global_Designable_Shared_KeyCode.Control,
        _global_Designable_Shared_KeyCode.X,
  ...
  var SelectAllNodes = new Shortcut({
    codes: [
      [
        _global_Designable_Shared_KeyCode.Meta,
        _global_Designable_Shared_KeyCode.A,
      ],
      [
        _global_Designable_Shared_KeyCode.Control,
        _global_Designable_Shared_KeyCode.A,
  ...
  var DeleteNodes = new Shortcut({
    codes: [
      [_global_Designable_Shared_KeyCode.Backspace],
      [_global_Designable_Shared_KeyCode.Delete],
    ],
    handler: function (context) {
      var operation =
        context === null || context === void 0
  ...
  var CopyNodes = new Shortcut({
    codes: [
      [
        _global_Designable_Shared_KeyCode.Meta,
        _global_Designable_Shared_KeyCode.C,
      ],
      [
        _global_Designable_Shared_KeyCode.Control,
        _global_Designable_Shared_KeyCode.C,
  ...
  var PasteNodes = new Shortcut({
    codes: [
      [
        _global_Designable_Shared_KeyCode.Meta,
        _global_Designable_Shared_KeyCode.V,
      ],
      [
        _global_Designable_Shared_KeyCode.Control,
        _global_Designable_Shared_KeyCode.V,
  ...
  var UndoMutation = new Shortcut({
    codes: [
      [
        _global_Designable_Shared_KeyCode.Meta,
        _global_Designable_Shared_KeyCode.Z,
      ],
      [
        _global_Designable_Shared_KeyCode.Control,
        _global_Designable_Shared_KeyCode.Z,
  ...
  var RedoMutation = new Shortcut({
    codes: [
      [
        _global_Designable_Shared_KeyCode.Meta,
        _global_Designable_Shared_KeyCode.Shift,
        _global_Designable_Shared_KeyCode.Z,
      ],
      [
        _global_Designable_Shared_KeyCode.Control,
  ...
  var CursorSwitchSelection = new Shortcut({
    codes: [
      _global_Designable_Shared_KeyCode.Shift,
      _global_Designable_Shared_KeyCode.S,
    ],
    handler: function (context) {
      var engine =
  ...
  var Core = /*#__PURE__*/ Object.freeze({
    ...
    Engine: Engine,
    get ScreenType() {
      return exports.ScreenType
    },
    get ScreenStatus() {
      return exports.ScreenStatus
    },
    Screen: Screen,
    get CursorStatus() {
      return exports.CursorStatus
    },
    get CursorDragType() {
      return exports.CursorDragType
    },
    get CursorType() {
      return exports.CursorType
    },
    Cursor: Cursor,
    Operation: Operation,
    Viewport: Viewport,
    ...
    Selection: Selection,
    get ClosestPosition() {
      return exports.ClosestPosition
    },
  ...
  if (
    (_a =
      Designable.Shared.globalThisPolyfill === null ||
      Designable.Shared.globalThisPolyfill === void 0
        ? void 0
        : Designable.Shared.globalThisPolyfill['Designable']) === null ||
    _a === void 0
      ? void 0
      : _a['Core']
  ) {

import { ILineSegment, IPoint, Rect } from '@designable/shared'
import { TreeNode } from './TreeNode'
import { TransformHelper } from './TransformHelper'
export declare type ISnapLineType = 'ruler' | 'space-block' | 'normal'
export declare type ISnapLine = ILineSegment & {
  type?: ISnapLineType
  distance?: number
  id?: string
  refer?: TreeNode

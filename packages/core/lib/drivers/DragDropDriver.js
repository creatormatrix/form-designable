...
var DragDropDriver = /** @class */ (function (_super) {
  ...
  function DragDropDriver() {
    ...
    _this.onMouseUp = function (e) {
      ...
      _this.batchRemoveEventListener(
        'contextmenu',
        _this.onContextMenuWhileDragging,
        true
      )
      ...
      if (
        e.clientX ===
          ((_a = GlobalState.moveEvent) === null || _a === void 0
            ...
            : _a.clientX) &&
        e.clientY ===
          ((_b = GlobalState.moveEvent) === null || _b === void 0
            ? void 0
            : _b.clientY)
      )
        return
      _this.dispatch(
        new events_1.DragMoveEvent({
          clientX: e.clientX,
          clientY: e.clientY,
          pageX: e.pageX,
          pageY: e.pageY,
    ...
    _this.onStartDrag = function (e) {
      ...
      _this.batchAddEventListener(
        'contextmenu',
        _this.onContextMenuWhileDragging,
        true
      )
      _this.dispatch(
        new events_1.DragStartEvent({

...
var useAutoScrollEffect = function (engine) {
  ...
  var scrolling = function (point, viewport) {
    if (engine.cursor.status === models_1.CursorStatus.Dragging) {
      xScroller = (0, shared_1.calcAutoScrollBasicInfo)(
        point,
        'x',
        viewport.rect
      )
      yScroller = (0, shared_1.calcAutoScrollBasicInfo)(
        point,
        'y',
        viewport.rect
      )
      if (xScroller) {
        ...
        xScrollerAnimationStop = (0, shared_1.scrollAnimate)(
      ...
      if (yScroller) {
        ...
        yScrollerAnimationStop = (0, shared_1.scrollAnimate)(
          viewport.scrollContainer,
          'y',
          yScroller.direction,
          yScroller.speed

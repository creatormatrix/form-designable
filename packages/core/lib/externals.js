...
exports.createDesigner =
  ...
  exports.createBehavior =
  exports.createLocales =
  exports.isResource =
  exports.isResourceList =
  exports.isResourceHost =
  exports.isBehavior =
  exports.isBehaviorList =
  exports.isBehaviorHost =
    void 0
...
var isBehaviorHost = function (val) {
  return (
    (val === null || val === void 0 ? void 0 : val.Behavior) &&
    (0, exports.isBehaviorList)(val.Behavior)
  )
}
...
var isResourceHost = function (val) {
  return (
    (val === null || val === void 0 ? void 0 : val.Resource) &&
    (0, exports.isResourceList)(val.Resource)
  )
}
...
var isResource = function (val) {
  return (
    (val === null || val === void 0 ? void 0 : val.node) &&
    !!val.node.isSourceNode &&
    val.node instanceof models_1.TreeNode
  )
}
...
var createBehavior = function () {
  ...
  return behaviors.reduce(function (buf, behavior) {
    if ((0, shared_1.isArr)(behavior))
      return buf.concat(
        exports.createBehavior.apply(
          void 0,
          __spreadArray([], __read(behavior), false)
        )
      )
    ...
    if (typeof selector === 'string') {
      behavior.selector = function (node) {
        return node.componentName === selector
      }
    }
...
var createResource = function () {
  ...
  return sources.reduce(function (buf, source) {
    return buf.concat(
      __assign(__assign({}, source), {
        node: new models_1.TreeNode({
...
var createDesigner = function (props) {
  ...
  return (0, reactive_1.untracked)(function () {
    return new models_1.Engine(
      __assign(__assign({}, props), {
        effects: __spreadArray(
          __spreadArray([], __read(effects), false),
          __read(presets_1.DEFAULT_EFFECTS),
          false
        ),
        drivers: __spreadArray(
          __spreadArray([], __read(drivers), false),
          __read(presets_1.DEFAULT_DRIVERS),
          false
        ),
        shortcuts: __spreadArray(
          __spreadArray([], __read(shortcuts), false),
          __read(presets_1.DEFAULT_SHORTCUTS),
          false
        ),
      })
    )

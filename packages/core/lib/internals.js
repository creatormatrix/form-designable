...
var mergeLocales = function (target, source) {
  if ((0, shared_1.isPlainObj)(target) && (0, shared_1.isPlainObj)(source)) {
    ;(0, shared_1.each)(source, function (value, key) {
      ...
      var messages = (0, exports.mergeLocales)(
        target[key] || target[token],
        value
      )
...
var getBrowserLanguage = function () {
  ...
  return (
    shared_2.globalThisPolyfill.navigator['browserlanguage'] ||
    ((_a = shared_2.globalThisPolyfill.navigator) === null || _a === void 0
      ? void 0
      : _a.language) ||
    'en'
  )

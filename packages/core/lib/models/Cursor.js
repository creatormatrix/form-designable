...
exports.Cursor =
  exports.CursorType =
  exports.CursorDragType =
  exports.CursorStatus =
    void 0
...
})((CursorDragType = exports.CursorDragType || (exports.CursorDragType = {})))
var CursorType
;(function (CursorType) {
    ...
    (_b =
      (_a =
        document === null || document === void 0
          ? void 0
          : document.getElementsByTagName) === null || _a === void 0
        ? void 0
    ...
    (_d =
      (_c =
        contentWindow === null || contentWindow === void 0
          ? void 0
          : contentWindow.document) === null || _c === void 0
        ? void 0
...
var calcPositionDelta = function (end, start) {
  return Object.keys(end || {}).reduce(function (buf, key) {
    if (
      (0, shared_1.isValidNumber)(
        end === null || end === void 0 ? void 0 : end[key]
      ) &&
      (0, shared_1.isValidNumber)(
        start === null || start === void 0 ? void 0 : start[key]
      )
    ) {

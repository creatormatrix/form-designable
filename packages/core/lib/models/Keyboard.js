...
var Keyboard = /** @class */ (function () {
  function Keyboard(engine) {
    ...
    this.engine = engine
    this.shortcuts =
      ((_a = engine.props) === null || _a === void 0 ? void 0 : _a.shortcuts) ||
      []
    this.makeObservable()
  }
  ...
  Keyboard.prototype.includes = function (key) {
    return this.sequence.some(function (code) {
      return Shortcut_1.Shortcut.matchCode(code, key)
    })
  }
  Keyboard.prototype.excludes = function (key) {
    this.sequence = this.sequence.filter(function (code) {
      return !Shortcut_1.Shortcut.matchCode(key, code)
    })
  }
  ...
  Keyboard.prototype.isModifier = function (code) {
    return Modifiers.some(function (modifier) {
      return Shortcut_1.Shortcut.matchCode(modifier[1], code)
    })
  }

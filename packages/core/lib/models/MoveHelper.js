...
var MoveHelper = /** @class */ (function () {
  ...
  MoveHelper.prototype.calcClosestPosition = function (point, viewport) {
    ...
    var isAfter = (0, shared_1.isNearAfter)(
      point,
      closestRect,
    ...
    if (
      (0, shared_1.isPointInRect)(point, closestRect, viewport.moveSensitive)
    ) {
  ...
  MoveHelper.prototype.calcClosestNode = function (point, viewport) {
    ...
    if (this.touchNode) {
      ...
      if (
        ...
        var touchDistance = (0, shared_1.calcDistancePointToEdge)(
          point,
          touchNodeRect
        )
        ...
        this.touchNode.eachChildren(function (node) {
          ...
          if (!rect) return
          var distance = (0, shared_1.isPointInRect)(
            point,
            rect,
  ...
  MoveHelper.prototype.dragStart = function (props) {
    var nodes = TreeNode_1.TreeNode.filterDraggable(
      props === null || props === void 0 ? void 0 : props.dragNodes
    )
    if (nodes.length) {
      this.dragNodes = nodes
      this.trigger(
        new events_1.DragNodeEvent({

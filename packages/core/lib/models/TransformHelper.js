...
var TransformHelper = /** @class */ (function () {
  ...
  Object.defineProperty(TransformHelper.prototype, 'cursorPosition', {
    get: function () {
      ...
      return this.operation.workspace.viewport.getOffsetPoint(
        new shared_1.Point(position.clientX, position.clientY)
      )
    },
    enumerable: false,
    configurable: true,
  ...
  Object.defineProperty(TransformHelper.prototype, 'dragNodesRect', {
    get: function () {
      ...
      return (0, shared_1.calcBoundingRect)(
        this.dragNodes.map(function (node) {
          return node.getValidElementOffsetRect()
        })
      )
    },
    enumerable: false,
  ...
  Object.defineProperty(TransformHelper.prototype, 'closestSnapLines', {
    get: function () {
      ...
      this.thresholdSnapLines.forEach(function (line) {
        var distance = (0, shared_1.calcDistanceOfSnapLineToEdges)(
          line,
  ...
  Object.defineProperty(TransformHelper.prototype, 'closestSpaceBlocks', {
    get: function () {
      ...
      return this.thresholdSpaceBlocks.filter(function (block) {
        ...
        return (
          (0, shared_1.calcDistanceOfSnapLineToEdges)(
            line,
            cursorDragNodesEdgeLines
    ...
    get: function () {
      ...
      for (var type in this.aroundSpaceBlocks) {
        ...
        if (block.isometrics.length) {
          ...
          results.push.apply(
            results,
            __spreadArray([], __read(block.isometrics), false)
          )
        }
      }
      return results
  ...
  TransformHelper.prototype.calcDragStartStore = function (nodes) {
    ...
    nodes.forEach(function (node) {
      ...
      _this.dragStartTranslateStore[node.id] = (0,
      shared_1.calcElementTranslate)(element)
  ...
  TransformHelper.prototype.calcRulerSnapLines = function (dragNodesRect) {
    ...
    return this.rulerSnapLines.map(function (line) {
      line.distance = (0, shared_1.calcDistanceOfSnapLineToEdges)(
        line,
        edgeLines
      )
      return line
  ...
  TransformHelper.prototype.calcAroundSpaceBlocks = function (dragNodesRect) {
    ...
    var closestSpaces = {}
    this.eachViewportNodes(function (refer, referRect) {
      if ((0, shared_1.isEqualRect)(dragNodesRect, referRect)) return
      var origin = (0, shared_1.calcSpaceBlockOfRect)(dragNodesRect, referRect)
      if (origin) {
        var spaceBlock = new SpaceBlock_1.SpaceBlock(
          _this,
  ...
  TransformHelper.prototype.translate = function (node, handler) {
    ...
    try {
      for (
        var _b = __values(this.closestSnapLines), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var line = _c.value
  ...
  TransformHelper.prototype.findRulerSnapLine = function (id) {
    return this.rulerSnapLines.find(function (item) {
      return item.id === id
    })
  }
  TransformHelper.prototype.addRulerSnapLine = function (line) {
    if (!(0, shared_1.isLineSegment)(line)) return
    if (!this.findRulerSnapLine(line.id)) {
      this.rulerSnapLines.push(
        new SnapLine_1.SnapLine(
          this,
          __assign(__assign({}, line), { type: 'ruler' })
        )
      )
    }
  }

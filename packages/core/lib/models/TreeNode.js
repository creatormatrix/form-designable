...
var resolveDesignerProps = function (node, props) {
  if ((0, shared_1.isFn)(props)) return props(node)
  return props
}
var TreeNode = /** @class */ (function () {
  ...
  TreeNode.prototype.getElement = function (area) {
    ...
    return (_a = this[area]) === null || _a === void 0
      ? void 0
  ...
  TreeNode.prototype.getValidElementOffsetRect = function (area) {
    ...
    return (_a = this[area]) === null || _a === void 0
      ? void 0
      : _a.getValidNodeOffsetRect(this)
  }
  ...
  TreeNode.prototype.getParentByDepth = function (depth) {
    ...
    if (
      ...
      return parent === null || parent === void 0
        ? void 0
        : parent.getParentByDepth(depth)
    }
  }
  TreeNode.prototype.getMessage = function (token) {
    return registry_1.GlobalRegistry.getDesignerMessage(
      token,
    ...
    if (
      ((_b =
        (_a = this.designerProps) === null || _a === void 0
          ? void 0
          : _a.allowSiblings) === null || _b === void 0
        ? void 0
        : _b.call(_a, this, nodes)) === false
    )
      return false
    return (_c = this.parent) === null || _c === void 0
      ? void 0
      : _c.allowAppend(nodes)
  }
  TreeNode.prototype.allowDrop = function (parent) {
    if (!(0, shared_1.isFn)(this.designerProps.allowDrop)) return true
  ...
  TreeNode.prototype.allowAppend = function (nodes) {
    ...
    if (
      ((_c =
        (_b = this.designerProps) === null || _b === void 0
          ? void 0
          : _b.allowAppend) === null || _c === void 0
        ? void 0
        : _c.call(_b, this, nodes)) === false
    )
      return false
    if (
      nodes.some(function (node) {
        return !node.allowDrop(_this)
      })
    )
      return false
  ...
  TreeNode.prototype.findById = function (id) {
    ...
    if (
      ((_a = this.children) === null || _a === void 0 ? void 0 : _a.length) > 0
    ) {
    ...
    return nodes.every(function (node) {
      if (
        ...
        (node === null || node === void 0
          ? void 0
          : node.getParentByDepth(_this.depth)) === _this
      ) {
        return true
      }
      return false
  ...
  TreeNode.prototype.setProps = function (props) {
    ...
    return this.triggerMutation(
      new events_1.UpdateNodePropsEvent({
        target: this,
        source: null,
      }),
      function () {
  ...
  TreeNode.prototype.insertAfter = function () {
    ...
    if (
      ...
      return []
    if (
      (_a = parent === null || parent === void 0 ? void 0 : parent.children) ===
        null || _a === void 0
        ? void 0
        : _a.length
    ) {
  ...
  TreeNode.prototype.insertBefore = function () {
    ...
    if (
      ...
      return this.triggerMutation(
        new events_1.InsertBeforeEvent({
          originSourceParents: originSourceParents,
          target: this,
          source: newNodes_2,
        }),
  ...
  TreeNode.prototype.insertChildren = function (start) {
    ...
    if ((_a = this.children) === null || _a === void 0 ? void 0 : _a.length) {
      ...
      return this.triggerMutation(
        new events_1.InsertChildrenEvent({
          originSourceParents: originSourceParents,
          target: this,
          source: newNodes_3,
        }),
  ...
  TreeNode.prototype.setChildren = function () {
    ...
    var newNodes = this.resetNodesParent(nodes, this)
    return this.triggerMutation(
      new events_1.UpdateChildrenEvent({
        originSourceParents: originSourceParents,
        target: this,
        source: newNodes,
      }),
    ...
    return this.triggerMutation(
      ...
      function () {
        ...
        if (node.children) {
          _this.children =
            ((_c =
              (_b = node.children) === null || _b === void 0
                ? void 0
                : _b.map) === null || _c === void 0
              ? void 0
              : _c.call(_b, function (node) {
  ...
  TreeNode.remove = function (nodes) {
    ...
    for (var i = nodes.length - 1; i >= 0; i--) {
      ...
      if (node.allowDelete()) {
        ...
        ;(_a = node.operation) === null || _a === void 0
          ? void 0
          : _a.selection.select(previous ? previous : next ? next : node.parent)
  ...
  TreeNode.clone = function (nodes) {
    ...
    ;(0, shared_1.each)(filterNestedNode, function (node) {
      ...
      groups[
        ...
        groups[
          (_b = node === null || node === void 0 ? void 0 : node.parent) ===
            null || _b === void 0
            ? void 0
            : _b.id
        ] || []
      groups[
        (_c = node === null || node === void 0 ? void 0 : node.parent) ===
          null || _c === void 0
          ? void 0
          : _c.id
      ].push(node)
      if (
        lastGroupNode[
          (_d = node === null || node === void 0 ? void 0 : node.parent) ===
            null || _d === void 0
            ? void 0
            : _d.id
        ]
        ...
        if (
          node.index >
          lastGroupNode[
            (_e = node === null || node === void 0 ? void 0 : node.parent) ===
              null || _e === void 0
              ? void 0
              : _e.id
          ].index
          ...
          lastGroupNode[
            (_f = node === null || node === void 0 ? void 0 : node.parent) ===
              null || _f === void 0
              ? void 0
              : _f.id
          ] = node
        ...
        lastGroupNode[
          (_g = node === null || node === void 0 ? void 0 : node.parent) ===
            null || _g === void 0
            ? void 0
            : _g.id
        ] = node
  ...
  TreeNode.filterDraggable = function (nodes) {
    ...
    return nodes.reduce(function (buf, node) {
      ...
      if (
        (0, shared_1.isFn)(
          (_a =
            node === null || node === void 0 ? void 0 : node.designerProps) ===
            null || _a === void 0
            ? void 0
            : _a.getDragNodes
        )

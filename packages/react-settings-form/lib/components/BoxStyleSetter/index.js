...
exports.BoxStyleSetter = (0, react_2.observer)(function (props) {
        ...
        if (position === 'all') {
          ...
          ;(_b = props.onChange) === null || _b === void 0
            ...
            : _b.call(
                props,
                ''
                  .concat(matched[1] || '0px', ' ')
                  .concat(matched[2] || '0px', ' ')
                  .concat(matched[3] || '0px', ' ')
                  .concat(matched[4] || '0px')
              )
        }
      },
    })
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      FoldItem_1.FoldItem.Base,
      null,
      react_1.default.createElement(
        SizeInput_1.SizeInput,
        __assign({}, createPositionHandler('all', props), {
          exclude: ['inherit', 'auto'],
        })
      )
    ),
    react_1.default.createElement(
      FoldItem_1.FoldItem.Extra,
      null,
      react_1.default.createElement(
        InputItems_1.InputItems,
        { width: '50%' },
        react_1.default.createElement(
          InputItems_1.InputItems.Item,
          { icon: props.labels[0] },
          react_1.default.createElement(
            SizeInput_1.SizeInput,
            __assign({}, createPositionHandler('top', props), {
              exclude: ['inherit', 'auto'],
            })
          )
        ),
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            SizeInput_1.SizeInput,
            __assign({}, createPositionHandler('right', props), {
              exclude: ['inherit', 'auto'],
            })
          )
        ),
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            SizeInput_1.SizeInput,
            __assign({}, createPositionHandler('bottom', props), {
              exclude: ['inherit', 'auto'],
            })
          )
        ),
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            SizeInput_1.SizeInput,
            __assign({}, createPositionHandler('left', props), {
              exclude: ['inherit', 'auto'],
            })
          )
        )
...
exports.BoxStyleSetter.defaultProps = {
  labels: [
    react_1.default.createElement(react_3.IconWidget, {
      infer: 'Top',
      size: 16,
      key: '1',
    }),

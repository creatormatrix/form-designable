...
exports.DisplayStyleSetter = (0, react_2.observer)(function (props) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      antd_1.FormItem.BaseItem,
      {
        label: field.title,
        className: (0, classnames_1.default)(prefix, props.className),
        style: props.style,
      },
      react_1.default.createElement(antd_2.Radio.Group, {
        className: prefix + '-radio',
        options: [
          {
            label: react_1.default.createElement(react_3.IconWidget, {
              infer: 'DisplayBlock',
              size: 16,
            }),
            value: 'block',

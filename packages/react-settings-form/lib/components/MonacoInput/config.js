...
var chrome_1 = __importDefault(require('./themes/chrome'))
var monokai_1 = __importDefault(require('./themes/monokai'))
var format_1 = require('./format')
var initialized = false
var initMonaco = function () {
  if (initialized) return
  react_1.loader.init().then(function (monaco) {
            ...
            switch (_c.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  (0, format_1.format)(
                    ((_a = model['getDesignerLanguage']) === null ||
                    _a === void 0
                      ? void 0
                      : _a.call(model)) || 'typescript',
                    model.getValue()
                  ),
                ]
              case 1:

;(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var useWorkspace = function (id) {
    ...
    var workspaceId =
      id ||
      ((_a = React.useContext(WorkspaceContext)) === null || _a === void 0
        ? void 0
        : _a.id)
    if (workspaceId) {
  ...
  var useValidNodeOffsetRect = function (node) {
    ...
    var compute = React.useCallback(
      function () {
        if (
          engine.cursor.status !== Designable.Core.CursorStatus.Normal &&
  ...
  var useComponents = function () {
    return React.useContext(DesignerComponentsContext)
  }
  ...
  */
  ...
  var Insertion$1 = Formily.ReactiveReact.observer(function () {
    ...
    var createInsertionStyle = function () {
      ...
      if (
        closestDirection === Designable.Core.ClosestPosition.Before ||
        ...
        closestDirection === Designable.Core.ClosestPosition.After ||
  ...
  var IconWidget = Formily.ReactiveReact.observer(function (props) {
    ...
    var renderTooltips = function (children) {
      if (
        !Designable.Shared.isStr(props.infer) &&
        (context === null || context === void 0 ? void 0 : context.tooltip)
      )
        return children
      var tooltip =
        props.tooltip ||
        registry.getDesignerMessage('icons.'.concat(props.infer))
      if (tooltip) {
        var title =
          React.isValidElement(tooltip) || Designable.Shared.isStr(tooltip)
            ? tooltip
            : tooltip.title
        var props_1 =
          React.isValidElement(tooltip) || Designable.Shared.isStr(tooltip)
  ...
  var Helpers = function (_a) {
    ...
    var ref = React.useRef()
    var _c = __read(React.useState('top-right'), 2),
      position = _c[0],
      setPosition = _c[1]
    React.useLayoutEffect(
      function () {
        ...
        update()
        return Formily.Reactive.reaction(
          function () {
            return [
              viewport.width,
              viewport.height,
    ...
    return React.createElement(
      'div',
      {
        className: classnames(prefix, ((_b = {}), (_b[position] = true), _b)),
        ref: ref,
      },
      React.createElement(
        'div',
        ...
        (node === null || node === void 0 ? void 0 : node.allowClone()) ===
          false
          ? null
        ...
        (node === null || node === void 0 ? void 0 : node.allowDelete()) ===
          false
          ? null
          : React.createElement(Delete$1, { node: node })
      )
    )
  }
  ...
  var FreeSelection = Formily.ReactiveReact.observer(function () {
    ...
    var createSelectionStyle = function () {
      ...
      var rect = Designable.Shared.calcRectByStartEndPoint(
        startDragPoint,
        currentPoint,
  ...
  var Cover = Formily.ReactiveReact.observer(function () {
    ...
    if (cursor.status !== Designable.Core.CursorStatus.Dragging) return null
    return React.createElement(
      React.Fragment,
      null,
  ...
  var TreeNodeWidget = Formily.ReactiveReact.observer(function (props) {
    ...
    var renderChildren = function () {
      ...
      if (
        ...
        return []
      return (_b =
        node === null || node === void 0 ? void 0 : node.children) === null ||
        _b === void 0
        ? void 0
  ...
  var DesignerToolsWidget = Formily.ReactiveReact.observer(function (props) {
    ...
    var renderCursorController = function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          {
            size: 'small',
            disabled: cursor.type === Designable.Core.CursorType.Normal,
            onClick: function () {
        ...
        React.createElement(
          ...
          {
            size: 'small',
            disabled: cursor.type === Designable.Core.CursorType.Selection,
            onClick: function () {
    ...
    var renderResponsiveController = function () {
      ...
      if (screen.type !== Designable.Core.ScreenType.Responsive) return null
      return React.createElement(
        React.Fragment,
        null,
    ...
    var renderScreenTypeController = function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          {
            size: 'small',
            disabled: screen.type === Designable.Core.ScreenType.PC,
            onClick: function () {
        ...
        React.createElement(
          ...
          {
            size: 'small',
            disabled: screen.type === Designable.Core.ScreenType.Mobile,
            onClick: function () {
        ...
        React.createElement(
          ...
          {
            size: 'small',
            disabled: screen.type === Designable.Core.ScreenType.Responsive,
            onClick: function () {
    ...
    var renderMobileController = function () {
      if (!props.use.includes('SCREEN_TYPE')) return null
      if (screen.type !== Designable.Core.ScreenType.Mobile) return
      return React.createElement(
        Antd.Button,
        {
          size: 'small',
    ...
    return React.createElement(
      'div',
      { style: props.style, className: classnames(prefix, props.className) },
  ...
  var ViewToolsWidget = Formily.ReactiveReact.observer(function (_a) {
    ...
    return React.createElement(
      Antd.Button.Group,
      { style: style, className: classnames(prefix, className) },
  ...
  var TextWidget = Formily.ReactiveReact.observer(function (props) {
    var takeLocale = function (message) {
      if (Designable.Shared.isStr(message)) return message
  ...
  var ResourceWidget = Formily.ReactiveReact.observer(function (props) {
    ...
    var _a = __read(React.useState(props.defaultExpand), 2),
      expand = _a[0],
      setExpand = _a[1]
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          sources.map(
            Designable.Shared.isFn(props.children) ? props.children : renderNode
          ),
          remainItems
  ...
  var GhostWidget = Formily.ReactiveReact.observer(function () {
    ...
    return cursor.status === Designable.Core.CursorStatus.Dragging
      ? React.createElement(
          'div',
          { ref: ref, className: prefix },
          renderNodes()
  ...
  var OutlineTreeNode = Formily.ReactiveReact.observer(function (_a) {
    ...
    var renderTitle = function (node) {
      if (Designable.Shared.isFn(ctx.renderTitle)) return ctx.renderTitle(node)
      return React.createElement(
        'span',
        null,
        React.createElement(NodeTitleWidget, { node: node })
    ...
    return React.createElement(
      'div',
      {
        style: style,
        ref: ref,
        className: classnames(prefix, className, 'expanded'),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            node !== node.root &&
              React.createElement(IconWidget, {
                className: classnames(prefix + '-hidden-icon', {
                  hidden: node.hidden,
                }),
  ...
  var OutlineTreeWidget = Formily.ReactiveReact.observer(function (_a) {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        __assign({}, props, {
          className: classnames(prefix + '-container', className),
          style: style,
        }),
        React.createElement(
          'div',
  ...
  var NodeActionsWidget = Formily.ReactiveReact.observer(function (props) {
    ...
    return React.createElement(
      'div',
      { className: classnames(prefix, props.className), style: props.style },
      React.createElement(
        'div',
        { className: prefix + '-content' },
        React.createElement(
          Antd.Space,
          { split: React.createElement(Antd.Divider, { type: 'vertical' }) },
          props.children
        )
      )
    )
  ...
  var Clone = React.createElement('path', {
  ...
  var Repeat = React.createElement('path', {
  ...
  var Component = React.createElement('path', {
  ...
  var Hidden = React.createElement('path', {
  ...
  var Remove = React.createElement('path', {
  ...
  var Setting = React.createElement('path', {
  ...
  var Redo = React.createElement('path', {
  ...
  var Mobile = React.createElement(
    'svg',
    { viewBox: '0 0 1024 1024' },
    React.createElement('path', {
  ...
  var Responsive = React.createElement(
    'svg',
  ...
  var Move = React.createElement('path', {
  ...
  var FreeMove = React.createElement(
    'svg',
    { viewBox: '0 0 1024 1024' },
    React.createElement('path', {
  ...
  var Selection = React.createElement('path', {
  ...
  var Recover = React.createElement('path', {
  ...
  var Flip = React.createElement('path', {
  ...
  var Expand = React.createElement('path', {
  ...
  var DragMove = React.createElement(
    'svg',
    { viewBox: '0 0 48 48' },
    React.createElement('path', {
  ...
  var PushPinOutlined = React.createElement(
    'svg',
    {
      viewBox: '64 64 896 896',
      focusable: 'false',
  ...
  var PushPinFilled = React.createElement(
    'svg',
    {
      viewBox: '64 64 896 896',
      focusable: 'false',
  ...
  var Outline = React.createElement('path', {
  ...
  var JSON = React.createElement('path', {
  ...
  var Code = React.createElement('path', {
  ...
  var EyeClose = React.createElement(
    'svg',
    null,
    React.createElement('path', {
  ...
  var Command = React.createElement(
    'svg',
    null,
    React.createElement('path', {
  ...
  var Delete = React.createElement(
    'svg',
    null,
    React.createElement('path', {
  ...
  var Shift = React.createElement('path', {
  ...
  var CloudUpload = React.createElement(
    'svg',
    { viewBox: '64 64 896 896' },
    React.createElement('path', {
  ...
  var Boolean = React.createElement(
    'svg',
    null,
    React.createElement('path', {
  ...
  var Number = React.createElement(
    'svg',
    null,
    React.createElement('path', {
  ...
  var RichText = React.createElement(
    'svg',
    null,
    React.createElement('path', {
  ...
  var Expression = React.createElement('path', {
  ...
  var Formula = React.createElement('path', {
  ...
  var Top = React.createElement('path', {
  ...
  var TopLeft = React.createElement('path', {
  ...
  var TopRight = React.createElement('path', {
    d: 'M152,872 L152,952 L72,952 L72,872 L152,872 Z M312,872 L312,952 L232,952 L232,872 L312,872 Z M472,872 L472,952 L392,952 L392,872 L472,872 Z M632,872 L632,952 L552,952 L552,872 L632,872 Z M952,872 L952,952 L872,952 L872,872 L952,872 Z M792,872 L792,952 L712,952 L712,872 L792,872 Z M152,712 L152,792 L72,792 L72,712 L152,712 Z M952,712 L952,792 L872,792 L872,712 L952,712 Z M152,552 L152,632 L72,632 L72,552 L152,552 Z M832,72 C898.3,72 952,125.7 952,192 L952,192 L952,632 L872,632 L872,232 C872,188.2 836.9,152.7 793.3,152 L793.3,152 L392,152 L392,72 Z M152,392 L152,472 L72,472 L72,392 L152,392 Z M152,232 L152,312 L72,312 L72,232 L152,232 Z M152,72 L152,152 L72,152 L72,72 L152,72 Z M312,72 L312,152 L232,152 L232,72 L312,72 Z',
  })
  var BottomRight = React.createElement('path', {
    d: 'M152,872 L152,952 L72,952 L72,872 L152,872 Z M312,872 L312,952 L232,952 L232,872 L312,872 Z M472,872 L472,952 L392,952 L392,872 L472,872 Z M632,872 L632,952 L552,952 L552,872 L632,872 Z M952,872 L952,952 L872,952 L872,872 L952,872 Z M792,872 L792,952 L712,952 L712,872 L792,872 Z M152,712 L152,792 L72,792 L72,712 L152,712 Z M952,712 L952,792 L872,792 L872,712 L952,712 Z M152,552 L152,632 L72,632 L72,552 L152,552 Z M832,72 C898.3,72 952,125.7 952,192 L952,192 L952,632 L872,632 L872,232 C872,188.2 836.9,152.7 793.3,152 L793.3,152 L392,152 L392,72 Z M152,392 L152,472 L72,472 L72,392 L152,392 Z M152,232 L152,312 L72,312 L72,232 L152,232 Z M152,72 L152,152 L72,152 L72,72 L152,72 Z M312,72 L312,152 L232,152 L232,72 L312,72 Z',
    transform:
      'translate(512.000000, 512.000000) scale(1, -1) translate(-512.000000, -512.000000) ',
  })
  var BottomLeft = React.createElement('path', {
    d: 'M152,872 L152,952 L72,952 L72,872 L152,872 Z M312,872 L312,952 L232,952 L232,872 L312,872 Z M472,872 L472,952 L392,952 L392,872 L472,872 Z M632,872 L632,952 L552,952 L552,872 L632,872 Z M952,872 L952,952 L872,952 L872,872 L952,872 Z M792,872 L792,952 L712,952 L712,872 L792,872 Z M152,712 L152,792 L72,792 L72,712 L152,712 Z M952,712 L952,792 L872,792 L872,712 L952,712 Z M152,552 L152,632 L72,632 L72,552 L152,552 Z M832,72 C898.3,72 952,125.7 952,192 L952,192 L952,632 L872,632 L872,232 C872,188.2 836.9,152.7 793.3,152 L793.3,152 L392,152 L392,72 Z M152,392 L152,472 L72,472 L72,392 L152,392 Z M152,232 L152,312 L72,312 L72,232 L152,232 Z M152,72 L152,152 L72,152 L72,72 L152,72 Z M312,72 L312,152 L232,152 L232,72 L312,72 Z',
    transform:
      'translate(512.000000, 512.000000) scale(-1, -1) translate(-512.000000, -512.000000) ',
  })

  var Image = React.createElement('path', {
  ...
  var ImageSize = React.createElement('path', {
  ...
  var Blur = React.createElement('path', {
  ...
  var Shadow = React.createElement('path', {
  ...
  var AxisX = React.createElement('path', {
  ...
  var AxisY = React.createElement('path', {
  ...
  var FontWeight = React.createElement('path', {
  ...
  var FontStyle = React.createElement('path', {
  ...
  var NormalFontStyle = React.createElement('path', {
  ...
  var ItalicFontStyle = React.createElement('path', {
  ...
  var FontColor = React.createElement('path', {
  ...
  var FontSize = React.createElement('path', {
    d: 'M100,189.5 C102.155215,189.5 104.27062,189.67045 106.333468,189.998605 L580,190 L580,190 C602.09139,190 620,207.90861 620,230 L620,280 C620,302.09139 602.09139,320 580,320 C557.90861,320 540,302.09139 540,280 L540,270 L380,270 L380,753 L500,753 C522.09139,753 540,770.90861 540,793 C540,815.09139 522.09139,833 500,833 L180,833 C157.90861,833 140,815.09139 140,793 C140,770.90861 157.90861,753 180,753 L300,753 L300,269.999 L140,269.999 L140,279.5 C140,301.59139 122.09139,319.5 100,319.5 C77.90861,319.5 60,301.59139 60,279.5 L60,229.5 C60,207.40861 77.90861,189.5 100,189.5 Z M652,833 C629.90861,833 612,815.09139 612,793 C612,770.90861 629.90861,753 652,753 L712,753 L712,541 L620,541 L620,551 C620,573.09139 602.09139,591 580,591 C557.90861,591 540,573.09139 540,551 L540,501 C540,478.90861 557.90861,461 580,461 L924,461 L924,461 C946.09139,461 964,478.90861 964,501 L964,551 C964,573.09139 946.09139,591 924,591 C901.90861,591 884,573.09139 884,551 L884,541 L792,541 L792,753 L852,753 C874.09139,753 892,770.90861 892,793 C892,815.09139 874.09139,833 852,833 L652,833 Z',
  })
  var LineHeight = React.createElement('path', {
  ...
  var TextDecoration = React.createElement('path', {
  ...
  var TextUnderline = React.createElement('path', {
  ...
  var TextLineThrough = React.createElement('path', {
    d: 'M551.208577,113.100229 C571.408577,121.400229 587.508577,137.900229 595.408577,158.200229 L734.856,519 L863,519 C890.061953,519 912,540.938047 912,568 C912,595.061953 890.061953,617 863,617 L772.732,617 L867.308577,861.700229 C875.308577,882.300229 865.008577,905.500229 844.408577,913.400229 C839.708577,915.200229 834.808577,916.100229 830.008577,916.100229 C814.008577,916.100229 798.808577,906.400229 792.708577,890.500229 L687.001,617 L343.875,617 L231.008577,891.300229 C222.608577,911.700229 199.208577,921.500229 178.808577,913.100229 C158.408577,904.700229 148.608577,881.300229 157.008577,860.900229 L257.366,617 L161,617 C133.938047,617 112,595.061953 112,568 C112,540.938047 133.938047,519 161,519 L297.69,519 L446.808577,156.600229 C454.908577,136.800229 470.308577,121.400229 490.008577,113.200229 C509.708577,105.000229 531.508577,104.900229 551.208577,113.100229 Z M520.808577,187.000229 L384.199,519 L649.125,519 L520.808577,187.000229 Z',
  })
  var TextAlign = React.createElement('path', {
  ...
  var TextAlignLeft = React.createElement('path', {
  ...
  var TextAlignCenter = React.createElement('path', {
  ...
  var TextAlignRight = React.createElement('path', {
  ...
  var TextAlignJustify = React.createElement('path', {
  ...
  var DisplayBlock = React.createElement('path', {
  ...
  var DisplayInlineBlock = React.createElement('path', {
  ...
  var DisplayInline = React.createElement('path', {
  ...
  var DisplayFlex = React.createElement('path', {
  ...
  var FlexDirectionRow = React.createElement('path', {
  ...
  var FlexDirectionColumn = React.createElement('path', {
  ...
  var FlexAlignContentCenter = React.createElement('path', {
  ...
  var FlexAlignContentStart = React.createElement('path', {
  ...
  var FlexAlignContentEnd = React.createElement('path', {
  ...
  var FlexAlignContentSpaceAround = React.createElement('path', {
  ...
  var FlexAlignContentSpaceBetween = React.createElement('path', {
  ...
  var FlexAlignContentStretch = React.createElement('path', {
  ...
  var FlexJustifyCenter = React.createElement('path', {
  ...
  var FlexJustifyStart = React.createElement('path', {
  ...
  var FlexJustifyEnd = React.createElement('path', {
  ...
  var FlexJustifySpaceBetween = React.createElement('path', {
  ...
  var FlexJustifySpaceAround = React.createElement('path', {
  ...
  var FlexJustifySpaceEvenly = React.createElement('path', {
  ...
  var FlexAlignItemsCenter = React.createElement('path', {
  ...
  var FlexAlignItemsStart = React.createElement('path', {
  ...
  var FlexAlignItemsEnd = React.createElement('path', {
  ...
  var FlexAlignItemsStretch = React.createElement('path', {
  ...
  var FlexAlignItemsBaseline = React.createElement('path', {
  ...
  var FlexNoWrap = React.createElement('path', {
  ...
  var FlexWrap = React.createElement('path', {
  ...
  var Focus = React.createElement('path', {
  ...
  var Return = React.createElement('path', {
  ...
  var History = React.createElement(
    'svg',
  ...
  var Play = React.createElement('path', {
  ...
  var InputSource = React.createElement(
    'svg',
  ...
  var TextAreaSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var SelectSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var TreeSelectSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var CascaderSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var RadioGroupSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var CheckboxGroupSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var SliderSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('rect', {
      fill: '#999999',
  ...
  var RateSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var TimePickerSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var TimeRangePickerSource = React.createElement(
    'svg',
    { viewBox: '0 0 1424 1024' },
    React.createElement(
      'g',
  ...
  var NumberPickerSource = React.createElement(
    'svg',
    { viewBox: '0 0 1424 1024' },
    React.createElement(
      'g',
  ...
  var TransferSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var UploadSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('rect', {
      fill: '#999999',
  ...
  var UploadDraggerSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M524.931034,80 C691.960872,80 786.973493,198.134474 809.205262,430.123156 C809.683377,435.112294 813.780979,438.97686 818.789541,439.162362 C952.942877,444.13101 1022,506.676517 1022,624.482759 C1022,686.378487 997.330268,733.50153 948.40537,764.65293 C900.561062,795.116298 829.824906,810.12931 736.137931,810.12931 C730.615084,810.12931 726.137931,805.652158 726.137931,800.12931 C726.137931,794.606463 730.615084,790.12931 736.137931,790.12931 C826.359002,790.12931 893.553881,775.867897 937.663596,747.782415 C980.692721,720.384964 1002,679.684731 1002,624.482759 C1002,519.142921 943.197337,464.83155 821.748746,459.301313 L818.049306,459.148659 C803.023623,458.592151 790.730816,446.998455 789.296471,432.03104 C767.947106,209.250259 680.079839,100 524.931034,100 C369.7047,100 282.288484,189.964836 260.728055,373.294922 C259.087578,387.244033 247.995507,398.167549 234.064277,399.627152 L233.641257,399.668479 C91.431391,412.557268 22,481.319011 22,608.318966 C22,739.159701 103.629541,799.201265 272.239445,790.143708 C277.754341,789.847453 282.46521,794.077998 282.761465,799.592894 C283.057719,805.10779 278.827175,809.818658 273.312279,810.114913 C94.2210335,819.735517 2,751.903517 2,608.318966 C2,470.51406 79.7276986,393.536025 231.836012,379.750118 C236.545747,379.323264 240.312596,375.655603 240.864945,370.958932 C263.543681,178.119782 358.883821,80 524.931034,80 Z',
  ...
  var SwitchSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var ObjectSource = React.createElement(
    'svg',
    { viewBox: '0 0 1424 1024' },
    React.createElement(
      'g',
  ...
  var GridSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var FormLayoutSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var SpaceSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var ArrayCardsSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var ButtonSource = React.createElement(
    'svg',
    { viewBox: '0 0 1424 1024' },
    React.createElement(
      'g',
  ...
  var MediaSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var NotificationSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('rect', {
      fill: '#999999',
  ...
  var ImageSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var TextSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,0 C988.18278,0 1024,35.81722 1024,80 L1024,944 C1024,988.18278 988.18278,1024 944,1024 L80,1024 C35.81722,1024 0,988.18278 0,944 L0,80 C0,35.81722 35.81722,0 80,0 L944,0 Z M944,20 L80,20 C47.1942859,20 20.5378857,46.328343 20,79.0077903 L20,80 L20,944 C20,976.805714 46.328343,1003.46211 79.0077903,1004 L80,1004 L944,1004 C976.805714,1004 1003.46211,977.671657 1004,944.99221 L1004,944 L1004,80 C1004,47.1942859 977.671657,20.5378857 944.99221,20 L944,20 Z',
  ...
  var CreateButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var DeleteButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var SubmitButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var ResetButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var UpdateButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var OpenPageButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var CustomButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var ConfirmButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var CancelButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var DetailLinkButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var CreateLinkButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var UpdateLinkButtonSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M944,212 C988.18278,212 1024,247.81722 1024,292 L1024,732 C1024,776.18278 988.18278,812 944,812 L80,812 C35.81722,812 0,776.18278 0,732 L0,292 C0,247.81722 35.81722,212 80,212 L944,212 Z M944,232 L80,232 C47.1942859,232 20.5378857,258.328343 20,291.00779 L20,292 L20,732 C20,764.805714 46.328343,791.462114 79.0077903,791.991962 L80,792 L944,792 C976.805714,792 1003.46211,765.671657 1004,732.99221 L1004,732 L1004,292 C1004,259.194286 977.671657,232.537886 944.99221,232.008038 L944,232 Z',
  ...
  var DataTableSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var DataQueryListSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var DataFormSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var DataDetailFormSource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M90,920 C40.7914288,920 0.806828576,880.507485 0.0120574286,831.488315 L0,830 L0,90 C0,40.7914288 39.4925145,0.806828576 88.5116854,0.0120574286 L90,0 L880,0 C929.208571,0 969.193171,39.4925145 969.987943,88.5116854 L970,90 L970,610 L950,610 L950,90 C950,51.7266668 919.2836,20.6275333 881.157578,20.009378 L880,20 L90,20 C51.7266668,20 20.6275333,50.7164002 20.009378,88.842422 L20,90 L20,830 C20,868.273333 50.7164002,899.372467 88.842422,899.990622 L90,900 L695,900 L695,920 L90,920 Z',
  ...
  var EntitySource = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd' },
    React.createElement('rect', {
      stroke: '#999999',
  ...
  var ImageEntitySource = React.createElement(
    'g',
  ...
  var FileEntitySource = React.createElement(
    'g',
    { fill: 'none' },
    React.createElement('rect', {
      stroke: '#999999',
  ...
  var FileSource = React.createElement(
    'g',
    { stroke: 'none', fill: 'none' },
    React.createElement('rect', {
      fill: 'var(--dn-brand-color)',
  ...
  var AddSort = React.createElement(
    'g',
  ...
  var AddIndex = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var AddColumn = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fillRule: 'evenodd' },
    React.createElement('rect', {
      transform:
  ...
  var AddColumnGroup = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M864,62 L160,62 C71.63444,62 0,133.63444 0,222 L0,802 C0,890.36556 71.63444,962 160,962 L864,962 C952.36556,962 1024,890.36556 1024,802 L1024,222 C1024,133.63444 952.36556,62 864,62 Z M160,142 L864,142 C908.18278,142 944,177.81722 944,222 L944,802 C944,846.18278 908.18278,882 864,882 L160,882 C115.81722,882 80,846.18278 80,802 L80,222 C80,177.81722 115.81722,142 160,142 Z',
  ...
  var AddPanel = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fillRule: 'evenodd' },
    React.createElement('path', {
      d: 'M864,62 L160,62 C71.63444,62 0,133.63444 0,222 L0,802 C0,890.36556 71.63444,962 160,962 L864,962 C952.36556,962 1024,890.36556 1024,802 L1024,222 C1024,133.63444 952.36556,62 864,62 Z M160,142 L864,142 C908.18278,142 944,177.81722 944,222 L944,802 C944,846.18278 908.18278,882 864,882 L160,882 C115.81722,882 80,846.18278 80,802 L80,222 C80,177.81722 115.81722,142 160,142 Z',
  ...
  var AddOperation = React.createElement(
    'g',
    { stroke: 'none', strokeWidth: '1', fillRule: 'evenodd' },
    React.createElement('path', {
  ...
  var PCSimulator = function (props) {
    ...
    return React.createElement(
      'div',
      __assign({}, props, { className: classnames(prefix, props.className) }),
      props.children
    )
  }
  ...
  var useResizeEffect = function (container, content, engine) {
    ...
    engine.subscribeTo(Designable.Core.DragMoveEvent, function (e) {
      ...
      if (distanceX <= 10) {
        if (!animationX) {
          animationX = Designable.Shared.createUniformSpeedAnimation(
            1000 * factorX,
            function (delta) {
      ...
      if (distanceY <= 10) {
        if (!animationY) {
          animationY = Designable.Shared.createUniformSpeedAnimation(
            300 * factorY,
            function (delta) {
  ...
  var Simulator = Formily.ReactiveReact.observer(
    function (props) {
      var screen = useScreen()
  ...
  var StudioPanelInternal = function (_a) {
    ...
    if (logo || actions) {
      return React.createElement(
        'div',
        __assign({}, props, {
          className: classnames(''.concat(prefix, '-container'), classNameBase),
        }),
        React.createElement(
          'div',
          { className: prefix + '-header' },
    ...
    return React.createElement(
      'div',
      __assign({}, props, { className: classnames(prefix, classNameBase) }),
      props.children
    )
  }
  ...
  var CompositePanel = function (props) {
    ...
    var renderContent = function () {
      ...
      return React.createElement(
        'div',
        {
          className: classnames(prefix + '-tabs-content', {
            pinning: pinning,
          }),
        },
        React.createElement(
  ...
  var SettingsPanel = Formily.ReactiveReact.observer(function (props) {
    ...
    return React.createElement(
      'div',
      { className: classnames(prefix, { pinning: pinning }) },
      React.createElement(
        'div',
        { className: prefix + '-header' },
        React.createElement(

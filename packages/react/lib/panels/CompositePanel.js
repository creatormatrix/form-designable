...
var CompositePanel = function (props) {
  ...
  var _g = __read(
      (0, react_1.useState)(
        (_d = props.defaultOpen) !== null && _d !== void 0 ? _d : true
      ),
      2
    ),
    visible = _g[0],
  ...
  var renderContent = function () {
    ...
    return react_1.default.createElement(
      'div',
      {
        className: (0, classnames_1.default)(prefix + '-tabs-content', {
          pinning: pinning,
        }),
      },
    ...
    react_1.default.createElement(
      ...
      items.map(function (item, index) {
        ...
        var takeTab = function () {
          ...
          return react_1.default.createElement(widgets_1.IconWidget, {
        ...
        return react_1.default.createElement(
          Comp,
          {
            className: (0, classnames_1.default)(prefix + '-tabs-pane', {
            ...
            onClick: function (e) {
              ...
              ;(_a = item.onClick) === null || _a === void 0
                ? void 0
                : _a.call(item, e)
              ;(_b = props.onChange) === null || _b === void 0
                ? void 0
                : _b.call(props, item.key)
            },
          },
          takeTab(),

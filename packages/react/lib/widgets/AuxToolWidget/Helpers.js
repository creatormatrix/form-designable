...
var Helpers = function (_a) {
  ...
  var _c = __read((0, react_1.useState)('top-right'), 2),
    position = _c[0],
    setPosition = _c[1]
  ...
  return react_1.default.createElement(
    'div',
    {
      className: (0, classnames_1.default)(
        prefix,
        ((_b = {}), (_b[position] = true), _b)
      ),
      ref: ref,
    },
    react_1.default.createElement(
      'div',
      { className: (0, classnames_1.default)(prefix + '-content') },
      react_1.default.createElement(Selector_1.Selector, { node: node }),
      (node === null || node === void 0 ? void 0 : node.allowClone()) === false
        ? null
        : react_1.default.createElement(Copy_1.Copy, { node: node }),
      (node === null || node === void 0 ? void 0 : node.allowDrag()) === false
        ? null
        : react_1.default.createElement(DragHandler_1.DragHandler, {
            node: node,
          }),
      (node === null || node === void 0 ? void 0 : node.allowDelete()) === false
        ? null
        : react_1.default.createElement(Delete_1.Delete, { node: node })
    )
  )
}

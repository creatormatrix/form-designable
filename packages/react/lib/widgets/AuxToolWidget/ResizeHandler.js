  ...
  return react_1.default.createElement(
    ...
    allowX &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('left-center'))
      ),
    allowX &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('right-center'))
      ),
    allowY &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('center-top'))
      ),
    allowY &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('center-bottom'))
      ),
    allowX &&
      allowY &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('left-top'))
      ),
    allowY &&
      allowY &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('right-top'))
      ),
    allowX &&
      allowY &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('left-bottom'))
      ),
    allowY &&
      allowY &&
      react_1.default.createElement(
        'div',
        __assign({}, createHandler('right-bottom'))
      )
  )
}

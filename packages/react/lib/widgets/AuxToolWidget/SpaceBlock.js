...
exports.SpaceBlock = (0, reactive_react_1.observer)(function () {
  ...
  if (cursor.status !== core_1.CursorStatus.Dragging) return null
  var renderRulerBox = function (distance, type) {
    if (type === 'top' || type === 'bottom') {
      return react_1.default.createElement(
        'div',
        { className: prefix + '-ruler-v' },
        react_1.default.createElement(
          'div',
          { className: prefix + '-ruler-indicator' },
          react_1.default.createElement(
            'span',
            null,
      ...
      'svg',
      {
        ...
        style: {
          ...
          transform: 'perspective(1px) translate3d('
            .concat(line.start.x, 'px,')
            .concat(line.start.y, 'px,0)'),
          position: 'absolute',
          zIndex: 3,
        },
      },
        ...
        react_1.default.createElement(
          'div',
          {
            ...
            style: {
              ...
              transform: 'perspective(1px) translate3d('
                .concat(crossDragNodesRect.x, 'px,')
                .concat(crossDragNodesRect.y, 'px,0)'),
              position: 'absolute',
              zIndex: 3,
            },
          },

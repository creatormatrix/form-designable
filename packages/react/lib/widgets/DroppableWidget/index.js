...
exports.DroppableWidget = (0, reactive_react_1.observer)(function (_a) {
  ...
  return react_1.default.createElement(
    'div',
    __assign({}, nodeId, props, { className: className, style: style }),
    hasChildren
      ? props.children
      : placeholder
      ? react_1.default.createElement(
          'div',
          { style: { height: height }, className: 'dn-droppable-placeholder' },
    ...
    (actions === null || actions === void 0 ? void 0 : actions.length)
      ? react_1.default.createElement(
          NodeActionsWidget_1.NodeActionsWidget,
          null,
          actions.map(function (action, key) {
            return react_1.default.createElement(
              NodeActionsWidget_1.NodeActionsWidget.Action,
              __assign({}, action, { key: key })
            )
          })
        )
      : null

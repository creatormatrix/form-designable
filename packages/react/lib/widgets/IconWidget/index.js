...
exports.IconWidget = (0, reactive_react_1.observer)(function (props) {
  ...
  var takeIcon = function (infer) {
    if ((0, shared_1.isStr)(infer)) {
      ...
      if (infer[theme]) {
        ...
        return react_1.default.createElement(exports.IconWidget.ShadowSVG, {
          width: width,
          height: height,
  ...
  var renderTooltips = function (children) {
    ...
    if (tooltip) {
      var title =
        react_1.default.isValidElement(tooltip) || (0, shared_1.isStr)(tooltip)
          ? tooltip
          : tooltip.title
      var props_1 =
        react_1.default.isValidElement(tooltip) || (0, shared_1.isStr)(tooltip)

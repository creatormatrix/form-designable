...
exports.OutlineTreeNode = (0, reactive_react_1.observer)(function (_a) {
      ...
      return (0, reactive_1.autorun)(function () {
        ...
        if (
          ...
          ((_a =
            moveHelper === null || moveHelper === void 0
              ? void 0
              : moveHelper.dragNodes) === null || _a === void 0
            ? void 0
            : _a.length)
        ) {
          if (ref.current.classList.contains('selected')) {
  ...
  var renderIcon = function (node) {
    ...
    if (icon) {
      return react_1.default.createElement(IconWidget_1.IconWidget, {
        infer: icon,
        size: 12,
      })
    }
  ...
  var renderTitle = function (node) {
    if ((0, shared_1.isFn)(ctx.renderTitle)) return ctx.renderTitle(node)
    return react_1.default.createElement(
      'span',
      null,
      react_1.default.createElement(NodeTitleWidget_1.NodeTitleWidget, {
        node: node,
      })
    )
  }
  var renderActions = function (node) {
    if ((0, shared_1.isFn)(ctx.renderActions)) return ctx.renderActions(node)
  }
  return react_1.default.createElement(
    'div',
    {
      style: style,
      ref: ref,
      className: (0, classnames_1.default)(prefix, className, 'expanded'),
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
                ...
                onClick: function (e) {
                  ...
                  if (
                    (_b =
                      ...
                      ? void 0
                      : _b.contains('expanded')
                  ) {
                    ;(_c = ref.current) === null || _c === void 0
                      ? void 0
                      : _c.classList.remove('expanded')
                  } else {
                    ;(_d = ref.current) === null || _d === void 0
                      ? void 0
                      : _d.classList.add('expanded')
                  }
                },
              },
        ...
        react_1.default.createElement(
          ...
          node !== node.root &&
            react_1.default.createElement(IconWidget_1.IconWidget, {
              className: (0, classnames_1.default)(prefix + '-hidden-icon', {
                hidden: node.hidden,
              }),
    ...
    react_1.default.createElement(
      ...
      (_c = node.children) === null || _c === void 0
        ? void 0
        : _c.map(function (child) {
            return react_1.default.createElement(exports.OutlineTreeNode, {
              node: child,
              key: child.id,

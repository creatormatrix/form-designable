  ...
  var renderNode = function (source) {
    ...
    return react_1.default.createElement(
      'div',
      {
        ...
        style: { gridColumnStart: 'span '.concat(span || 1) },
        key: node.id,
      ...
      icon && react_1.default.isValidElement(icon)
        ? react_1.default.createElement(react_1.default.Fragment, null, icon)
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          null,
          title ||
            ((_a = node.children[0]) === null || _a === void 0
              ? void 0
              : _a.getMessage('title'))
        )
      )
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        sources.map(
          (0, shared_1.isFn)(props.children) ? props.children : renderNode
        ),
        remainItems
          ? react_1.default.createElement('div', {
              className: prefix + '-item-remain',
              style: { gridColumnStart: 'span '.concat(3 - remainItems) },
            })
          : null
      )
    )

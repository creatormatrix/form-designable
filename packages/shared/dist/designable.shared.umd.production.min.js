;(function (global, factory) {
  ...
  var isFn = isType(['Function', 'AsyncFunction', 'GeneratorFunction'])
  ...
  var EventDriver = /** @class */ (function () {
    ...
    EventDriver.prototype.addEventListener = function (
      type,
      listener,
      options
    ) {
  ...
  var Event = /** @class */ (function (_super) {
    ...
    Event.prototype.attachEvents = function (
      container,
      contentWindow,
      context
    ) {
  ...
  var calcElementRotate = function (element) {
    ...
    if (transform) {
      return Number(
        (_c =
          (_b = transform.match(/rotate\(\s*([-\d.]+)/)) === null ||
          _b === void 0
            ? void 0
            : _b[1]) !== null && _c !== void 0
          ? _c
  ...
  var calcElementScale = function (element) {
    ...
    if (transform) {
      return Number(
        (_c =
          (_b = transform.match(/scale\(\s*([-\d.]+)/)) === null ||
          _b === void 0
            ? void 0
            : _b[1]) !== null && _c !== void 0
          ? _c

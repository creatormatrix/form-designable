...
export declare function every<T extends {}, TValue = T[keyof T]>(
  val: T,
...
export declare function some<T extends {}, TValue = T[keyof T]>(
  val: T,
  iterator: EachObjectIterator,
  revert?: boolean
): boolean
...
export declare function findIndex<T extends {}, TValue = T[keyof T]>(
  val: T,
  iterator: EachObjectIterator,
  revert?: boolean
): keyof T
...
export declare function find<T extends {}, TValue = T[keyof T]>(
  val: T,
  iterator: EachObjectIterator,
  revert?: boolean
): T[keyof T]

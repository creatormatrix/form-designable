...
function isPoint(val) {
  return (
    (0, types_1.isValidNumber)(
      val === null || val === void 0 ? void 0 : val.x
    ) &&
    (0, types_1.isValidNumber)(val === null || val === void 0 ? void 0 : val.y)
  )
}
exports.isPoint = isPoint
function isLineSegment(val) {
  return (
    isPoint(val === null || val === void 0 ? void 0 : val.start) &&
...
function calcBoundingRect(rects) {
  ...
  if (
    (rects === null || rects === void 0 ? void 0 : rects.length) === 1 &&
    !rects[0]
  )
    return
  var minTop = Infinity
...
function calcDistanceOfSnapLineToEdges(line, edges) {
  ...
  if (
    ...
    _a === void 0
      ? void 0
      : _a.y) ===
    ((_b = line === null || line === void 0 ? void 0 : line.end) === null ||
    _b === void 0
      ? void 0
      : _b.y)
  ) {
    ...
    ((_c = line === null || line === void 0 ? void 0 : line.start) === null ||
    _c === void 0
      ? void 0
      : _c.x) ===
    ((_d = line === null || line === void 0 ? void 0 : line.end) === null ||
    _d === void 0
      ? void 0
      : _d.x)
  ) {

...
var calcElementLayout = function (element) {
  ...
  var isNotFullWidth = function () {
    ...
    var outerWidth = (0, exports.calcElementOuterWidth)(innerWidth, style)
...
var calcElementRotate = function (element) {
  ...
  if (transform) {
    return Number(
      (_c =
        (_b = transform.match(/rotate\(\s*([-\d.]+)/)) === null || _b === void 0
          ? void 0
          : _b[1]) !== null && _c !== void 0
        ? _c
        : 0
...
var calcElementScale = function (element) {
  ...
  if (transform) {
    return Number(
      (_c =
        (_b = transform.match(/scale\(\s*([-\d.]+)/)) === null || _b === void 0
          ? void 0
          : _b[1]) !== null && _c !== void 0
        ? _c
        : 0

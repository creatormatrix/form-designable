...
var EventDriver = /** @class */ (function () {
  ...
  EventDriver.prototype.addEventListener = function (type, listener, options) {
    ...
    if (
      ...
      if (
        !((_b =
          (_a = target[EVENTS_SYMBOL][type]) === null || _a === void 0
            ? void 0
        ...
        target.addEventListener(type, listener, options)
        ;(_d =
          (_c = target[EVENTS_SYMBOL][type]) === null || _c === void 0
            ? void 0
            : _c.set) === null || _d === void 0
          ? void 0
          : _d.call(_c, listener, true)
      }
    }
  }
  EventDriver.prototype.removeEventListener = function (
    type,
    listener,
    options
  ) {
    ...
    if (
      ...
      ;(_b =
        (_a = target[EVENTS_SYMBOL][type]) === null || _a === void 0
          ? void 0
          : _a.delete) === null || _b === void 0
        ? void 0
        : _b.call(_a, listener)
      target.removeEventListener(type, listener, options)
    }
  }
  EventDriver.prototype.batchAddEventListener = function (
    type,
    listener,
    options
  ) {
  ...
  EventDriver.prototype.batchRemoveEventListener = function (
    type,
    listener,
    options
  ) {
...
var Event = /** @class */ (function (_super) {
  ...
  function Event(props) {
    ...
    if (
      (0, types_1.isArr)(
        props === null || props === void 0 ? void 0 : props.effects
      )
    ) {
    ...
    if (
      (0, types_1.isArr)(
        props === null || props === void 0 ? void 0 : props.drivers
      )
    ) {
  ...
  Event.prototype.subscribeWith = function (type, subscriber) {
    return this.subscribe(function (event) {
      if ((0, types_1.isArr)(type)) {
        ...
        if (
          type &&
          (event === null || event === void 0 ? void 0 : event.type) === type
        ) {
          return subscriber(event)
        }
      }
  ...
  Event.prototype.detachEvents = function (container) {
    ...
    this.containers = this.containers.filter(function (item) {

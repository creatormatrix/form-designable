...
var isType = function (type) {
  return function (obj) {
    return (
      obj != null &&
      (Array.isArray(type) ? type : [type]).some(function (t) {
        return (0, exports.getType)(obj) === '[object '.concat(t, ']')
      })
    )
  }
}
...
var isHTMLElement = function (obj) {
  return (
    (obj === null || obj === void 0 ? void 0 : obj['nodeName']) ||
    (obj === null || obj === void 0 ? void 0 : obj['tagName'])
  )
}
